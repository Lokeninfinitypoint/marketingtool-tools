...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["699538e1072edabd56b3d503c7d484cb.png","69e0cabc6abf41944e42d7f7ac26c1ba.png","6afff8727d01c94db3b9a7209bb2f0ad.png"],"writing":["6c45133afbd06206756e1dac2c9c4ba1.png","6d107688532c8d2425145f5d6cfa065a.png","6e94a9253c9dae2a2bbde3e14a7d55bc.png"],"editing":["6fc8dfddf7fd7255d86361f31adc36c8.png","705fb3d0483c26a5b19a59146723a239.png","709eb1b05980742d06aa4e315bb0270d.png"],"publish":["71602ec35adbd144d552cb32d6f3bf2a.png","71ad4cbbacd0bd20582ec491e4ff1200.png","72481c627abccae437b2b165d30d8c67.png"]},
  tabDescriptions: {"overview":[{"title":"Affiliate Hub","desc":"Campaign center"},{"title":"Earnings","desc":"Commission data"},{"title":"Top Products","desc":"Best sellers"}],"writing":[{"title":"Review Writer","desc":"Product reviews"},{"title":"Comparison","desc":"Vs. articles"},{"title":"Email Copy","desc":"Promo emails"}],"editing":[{"title":"SEO Keywords","desc":"Search terms"},{"title":"CTA Power","desc":"Click drivers"},{"title":"Trust Signals","desc":"Credibility"}],"publish":[{"title":"Link Clicks","desc":"Traffic data"},{"title":"Conversions","desc":"Sales made"},{"title":"Revenue","desc":"Earnings report"}]},
  tips: [{"title":"Be Detailed","desc":"Provide specific information for accurate Affiliate Marketing Copy results."},{"title":"Set Clear Goals","desc":"Define what success looks like for your task."},{"title":"Iterate Results","desc":"Refine your input based on initial output."}],
};
...
export function AffiliateMarketingCopyPage() {
  const { user } = useAuth();
...
export default AffiliateMarketingCopyPage;
