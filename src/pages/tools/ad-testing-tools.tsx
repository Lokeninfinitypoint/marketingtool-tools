...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["3df2d668076abbadd1204774b0a7173b.png","3f991bcf43ae929df34128d8f8fd8f55.png","4274e621fe61e871266ecd0eef3b5b1c.png"],"configure":["4483ca3c63168d0dfed4815fa86686e5.png","45c90c4f9b8581e04430352d40af645a.png","464d740909fca9d4d56f489475f08458.png"],"generate":["473df6a67826badcbf29ba183bfc5c05.png","4808fd41ab2758e85cbde6ef954e14eb.png","485abf26ea687bd571972383bf2b2c2a.png"],"results":["4a4b6a08ec31ad2806e4d8a84904c4f2.png","4b20b4ed113d70e42bc67b74a53b5555.png","4bce24d50b87d09308b119576e28e69a.png"]},
  tabDescriptions: {"overview":[{"title":"Test Dashboard","desc":"Active tests"},{"title":"Win Rate","desc":"Success metrics"},{"title":"Test History","desc":"Past results"}],"configure":[{"title":"A/B Builder","desc":"Create tests"},{"title":"Variables","desc":"What to test"},{"title":"Sample Size","desc":"Audience split"}],"generate":[{"title":"Winner Data","desc":"Best performer"},{"title":"Confidence","desc":"Statistical proof"},{"title":"Lift Analysis","desc":"Improvement %"}],"results":[{"title":"Apply Winners","desc":"Scale results"},{"title":"Next Tests","desc":"What to try"},{"title":"Test Calendar","desc":"Schedule tests"}]},
  tips: [{"title":"Be Detailed","desc":"Provide specific information for accurate Ad Testing Tools results."},{"title":"Set Clear Goals","desc":"Define what success looks like for your task."},{"title":"Iterate Results","desc":"Refine your input based on initial output."}],
};
...
export function AdTestingToolsPage() {
  const { user } = useAuth();
...
export default AdTestingToolsPage;
