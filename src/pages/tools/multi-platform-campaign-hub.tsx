...
const TOOL_DATA = {
  ...
  badge: 'Campaign',
  badgeColor: '#dd6b20',
  description: 'AI-powered multi platform campaign hub',
  heroVideo: '/media/videos/Social%20Media%20Templates%20%283%29.mp4',
  ...
  tabImages: {"overview":["portfolio-1-3.png","portfolio-1.png","portfolio-2.png"],"setup":["portfolio-3.png","portfolio-4.png","preview.png"],"monitor":["pricing-bg-two.png","projects.png","release-note.png"],"optimize":["returnvalue.png","right-sidebar.png","routs.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your multi platform campaign hub requirements...",
    "required": true
  }
];

export function MultiPlatformCampaignHubPage() {
  const { user } = useAuth();
...
export default MultiPlatformCampaignHubPage;
