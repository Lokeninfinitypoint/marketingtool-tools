...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["digital-wallet-fields.png","directionalLight_darkMode_selected.png","directionalLight_darkMode_unselected.png"],"writing":["directionalLight_lightMode_selected.png","directionalLight_lightMode_unselected.png","door-01.png"],"editing":["drp.png","e00f85798a33a7e9dd7a395e1a177046.png","e0d726c46b2b33afe85f77b53fa10563.png"],"publish":["e1f0ff971b42da90762f43320d8a89b5.png","e235d9cefafa38908433ac7e03f47aa2.png","e27eedb93587d150d2c4d9303959f872.png"]},
  tabDescriptions: {"overview":[{"title":"Copy Hub","desc":"Content center"},{"title":"Recent","desc":"Latest copies"},{"title":"Top Performers","desc":"Best results"}],"writing":[{"title":"Write Copy","desc":"AI generation"},{"title":"Brand Voice","desc":"Tone match"},{"title":"Channels","desc":"Platform fit"}],"editing":[{"title":"Saved Content","desc":"Your copies"},{"title":"Templates","desc":"Quick start"},{"title":"Snippets","desc":"Reusable blocks"}],"publish":[{"title":"Performance","desc":"Engagement data"},{"title":"Conversions","desc":"Click rates"},{"title":"Trends","desc":"What works"}]},
  tips: [{"title":"Be Detailed","desc":"Provide specific information for accurate Marketing Copy Generator results."},{"title":"Set Clear Goals","desc":"Define what success looks like for your task."},{"title":"Iterate Results","desc":"Refine your input based on initial output."}],
};
...
export function MarketingCopyGeneratorPage() {
  const { user } = useAuth();
...
export default MarketingCopyGeneratorPage;
