...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["ca042d59241cd48ac5fe4d288404df71.png","ca33bf90c5aa8bcca176cf219e077900.png","ca39d2a61c4631e063c1f53cc6b05ef1.png"],"technical":["calander.png","calendar-page.png","calendar.png"],"content":["callto-action.png","card-img1.png","card-img2.png"],"ranking":["card-img3.png","card-img4.png","card-overlay-img1.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your long tail keyword generator requirements...",
    "required": true
  },
  {
    "name": "url",
...
export function LongTailKeywordGeneratorPage() {
  const { user } = useAuth();
...
export default LongTailKeywordGeneratorPage;
