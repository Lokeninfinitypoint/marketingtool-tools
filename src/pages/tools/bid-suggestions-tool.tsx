...
const TOOL_DATA = {
  ...
  badge: 'Budget',
  badgeColor: '#48bb78',
  description: 'AI-powered bid suggestions tool',
  heroVideo: '/media/videos/Facebook%20Instagram%20Ads%20Setup%20for%20Growth%20%281%29.mp4',
  ...
  tabImages: {"overview":["design.png","device-iPhone14Pro.8b4e207e.png","device-iPhone14Pro_dark.6179e616.png"],"analysis":["device-tv.afb3e674.png","device-tv_dark.3d102412.png","device-watchSeries8-45.6b7e9754.png"],"optimize":["device-watchSeries8-45_dark.97273065.png","digital-wallet-button.png","digital-wallet-fields.png"],"report":["directionalLight_darkMode_selected.png","directionalLight_darkMode_unselected.png","directionalLight_lightMode_selected.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your bid suggestions tool requirements...",
    "required": true
  }
];

export function BidSuggestionsToolPage() {
  const { user } = useAuth();
...
export default BidSuggestionsToolPage;
