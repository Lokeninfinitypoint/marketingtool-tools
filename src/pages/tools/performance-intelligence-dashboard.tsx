...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["Hire Affordable Sugar Land SEO Company, Local Business SEO Sugar Land.jpeg","How Enterprises Use Automated Performance Testing to Prevent Scalability Failures.jpeg","How to Run Facebook Ads the Smart Way Without Wasting Your Budget.jpg"],"metrics":["How to make AI agents cheaper, faster and more accurate.jpeg","Ideogram.jpeg","f55df5fd3f783764d7b6626e2909a206.png"],"insights":["Just for A future tip pt8.jpeg","JustMyLook Beauty App Launch 3D Animation.jpeg","Langerson araque.jpeg"],"export":["Making Code Reviews Count.jpeg","f587399cd5c0b89927a719eeb4fa769c.png","Master Your Google Ads_ Become an Expert.jpeg"]},
  tabDescriptions: {"overview":[{"title":"Intelligence Hub","desc":"Smart insights"},{"title":"Health Score","desc":"Overall status"},{"title":"Alerts","desc":"Action items"}],"metrics":[{"title":"KPI Tracker","desc":"Key numbers"},{"title":"Trends","desc":"Over time"},{"title":"Benchmarks","desc":"Industry data"}],"insights":[{"title":"Channel Compare","desc":"Platform vs platform"},{"title":"Period Compare","desc":"Time vs time"},{"title":"Campaign Compare","desc":"Ad vs ad"}],"export":[{"title":"Projections","desc":"Future outlook"},{"title":"Scenarios","desc":"What-if"},{"title":"Goals","desc":"Target tracking"}]},
...
export function PerformanceIntelligenceDashboardPage() {
  const { user } = useAuth();
...
export default PerformanceIntelligenceDashboardPage;
