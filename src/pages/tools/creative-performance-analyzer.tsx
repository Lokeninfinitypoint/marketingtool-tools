...
const TOOL_DATA = {
  ...
  badge: 'Creative',
  badgeColor: '#9f7aea',
  description: 'AI-powered creative performance analyzer',
  heroVideo: '/media/videos/Pinterest%20%2826%29.mp4',
  ...
  tabImages: {"overview":["counter.jpg","cover_cmhniyboy0002v8rvph8hiy8x_1762451532070_wcrdiyxr82b.jpg","crane.jpg"],"metrics":["css-structure-1.jpg","css.jpg","cta_bg.jpeg"],"insights":["cta_bg_2.jpeg","dark-home.jpg","detail 2.jpg"],"export":["detail.jpg","doc for company registration.jpg","e-commerce web dolution.jpeg"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your creative performance analyzer requirements...",
    "required": true
  }
];

export function CreativePerformanceAnalyzerPage() {
  const { user } = useAuth();
...
export default CreativePerformanceAnalyzerPage;
