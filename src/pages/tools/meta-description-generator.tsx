...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["main-banner-bg.png","maintenance-shape.png","marketingtool-feature-graphic.png"],"targeting":["missingMaterialImage.png","movie.png","moving_text_shape.png"],"creative":["mutiple-carousel-img1.png","mutiple-carousel-img2.png","mutiple-carousel-img3.png"],"optimize":["mutiple-carousel-img4.png","nav.png","news1.png"]},
  tabDescriptions: {"overview":[{"title":"SEO Score","desc":"Site health"},{"title":"Rankings","desc":"Keyword positions"},{"title":"Visibility","desc":"Search presence"}],"targeting":[{"title":"Technical SEO","desc":"Site structure"},{"title":"Speed Score","desc":"Load time"},{"title":"Mobile Ready","desc":"Mobile check"}],"creative":[{"title":"Content Quality","desc":"Writing score"},{"title":"Keyword Usage","desc":"Optimization"},{"title":"Readability","desc":"User friendly"}],"optimize":[{"title":"SERP Preview","desc":"Search display"},{"title":"Rank Tracking","desc":"Position changes"},{"title":"Opportunities","desc":"Growth areas"}]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your meta description generator requirements...",
    "required": true
  },
  {
    "name": "url",
...
export function MetaDescriptionGeneratorPage() {
  const { user } = useAuth();
