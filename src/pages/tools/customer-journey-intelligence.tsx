...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["img-9.jpg","img-news-3.jpg","img-news-4.jpg"],"metrics":["img.jpg","img1.jpg","img2.jpg"],"insights":["img3.jpg","img4.jpg","img5.jpg"],"export":["img6.jpg","instagram.jpg","javascript-structure-1.jpg"]},
  tabDescriptions: {"overview":[{"title":"Journey Map","desc":"Customer path"},{"title":"Conversion Rate","desc":"Success %"},{"title":"Drop-offs","desc":"Where lost"}],"metrics":[{"title":"Awareness","desc":"Discovery phase"},{"title":"Consideration","desc":"Research phase"},{"title":"Decision","desc":"Purchase phase"}],"insights":[{"title":"Channels","desc":"Where they interact"},{"title":"Content","desc":"What they see"},{"title":"Timing","desc":"When they engage"}],"export":[{"title":"Friction Points","desc":"Remove barriers"},{"title":"Quick Wins","desc":"Easy fixes"},{"title":"Personalization","desc":"Tailored paths"}]},
...
export function CustomerJourneyIntelligencePage() {
  const { user } = useAuth();
...
export default CustomerJourneyIntelligencePage;
