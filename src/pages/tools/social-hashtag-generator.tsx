...
const TOOL_DATA = {
  ...
  badge: 'Social Media',
  badgeColor: '#e53e8c',
  description: 'AI-powered social hashtag generator',
  heroVideo: '/media/videos/new_media_0657.mp4',
  ...
  tabImages: {"overview":["45c90c4f9b8581e04430352d40af645a.png","464d740909fca9d4d56f489475f08458.png","473df6a67826badcbf29ba183bfc5c05.png"],"writing":["4808fd41ab2758e85cbde6ef954e14eb.png","485abf26ea687bd571972383bf2b2c2a.png","4a4b6a08ec31ad2806e4d8a84904c4f2.png"],"editing":["4b20b4ed113d70e42bc67b74a53b5555.png","4bce24d50b87d09308b119576e28e69a.png","4c9e29dbf6d601083b8e515623e13faf.png"],"publish":["4d35648697c8c465cc0208bd38981b69.png","4ee673b9365dc8939108fd2fa6e41103.png","4f505d349e0506d2bbc49ca0376cd6f2.png"]},
  tabDescriptions: {"overview":[{"title":"Content Plan","desc":"Strategy view"},{"title":"Platform Stats","desc":"Engagement data"},{"title":"Trending","desc":"Hot topics"}],"writing":[{"title":"Post Creator","desc":"Write content"},{"title":"Visual Design","desc":"Media tools"},{"title":"Hashtag Mix","desc":"Tag strategy"}],"editing":[{"title":"Calendar","desc":"Schedule view"},{"title":"Best Times","desc":"Optimal posting"},{"title":"Auto Post","desc":"Scheduled publish"}],"publish":[{"title":"Engagement","desc":"Likes/comments"},{"title":"Growth","desc":"Follower change"},{"title":"Top Content","desc":"Best posts"}]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your social hashtag generator requirements...",
    "required": true
  },
  {
    "name": "platform",
...
export function SocialHashtagGeneratorPage() {
  const { user } = useAuth();
...
export default SocialHashtagGeneratorPage;
