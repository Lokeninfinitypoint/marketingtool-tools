...
const TOOL_DATA = {
  ...
  badge: 'Instagram',
  badgeColor: '#E4405F',
  description: 'AI-powered instagram engagement analyzer',
  heroVideo: '/media/videos/Pinterest%2821%29.mp4',
  ...
  tabImages: {"overview":["58ca16b1db997cc1663f3b0e01554a99.png","58e3775d1124a0e15f53d6d639dafd24.png","5a6794d9f07c30a173a3b78a8b1f6a6a.png"],"targeting":["5b232ac841a548a7d2dc4bd9a0ff5cae.png","5b4e4535c8bf4397cd63b73e92c95f13.png","5b64dc58ccbd381a710eb1cfd6f09fcb.png"],"creative":["5ef9171736dffe8838375d0690f2d371.png","637af7b11139f43f3667b1a79d32d498.png","654c8939c0a506b97974184e94d48b66.png"],"optimize":["661ca1614536421c475c3a5847afb4f8.png","6712a68ca7c16b2eed0271ca2b008e7d.png","677ba27659c590bd94e196476786d08e.png"]},
  tabDescriptions: {"overview":[{"title":"Profile Stats","desc":"Account metrics"},{"title":"Content Mix","desc":"Post types"},{"title":"Engagement","desc":"Interaction rate"}],"targeting":[{"title":"Post Creator","desc":"Create content"},{"title":"Story Design","desc":"Story builder"},{"title":"Reels","desc":"Short video"}],"creative":[{"title":"Best Times","desc":"Post timing"},{"title":"Calendar","desc":"Content plan"},{"title":"Auto Post","desc":"Scheduling"}],"optimize":[{"title":"Growth Rate","desc":"Follower growth"},{"title":"Top Posts","desc":"Best content"},{"title":"Hashtag Data","desc":"Tag performance"}]},
  tips: [{"title":"Know Your Niche","desc":"Specify your industry for targeted suggestions."},{"title":"Include Hashtags","desc":"Mention your niche for relevant hashtag ideas."},{"title":"Visual Style","desc":"Describe your brand aesthetic for consistent content."}],
};
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your instagram engagement analyzer requirements...",
    "required": true
  },
  {
    "name": "audience",
...
export function InstagramEngagementAnalyzerPage() {
  const { user } = useAuth();
...
export default InstagramEngagementAnalyzerPage;
