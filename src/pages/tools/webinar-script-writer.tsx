...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["App-Icon-1024x1024@1x.png","AreaLookUpTable.png","Asteroid.png"],"writing":["B 08.png","BigTexturedWindow.png","Blog.png"],"editing":["BoundingBoxLabelFont.png","Chart.png","Chart1.png"],"publish":["ColorMap.png","DELETE THIS!!.png","Desert_Hex.png"]},
...
export function WebinarScriptWriterPage() {
  const { user } = useAuth();
...
export default WebinarScriptWriterPage;
