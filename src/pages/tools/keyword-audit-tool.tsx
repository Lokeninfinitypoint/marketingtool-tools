...
const TOOL_DATA = {
  ...
  badge: 'Audit',
  badgeColor: '#38a169',
  description: 'AI-powered keyword audit tool',
  heroVideo: '/media/videos/Pinterest%2831%29.mp4',
  ...
  tabImages: {"overview":["TBLR_Control_unselected.png","TBLR_Magnifier_selected.png","TBLR_Magnifier_unselected.png"],"analysis":["TBLR_Warnings_selected.png","TBLR_Warnings_unselected.png","Todo.png"],"scoring":["Tree_Iso.png","Untitled.png","Water_Hex.png"],"recommendations":["a03a430660d0dd6b068a56ab2adf1699.png","a04a4a26e9337c87a021322cd68e298f.png","a24a681f107f5f4d3e59140820bc7b75.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your keyword audit tool requirements...",
    "required": true
  }
];

export function KeywordAuditToolPage() {
  const { user } = useAuth();
...
export default KeywordAuditToolPage;
