...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["Campaign Performance Insights in New Google Ads Reports.jpeg","Campaign Performance Metrics Analysis in Ads.jpeg","Conversion rate optimization.jpeg"],"metrics":["Cover image-image.jpg","Data-Driven Online Marketing Strategies for Maximum ROI.jpeg","Design system Photos - Download Free High-Quality Pictures _ Freepik.jpeg"],"insights":["Did You Know- Social Media Activates the Same Pathways as Gambling.jpeg","Digital Marketing and Seo Expertise with Sourcelinebd_.jpeg","Digital Marketing.jpeg"],"export":["Digitalmehmet's Curated Illumination Magazine - The Digitalmehmet Content Ecosystem.jpeg","Dijital Pazarlama.jpeg","Dust.jpg"]},
  tabDescriptions: {"overview":[{"title":"Alert Dashboard","desc":"Active alerts"},{"title":"Triggered","desc":"Recent alerts"},{"title":"Status","desc":"System health"}],"metrics":[{"title":"Create Alert","desc":"New rule"},{"title":"Channels","desc":"Notification type"},{"title":"Priority","desc":"Alert level"}],"insights":[{"title":"Conditions","desc":"Trigger rules"},{"title":"Thresholds","desc":"Limit values"},{"title":"Frequency","desc":"Check interval"}],"export":[{"title":"Alert Log","desc":"Past alerts"},{"title":"Resolution","desc":"Actions taken"},{"title":"Trends","desc":"Alert patterns"}]},
...
export function PerformanceAutoAlertsPage() {
  const { user } = useAuth();
...
export default PerformanceAutoAlertsPage;
