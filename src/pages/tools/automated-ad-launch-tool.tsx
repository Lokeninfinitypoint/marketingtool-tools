...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["calendar-page.png","calendar.png","callto-action.png"],"configure":["card-img1.png","card-img2.png","card-img3.png"],"generate":["card-img4.png","card-overlay-img1.png","card-overlay-img2.png"],"results":["card-overlay-img3.png","carousel-img1.png","carousel-img2.png"]},
  tabDescriptions: {"overview":[{"title":"Auto Launch","desc":"Automated setup"},{"title":"Active Rules","desc":"Running automations"},{"title":"Success Rate","desc":"Launch accuracy"}],"configure":[{"title":"Trigger Setup","desc":"When to launch"},{"title":"Templates","desc":"Ad templates"},{"title":"Workflows","desc":"Step-by-step"}],"generate":[{"title":"Launch Rules","desc":"Conditions"},{"title":"Budget Caps","desc":"Spend limits"},{"title":"Schedule","desc":"Timing rules"}],"results":[{"title":"Live Status","desc":"Running ads"},{"title":"Performance","desc":"Results check"},{"title":"Alerts","desc":"Issue warnings"}]},
  tips: [{"title":"Be Detailed","desc":"Provide specific information for accurate Automated Ad Launch Tool results."},{"title":"Set Clear Goals","desc":"Define what success looks like for your task."},{"title":"Iterate Results","desc":"Refine your input based on initial output."}],
};
...
export function AutomatedAdLaunchToolPage() {
  const { user } = useAuth();
...
export default AutomatedAdLaunchToolPage;
