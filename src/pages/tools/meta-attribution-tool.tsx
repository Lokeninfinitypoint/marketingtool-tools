...
const TOOL_DATA = {
  ...
  badge: 'Facebook/Meta',
  badgeColor: '#1877F2',
  description: 'AI-powered meta attribution tool',
  heroVideo: '/media/videos/Pinterest%2852%29.mp4',
  ...
  tabImages: {"overview":["gallery2.png","gallery3.png","gallery4.png"],"targeting":["gallery5.png","gallery6.png","gallery7.png"],"creative":["gallery8.png","gallery9.png","gallery_bright.png"],"optimize":["gallery_dim.png","gmap.png","gmapapi.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your meta attribution tool requirements...",
    "required": true
  },
  {
    "name": "audience",
...
export function MetaAttributionToolPage() {
  const { user } = useAuth();
...
export default MetaAttributionToolPage;
