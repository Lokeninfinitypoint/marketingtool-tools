...
const TOOL_DATA = {
  ...
  tabs: [{"id":"overview","name":"Overview","icon":"📊"},{"id":"transform","name":"Transform","icon":"🔄"},{"id":"style","name":"Style","icon":"🎨"},{"id":"export","name":"Export","icon":"📤"}],
  tabImages: {"overview":["f0e5eb83f003a0d04f55dfd9e5e6e013.png","AI robot working on laptop.jpeg","f0ecf43435c3bd430c0ade1c2073ecf5.png"],"transform":["AI-Powered Case Analysis for Legal Professionals.jpeg","AI-Powered Innovation for Growth.jpeg","AI.jpeg"],"style":["Agentic AI- Building Autonomous Systems from Scratch.jpeg","Best Data Analytics Solutions Providers for Smarter Decisions.jpeg","Best Website Analysis Tools for Digital Marketers.jpeg"],"export":["BlackTexture.jpg","Boost Your Website with GEO, AEO & AI SEO Optimization.jpeg","f10b0d27cc9c8f693b13500975b36576.png"]},
  tabDescriptions: {"overview":[{"title":"Text Input","desc":"Paste content"},{"title":"Analysis","desc":"Text quality"},{"title":"Readability","desc":"Score check"}],"transform":[{"title":"Transform","desc":"AI rewrite"},{"title":"Batch","desc":"Multiple texts"},{"title":"Compare","desc":"Before/after"}],"style":[{"title":"Tone","desc":"Voice adjust"},{"title":"Formality","desc":"Level control"},{"title":"Audience","desc":"Reader match"}],"export":[{"title":"Copy","desc":"To clipboard"},{"title":"Download","desc":"Save file"},{"title":"History","desc":"Past edits"}]},
  tips: [{"title":"Paste Original Text","desc":"Include the exact text you want transformed."},{"title":"Set Target Tone","desc":"Choose formal, casual, or technical style."},{"title":"Specify Audience","desc":"Mention who will read it for appropriate level."}],
};
...
export function ParagraphSimplifierPage() {
  const { user } = useAuth();
...
export default ParagraphSimplifierPage;
