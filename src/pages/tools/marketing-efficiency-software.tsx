...
const TOOL_DATA = {
  ...
  tabs: [{"id":"overview","name":"Overview","icon":"📊"},{"id":"competitors","name":"Competitors","icon":"🏆"},{"id":"trends","name":"Trends","icon":"📈"},{"id":"strategy","name":"Strategy","icon":"🧠"}],
  tabImages: {"overview":["e3b7a62de10c1250f574dbf8240ed0ba.png","e3e566b5ad54e31625748994a0d056e8.png","e58521bd04c7a9f95efa633581181d02.png"],"competitors":["e6032e169a8ff37c0a61b429bcdfd4cd.png","e974d7df99cfa39672280dadc2b61edd.png","e9b3e87d9e1e159199c4d5d444489636.png"],"trends":["e9de73cfcfd2a3897159959e94bdcd6f.png","eaf87863c62289c921805cc72ede2205.png","eb41cab896d34a2c6ef7eb49fba18bff.png"],"strategy":["eb6c0c27fb476f28281cbdd2823f74fd.png","ec8c4b5100c1bc6a94eddd869b7fd2b7.png","ecommerce-dark-rtl.png"]},
  tabDescriptions: {"overview":[{"title":"Efficiency Score","desc":"Overall rating"},{"title":"Time Saved","desc":"Hours reclaimed"},{"title":"Cost Savings","desc":"Budget saved"}],"competitors":[{"title":"Bottlenecks","desc":"Slow processes"},{"title":"Redundancies","desc":"Duplicate work"},{"title":"Gaps","desc":"Missing tools"}],"trends":[{"title":"Workflows","desc":"Auto-tasks"},{"title":"Templates","desc":"Quick processes"},{"title":"Rules","desc":"Auto-actions"}],"strategy":[{"title":"ROI Report","desc":"Value gained"},{"title":"Benchmarks","desc":"Industry compare"},{"title":"Trends","desc":"Over time"}]},
  tips: [{"title":"Be Detailed","desc":"Provide specific information for accurate Marketing Efficiency Software results."},{"title":"Set Clear Goals","desc":"Define what success looks like for your task."},{"title":"Iterate Results","desc":"Refine your input based on initial output."}],
};
...
export function MarketingEfficiencySoftwarePage() {
  const { user } = useAuth();
...
export default MarketingEfficiencySoftwarePage;
