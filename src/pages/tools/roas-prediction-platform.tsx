...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["testimonial_bg.jpeg","testimonial_bg_1.jpeg","thumb.jpg"],"allocation":["thumbnail_cmi651dcy0000v874350py1s9_1763608657177_i0kcx7br7u.jpg","tools-bg.jpg","tools-hero.jpg"],"forecast":["user-11.jpg","user-12.jpg","user-13.jpg"],"optimize":["user-14.jpg","user-15.jpg","user-3.jpg"]},
...
export function RoasPredictionPlatformPage() {
  const { user } = useAuth();
...
export default RoasPredictionPlatformPage;
