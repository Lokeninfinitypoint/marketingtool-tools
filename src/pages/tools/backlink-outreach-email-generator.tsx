...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["crm-hover-sidebar.png","crm-rtl.png","crm.png"],"technical":["crypto-wallet-dashboard.png","css-structure-1.png","d0d121f0e1571d0cf9c3c016a97bbb5a.png"],"content":["d221397e7bdbd8d6abedd616bdaa1afd.png","d2c180b6d64db3fdf163750d49c19340.png","d319ca147113424be96be348ced23ba2.png"],"ranking":["d327650eb8518cfa4a00b7d35823f324.png","d36fadaf871544a015476718b416eb3d.png","d4a33ba1000ab14ccc14eb1fb7ffaf46.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your backlink outreach email generator requirements...",
    "required": true
  },
  {
    "name": "url",
...
export function BacklinkOutreachEmailGeneratorPage() {
  const { user } = useAuth();
...
export default BacklinkOutreachEmailGeneratorPage;
