...
const TOOL_DATA = {
  ...
  badge: 'Grader',
  badgeColor: '#38a169',
  description: 'AI-powered website grader',
  heroVideo: '/media/videos/new_media_0667.mp4',
  ...
  tabImages: {"overview":["Envato Logo.png","Error.png","Farm_Hex.png"],"analysis":["Footer.png","Forest_Hex.png","GlobalColor.png"],"scoring":["Grass_Iso_Left.png","Grassland_Hex.png","f4b81fc72b0198b5885125ba78469be5.png"],"recommendations":["Log_Iso.png","Mountain_Hex.png","NoPath.png"]},
  tabDescriptions: {"overview":[{"title":"Health Score","desc":"Website Grader rating"},{"title":"Key Issues","desc":"Critical problems found"},{"title":"Best Practices","desc":"Industry standards"}],"analysis":[{"title":"Deep Scan","desc":"Detailed findings"},{"title":"Trend Data","desc":"Historical changes"},{"title":"Competitor Gap","desc":"How you compare"}],"scoring":[{"title":"Grade Card","desc":"A-F rating breakdown"},{"title":"Priority Fixes","desc":"Most impactful changes"},{"title":"Strengths","desc":"What works well"}],"recommendations":[{"title":"Action Plan","desc":"Step-by-step fixes"},{"title":"Quick Wins","desc":"Easy improvements"},{"title":"Long-term Strategy","desc":"Growth roadmap"}]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your website grader requirements...",
    "required": true
  }
];
...
export default WebsiteGraderPage;
