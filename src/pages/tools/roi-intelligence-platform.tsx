...
const TOOL_DATA = {
  ...
  tabs: [{"id":"overview","name":"Overview","icon":"📊"},{"id":"allocation","name":"Allocation","icon":"💰"},{"id":"forecast","name":"Forecast","icon":"🔮"},{"id":"optimize","name":"Optimize","icon":"💵"}],
  tabImages: {"overview":["fe21d33bb536ca4e26000a829c9292f4.png","fe5f8a59dbaae734d6da4096f369ef4a.png","fed2d9cdcb6901ed608b562f5848f58f.png"],"allocation":["fff5d2b3a07ff6bd7b0c6d094a912525.png","0476f66d99cf48d6033cf9a0c3b70d48.webp","060f1aef926a6a24fa24a88a8951b248.webp"],"forecast":["0911980a04dffcfa308c00516360b742.webp","0a84fdc9ddeeb3c7d72bd637d1b72da9.webp","0b2deb1ed0b413b1d93ebb0d6c6060ad.webp"],"optimize":["0ed64aaa30846885a780231537230434.webp","10fb700e3db1b72a8b99faef40d26ff1.webp","132a60a1c75cfd6c02705875cb480aac.webp"]},
  tabDescriptions: {"overview":[{"title":"ROI Summary","desc":"Return overview"},{"title":"Channels","desc":"Per-channel data"},{"title":"Trends","desc":"Over time"}],"allocation":[{"title":"Deep Analysis","desc":"Detailed view"},{"title":"Segments","desc":"By audience"},{"title":"Time Compare","desc":"Period analysis"}],"forecast":[{"title":"Improvements","desc":"Action items"},{"title":"Auto-Optimize","desc":"AI suggestions"},{"title":"Test Plan","desc":"A/B strategy"}],"optimize":[{"title":"Custom Report","desc":"Build report"},{"title":"Export","desc":"Download data"},{"title":"Schedule","desc":"Auto-send"}]},
...
export function RoiIntelligencePlatformPage() {
  const { user } = useAuth();
...
export default RoiIntelligencePlatformPage;
