...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["nf-card-img.png","nft-gradient-bg.png","nft-img1.png"],"analysis":["nft-img2.png","nft-img3.png","nft-img4.png"],"scoring":["note.png","notes.png","notification-icon.png"],"recommendations":["objectrecognizer1.png","openSkyFadeMask_gradientBox.png","partials.png"]},
  tabDescriptions: {"overview":[{"title":"Health Score","desc":"Microsoft Ads Grader rating"},{"title":"Key Issues","desc":"Critical problems found"},{"title":"Best Practices","desc":"Industry standards"}],"analysis":[{"title":"Deep Scan","desc":"Detailed findings"},{"title":"Trend Data","desc":"Historical changes"},{"title":"Competitor Gap","desc":"How you compare"}],"scoring":[{"title":"Grade Card","desc":"A-F rating breakdown"},{"title":"Priority Fixes","desc":"Most impactful changes"},{"title":"Strengths","desc":"What works well"}],"recommendations":[{"title":"Action Plan","desc":"Step-by-step fixes"},{"title":"Quick Wins","desc":"Easy improvements"},{"title":"Long-term Strategy","desc":"Growth roadmap"}]},
...
export function MicrosoftAdsGraderPage() {
  const { user } = useAuth();
...
export default MicrosoftAdsGraderPage;
