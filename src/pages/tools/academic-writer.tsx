...
const TOOL_DATA = {
  ...
  tabs: [{"id":"overview","name":"Overview","icon":"📊"},{"id":"research","name":"Research","icon":"🔍"},{"id":"citation","name":"Citations","icon":"📑"},{"id":"formatting","name":"Formatting","icon":"📝"}],
  tabImages: {"overview":["005a225ab33c9f1a8a73d4b3c442f2ae.png","01105d3179e5710817d925e86f3cc698.png","013a9a763684472490af6bc7aabfbfa8.png"],"research":["014af3803f7fe988bc4661386f1e80f7.png","01b569fd1095ed0daf4f923864e685bc.png","027fc88df11eecda52c049fe445b632c.png"],"citation":["0282fe00d374d04aa480de2d9a670e2b.png","02_Tools.png","02e8e5634b78ceb2774970a2e6da424b.png"],"formatting":["036265215728864b7af2c3b2a02734c3.png","03681bc55f03d74f268322db7e5d76bc.png","036d94a7180ccdb51d9a536e508829a2.png"]},
  tabDescriptions: {"overview":[{"title":"Content Brief","desc":"Topic setup"},{"title":"Structure","desc":"Outline builder"},{"title":"Target Audience","desc":"Reader profile"}],"research":[{"title":"AI Draft","desc":"Auto-write"},{"title":"Tone Control","desc":"Voice style"},{"title":"Length","desc":"Word count"}],"citation":[{"title":"Grammar","desc":"Error check"},{"title":"Readability","desc":"Clarity score"},{"title":"Originality","desc":"Plagiarism check"}],"formatting":[{"title":"SEO Check","desc":"Search optimize"},{"title":"Export","desc":"Download file"},{"title":"Publish","desc":"Go live"}]},
...
export function AcademicWriterPage() {
  const { user } = useAuth();
...
export default AcademicWriterPage;
