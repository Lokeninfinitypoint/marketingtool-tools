...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["57a1581037cb539b8609df2e95fe2928.png","57ba9fbad69e0ac8af1b814de12e372d.png","589a97fc8440211a5969d5404370b8c2.png"],"writing":["58a1927cbd42b79353f66a3451ef31d6.png","58ca16b1db997cc1663f3b0e01554a99.png","58e3775d1124a0e15f53d6d639dafd24.png"],"editing":["5a6794d9f07c30a173a3b78a8b1f6a6a.png","5b232ac841a548a7d2dc4bd9a0ff5cae.png","5b4e4535c8bf4397cd63b73e92c95f13.png"],"publish":["5b64dc58ccbd381a710eb1cfd6f09fcb.png","5ef9171736dffe8838375d0690f2d371.png","637af7b11139f43f3667b1a79d32d498.png"]},
  tabDescriptions: {"overview":[{"title":"Subject","desc":"Topic setup"},{"title":"Level","desc":"Difficulty"},{"title":"Format","desc":"Study type"}],"writing":[{"title":"Generate","desc":"Create notes"},{"title":"Flashcards","desc":"Quick review"},{"title":"Summary","desc":"Key points"}],"editing":[{"title":"Practice","desc":"Test yourself"},{"title":"Quiz","desc":"Quick quiz"},{"title":"Review","desc":"Check answers"}],"publish":[{"title":"Export","desc":"Download PDF"},{"title":"Share","desc":"Send to group"},{"title":"Track","desc":"Study progress"}]},
  tips: [{"title":"Name the Subject","desc":"Specify the exact topic or course."},{"title":"Set Difficulty","desc":"Indicate beginner, intermediate, or advanced."},{"title":"Define Format","desc":"Choose notes, flashcards, quiz, or summary."}],
};
...
export function StudyNotesGeneratorPage() {
  const { user } = useAuth();
...
export default StudyNotesGeneratorPage;
