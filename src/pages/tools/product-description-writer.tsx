...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["company profile presentation.jpg","contact_bg.jpeg","contact_bg_2.jpeg"],"writing":["countbg.jpg","counter.jpg","cover_cmhniyboy0002v8rvph8hiy8x_1762451532070_wcrdiyxr82b.jpg"],"editing":["crane.jpg","css-structure-1.jpg","css.jpg"],"publish":["cta_bg.jpeg","cta_bg_2.jpeg","dark-home.jpg"]},
...
export function ProductDescriptionWriterPage() {
  const { user } = useAuth();
...
export default ProductDescriptionWriterPage;
