...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["bg-shape-five.png","bg-shape-four.png","bg-shape-one.png"],"configure":["bg-shape-tree.png","bg-trans.png","billboardSample.png"],"generate":["blog-detailes-01.png","blog-detailes-02.png","bookmark2.png"],"results":["bookmark3.png","bookmark4.png","brand-logo.png"]},
  tabDescriptions: {"overview":[{"title":"Lead Magnets","desc":"Your assets"},{"title":"Downloads","desc":"Conversion data"},{"title":"Top Performers","desc":"Best leads"}],"configure":[{"title":"Content Type","desc":"Choose format"},{"title":"AI Writer","desc":"Generate content"},{"title":"Value Prop","desc":"Key benefits"}],"generate":[{"title":"Layout","desc":"Template design"},{"title":"Branding","desc":"Visual style"},{"title":"Format","desc":"PDF/Guide/Checklist"}],"results":[{"title":"Landing Page","desc":"Capture form"},{"title":"Email Sequence","desc":"Follow-up"},{"title":"Promotion","desc":"Traffic plan"}]},
  tips: [{"title":"Be Detailed","desc":"Provide specific information for accurate Lead Magnet Creator results."},{"title":"Set Clear Goals","desc":"Define what success looks like for your task."},{"title":"Iterate Results","desc":"Refine your input based on initial output."}],
};
...
export function LeadMagnetCreatorPage() {
  const { user } = useAuth();
...
export default LeadMagnetCreatorPage;
