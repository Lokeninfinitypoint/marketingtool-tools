...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["Success.png","TBLR_Check_selected.png","TBLR_Check_unselected.png"],"build":["TBLR_Control_selected.png","TBLR_Control_unselected.png","TBLR_Magnifier_selected.png"],"triggers":["TBLR_Magnifier_unselected.png","TBLR_Warnings_selected.png","TBLR_Warnings_unselected.png"],"logs":["Todo.png","Tree_Iso.png","Untitled.png"]},
...
export function WorkflowAutomationBuilderPage() {
  const { user } = useAuth();
...
export default WorkflowAutomationBuilderPage;
