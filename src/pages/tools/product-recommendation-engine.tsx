...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["hero_area_bg3.jpg","hero_bg.jpeg","hero_slider_1.jpeg"],"catalog":["hero_video_bg.jpeg","history-hero.jpg","html-structure-1.jpg"],"pricing":["html.jpg","img-1.jpg","img-10.jpg"],"promote":["img-11.jpg","img-2.jpg","img-3.jpg"]},
...
export function ProductRecommendationEnginePage() {
  const { user } = useAuth();
