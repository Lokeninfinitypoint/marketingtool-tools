...
const TOOL_DATA = {
  ...
  heroVideo: '/media/videos/new_media_0649.mp4',
  ...
  tabImages: {"overview":["f05bf7727144b9fc9dac07ce98cdcd18.webp","f0654bfb90422af06626aca8e38cc589.webp","f5d8653cefd222716d03b8b5d173be48.webp"],"analysis":["faec18c83360d43512a707c728a1463f.webp","fbe3ebbc34c5958f22167f60689b8c55.webp","ic_launcher.webp"],"scoring":["ic_launcher_foreground.webp","ic_launcher_round.webp","005a225ab33c9f1a8a73d4b3c442f2ae.png"],"recommendations":["01105d3179e5710817d925e86f3cc698.png","013a9a763684472490af6bc7aabfbfa8.png","014af3803f7fe988bc4661386f1e80f7.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your seo audit tool requirements...",
    "required": true
  }
];

export function SeoAuditToolPage() {
  const { user } = useAuth();
...
export default SeoAuditToolPage;
