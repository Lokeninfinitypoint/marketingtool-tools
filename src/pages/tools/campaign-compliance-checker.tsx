...
const TOOL_DATA = {
  ...
  badge: 'Audit',
  badgeColor: '#38a169',
  description: 'AI-powered campaign compliance checker',
  heroVideo: '/media/videos/Make%20Money%20with%20AI-Generated%20Cartoon%20Animation%20Videos.mp4',
  ...
  tabImages: {"overview":["movie.png","moving_text_shape.png","mutiple-carousel-img1.png"],"analysis":["mutiple-carousel-img2.png","mutiple-carousel-img3.png","mutiple-carousel-img4.png"],"scoring":["nav.png","news1.png","news10.png"],"recommendations":["news11.png","news12.png","news13.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your campaign compliance checker requirements...",
    "required": true
  }
];

export function CampaignComplianceCheckerPage() {
  const { user } = useAuth();
...
export default CampaignComplianceCheckerPage;
