...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["Forest_Hex.png","GlobalColor.png","Grass_Iso_Left.png"],"configure":["Grassland_Hex.png","f4b81fc72b0198b5885125ba78469be5.png","Log_Iso.png"],"generate":["Mountain_Hex.png","NoPath.png","OpenGL.png"],"results":["PageContent.png","Photoshop LogoSK.png","Placeholder_Inspector.png"]},
  tabDescriptions: {"overview":[{"title":"SEO Score","desc":"Site health"},{"title":"Rankings","desc":"Keyword positions"},{"title":"Visibility","desc":"Search presence"}],"configure":[{"title":"Technical SEO","desc":"Site structure"},{"title":"Speed Score","desc":"Load time"},{"title":"Mobile Ready","desc":"Mobile check"}],"generate":[{"title":"Content Quality","desc":"Writing score"},{"title":"Keyword Usage","desc":"Optimization"},{"title":"Readability","desc":"User friendly"}],"results":[{"title":"SERP Preview","desc":"Search display"},{"title":"Rank Tracking","desc":"Position changes"},{"title":"Opportunities","desc":"Growth areas"}]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your internal linking suggestions requirements...",
    "required": true
  },
  {
    "name": "url",
...
export function InternalLinkingSuggestionsPage() {
  const { user } = useAuth();
...
export default InternalLinkingSuggestionsPage;
