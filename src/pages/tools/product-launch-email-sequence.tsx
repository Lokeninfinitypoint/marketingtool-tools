...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["footer.jpg","footer_bg.jpeg","ftp-01.jpg"],"compose":["ftp-02.jpg","fund startup.jpg","galbg.jpg"],"personalize":["gallery_bg.jpeg","girl 2.jpg","girl.jpg"],"sequence":["glass-scratched.jpg","google data studio template.jpeg","google-ads.jpg"]},
...
export function ProductLaunchEmailSequencePage() {
  const { user } = useAuth();
...
export default ProductLaunchEmailSequencePage;
