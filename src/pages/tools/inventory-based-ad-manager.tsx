...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["Polaroid.Frame.png","Rectangle381.png","Russe Rocket - Vertical.png"],"catalog":["Sci-fi Grid.png","Sign_Iso.png","Spaceship.png"],"pricing":["SplashScreenLegacy.png","Stump_Iso.png","Success.png"],"promote":["TBLR_Check_selected.png","TBLR_Check_unselected.png","TBLR_Control_selected.png"]},
...
export function InventoryBasedAdManagerPage() {
  const { user } = useAuth();
...
export default InventoryBasedAdManagerPage;
