...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["blog.jpg","brain 2.jpg","brain.jpg"],"writing":["brand-logo.jpg","button-2.jpg","button.jpg"],"editing":["callto-action.jpg","calltobg.jpg","change-default-color.jpg"],"publish":["change-email-setting.jpg","chat-bot-bg.jpg","clients.jpg"]},
...
export function PressReleaseGeneratorPage() {
  const { user } = useAuth();
...
export default PressReleaseGeneratorPage;
