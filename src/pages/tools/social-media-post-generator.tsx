...
const TOOL_DATA = {
  ...
  heroVideo: '/media/videos/new_media_0658.mp4',
  ...
  tabImages: {"overview":["50dc6e085d4119c841578610408235a3.png","51adfa69ca7f294f9afed92aa4c9c1ac.png","53444b1e5dc93bf1632d434641625f2d.png"],"writing":["53c4248fc9f25fe6275f4900f756b3a7.png","547f28896fb1a2f30aa77925e664e441.png","55411036857f11774ce24483d4e45c2d.png"],"editing":["555994644_pvt ltd company.png","5590f347fd864703b3413c0458a7e477.png","55ae9d91011f194762b652dd3a06f05b.png"],"publish":["55b9f4803fc65aef6c621a43c5da05f3.png","562a226345b2c4762840ba4ecd9a91cd.png","565d280f5ba73152f1d8e88bd00b1e41.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your social media post generator requirements...",
    "required": true
  },
  {
    "name": "platform",
...
export function SocialMediaPostGeneratorPage() {
  const { user } = useAuth();
