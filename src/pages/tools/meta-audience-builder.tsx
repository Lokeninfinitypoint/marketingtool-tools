...
const TOOL_DATA = {
  ...
  badge: 'Facebook/Meta',
  badgeColor: '#1877F2',
  description: 'AI-powered meta audience builder',
  heroVideo: '/media/videos/Pinterest%2853%29.mp4',
  ...
  tabImages: {"overview":["google-login.png","google.png","group3320.png"],"targeting":["group3396.png","group3474.png","group9060.png"],"creative":["group9102.png","group93352.png","grunt.png"],"optimize":["header-4096x2304.png","header-dashboard.png","header-default.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your meta audience builder requirements...",
    "required": true
  },
  {
    "name": "audience",
...
export function MetaAudienceBuilderPage() {
  const { user } = useAuth();
...
export default MetaAudienceBuilderPage;
