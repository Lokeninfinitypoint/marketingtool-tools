...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["gallery-img3.png","gallery-img4.png","gallery-img5.png"],"writing":["gallery-img6.png","gallery-img7.png","gallery-img8.png"],"editing":["gallery-img9.png","gallery.png","gallery2.png"],"publish":["gallery3.png","gallery4.png","gallery5.png"]},
  tabDescriptions: {"overview":[{"title":"Brand Profile","desc":"Identity summary"},{"title":"Voice Score","desc":"Consistency"},{"title":"Guidelines","desc":"Brand rules"}],"writing":[{"title":"Tone Setup","desc":"Define voice"},{"title":"Personality","desc":"Brand traits"},{"title":"Values","desc":"Core beliefs"}],"editing":[{"title":"Generate","desc":"On-brand content"},{"title":"Adapt","desc":"Restyle text"},{"title":"Templates","desc":"Brand templates"}],"publish":[{"title":"Audit","desc":"Consistency check"},{"title":"Deviations","desc":"Off-brand items"},{"title":"Auto-Fix","desc":"Corrections"}]},
  tips: [{"title":"Share Brand Examples","desc":"Include links to existing brand content."},{"title":"List Brand Values","desc":"Name your core values and personality traits."},{"title":"Define Target Market","desc":"Describe your ideal customer."}],
};
...
export function BrandVoiceGeneratorPage() {
  const { user } = useAuth();
...
export default BrandVoiceGeneratorPage;
