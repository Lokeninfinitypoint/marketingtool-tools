...
const TOOL_DATA = {
  ...
  badgeColor: '#FBBC05',
  description: 'AI-powered dayparting optimizer',
  heroVideo: '/media/videos/Pinterest%20%2831%29.mp4',
  ...
  tabImages: {"overview":["lamp.jpg","laptop-with-chart-and-glowing-distant-coworking-re-2026-01-11-08-42-31-utc.jpg","learn-debugging-basics.jpg"],"targeting":["learn-native-debugging.jpg","learn-react-native-devtools.jpg","magnifier.jpg"],"performance":["meta-content.jpg","monitor.jpg","motherboard 2.jpg"],"optimize":["motherboard.jpg","news2.jpg","news3.jpg"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your dayparting optimizer requirements...",
    "required": true
  },
  {
    "name": "keywords",
...
export function DaypartingOptimizerPage() {
  const { user } = useAuth();
...
export default DaypartingOptimizerPage;
