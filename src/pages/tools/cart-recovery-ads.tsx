...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["user-grid-bg2.png","user-grid-bg5.png","user-grid-bg6.png"],"catalog":["user-grid-bg7.png","user-grid-bg8.png","user-grid-bg9.png"],"pricing":["user-grid-img11.png","user-grid-img12.png","user-grid-img14.png"],"promote":["user-grid-img2.png","user-grid-img4.png","user-grid-img5.png"]},
...
export function CartRecoveryAdsPage() {
  const { user } = useAuth();
...
export default CartRecoveryAdsPage;
