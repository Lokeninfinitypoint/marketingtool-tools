...
const TOOL_DATA = {
  ...
  badgeColor: '#FBBC05',
  description: 'AI-powered geo targeting optimizer',
  heroVideo: '/media/videos/Pinterest%2812%29.mp4',
  ...
  tabImages: {"overview":["02e8e5634b78ceb2774970a2e6da424b.png","036265215728864b7af2c3b2a02734c3.png","03681bc55f03d74f268322db7e5d76bc.png"],"targeting":["036d94a7180ccdb51d9a536e508829a2.png","03_AIChat.png","03_ToolResult.png"],"performance":["03b06697daf2f6ac9641f178050018c1.png","0462d6a689202be7955ff5f99bdab462.png","04_AIChat.png"],"optimize":["04_History.png","053c5068b3122138005547f79bcf6e57.png","05_MemeGenerator.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your geo targeting optimizer requirements...",
    "required": true
  },
  {
    "name": "keywords",
...
export function GeoTargetingOptimizerPage() {
  const { user } = useAuth();
...
export default GeoTargetingOptimizerPage;
