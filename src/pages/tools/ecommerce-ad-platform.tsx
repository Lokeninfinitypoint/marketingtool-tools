...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["tools-bg.jpg","tools-hero.jpg","user-11.jpg"],"catalog":["user-12.jpg","user-13.jpg","user-14.jpg"],"pricing":["user-15.jpg","user-3.jpg","user-4.jpg"],"promote":["video_block.jpeg","video_block_shape.jpeg","web-analytics.jpg"]},
...
export function EcommerceAdPlatformPage() {
  const { user } = useAuth();
...
export default EcommerceAdPlatformPage;
