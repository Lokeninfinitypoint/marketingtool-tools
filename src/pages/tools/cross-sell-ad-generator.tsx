...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["fund startup.jpg","galbg.jpg","gallery_bg.jpeg"],"writing":["girl 2.jpg","girl.jpg","glass-scratched.jpg"],"editing":["google data studio template.jpeg","google-ads.jpg","google-analytics.jpg"],"publish":["google-content.jpg","google-seo.jpg","guy 2.jpg"]},
  tabDescriptions: {"overview":[{"title":"Store Stats","desc":"Sales overview"},{"title":"Products","desc":"Active items"},{"title":"Revenue","desc":"Sales data"}],"writing":[{"title":"Product Feed","desc":"Catalog sync"},{"title":"Categories","desc":"Organization"},{"title":"Inventory","desc":"Stock levels"}],"editing":[{"title":"Price Check","desc":"Competitor pricing"},{"title":"Discounts","desc":"Sale setup"},{"title":"Margins","desc":"Profit tracking"}],"publish":[{"title":"Ad Creator","desc":"Product ads"},{"title":"Cross-sell","desc":"Upsell offers"},{"title":"Retarget","desc":"Cart recovery"}]},
...
export function CrossSellAdGeneratorPage() {
  const { user } = useAuth();
...
export default CrossSellAdGeneratorPage;
