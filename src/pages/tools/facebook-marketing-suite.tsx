...
const TOOL_DATA = {
  ...
  badge: 'Facebook/Meta',
  badgeColor: '#1877F2',
  description: 'AI-powered facebook marketing suite',
  heroVideo: '/media/videos/Pinterest%20%288%29.mp4',
  ...
  tabImages: {"overview":["9622842db1c3b4226a9ce9072cccbc2f.webp","967a433fbf114aaa97df45fadec404b6.webp","99193051db185a6f2865c91fc31f57c8.webp"],"targeting":["9d082636d4aacf1a3c4342cacc068a32.webp","9d191aea39617e90a21a886b24f23f68.webp","9eeeab29ddc08da714935170cec7b416.webp"],"creative":["a0522a5d75007431c628372e492f8c4c.webp","a16d20c2e74bb8db5ce0c04dd64507fb.webp","a5d2515c92bc5a422775ba18ac6c14ce.webp"],"optimize":["a6253bdf7f0ba048283a68cc847fe331.webp","a9f87435006c17045d0bf7b4088da34e.webp","ac51b271d22ecd2b9e9c497381620094.webp"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your facebook marketing suite requirements...",
    "required": true
  },
  {
    "name": "audience",
...
export function FacebookMarketingSuitePage() {
  const { user } = useAuth();
...
export default FacebookMarketingSuitePage;
