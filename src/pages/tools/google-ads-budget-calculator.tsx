...
const TOOL_DATA = {
  ...
  badge: 'Google Ads',
  badgeColor: '#EA4335',
  description: 'AI-powered google ads budget calculator',
  heroVideo: '/media/videos/Pinterest%2813%29.mp4',
  tabs: [{"id":"overview","name":"Overview","icon":"📊"},{"id":"keywords","name":"Keywords","icon":"🔑"},{"id":"bidding","name":"Bidding","icon":"💵"},{"id":"optimize","name":"Optimize","icon":"🚀"}],
  tabImages: {"overview":["05_Profile.png","06_MemeGen.png","06_Profile.png"],"keywords":["0714f92dea58ee1adbcb4348b64d94c0.png","0718de85344c421f604988e421e608d9.png","077a3149fd779206ad3ef1e14e8faf65.png"],"bidding":["08e488cc4e5f340808fa58a0b6227129.png","0c34ac3cef8e4faf2bddd7b4d4297036.png","0d25b91a4777b23621a26d5f2dfe5cb1.png"],"optimize":["0d5ba2dabad4835552937b83bc74987d.png","0ecd021753d244d072cd511863fa6292.png","0ef746b3f6bee285632755121f0e8863.png"]},
  tabDescriptions: {"overview":[{"title":"Account Score","desc":"Overall health"},{"title":"Active Campaigns","desc":"Running ads"},{"title":"Quality Score","desc":"Ad relevance"}],"keywords":[{"title":"Keyword Match","desc":"Match types"},{"title":"Negative KW","desc":"Block terms"},{"title":"Search Terms","desc":"Actual queries"}],"bidding":[{"title":"Bid Strategy","desc":"Smart bidding"},{"title":"CPC Trends","desc":"Cost tracking"},{"title":"Budget Pace","desc":"Spend rate"}],"optimize":[{"title":"Ad Extensions","desc":"Sitelinks/Callouts"},{"title":"Landing Page","desc":"Page quality"},{"title":"Conversion Setup","desc":"Tracking"}]},
  tips: [{"title":"Include Keywords","desc":"List your target keywords for specific analysis."},{"title":"Set Budget","desc":"Specify daily/monthly budget for accurate forecasts."},{"title":"Define Goals","desc":"State conversion goals: leads, sales, or sign-ups."}],
};
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your google ads budget calculator requirements...",
    "required": true
  },
  {
    "name": "keywords",
...
export function GoogleAdsBudgetCalculatorPage() {
  const { user } = useAuth();
...
export default GoogleAdsBudgetCalculatorPage;
