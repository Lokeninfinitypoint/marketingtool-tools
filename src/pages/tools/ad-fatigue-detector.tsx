...
const TOOL_DATA = {
  ...
  tabs: [{"id":"overview","name":"Overview","icon":"📊"},{"id":"frequency","name":"Frequency","icon":"🔄"},{"id":"creative","name":"Creative","icon":"🎨"},{"id":"refresh","name":"Refresh","icon":"♻️"}],
  tabImages: {"overview":["1c440937d3aea203a4090944d82c9439.png","1dbdd014cf53d8e8bb67eaa67bd34f65.png","1df01723f3f61fd990d5531a51072f7b.png"],"frequency":["202568a90597e8b2b82acba80cf806a8.png","21.png","22.png"],"creative":["2208e851fe2f4c4784be70f9796c31e9.png","222ccbd9c02a04034df53d14603df4b5.png","22a64360567871f37fbb8ad1da4410a8.png"],"refresh":["23.png","2340_1560.png","2340_1560_1.png"]},
  tabDescriptions: {"overview":[{"title":"Fatigue Score","desc":"Creative health"},{"title":"Active Ads","desc":"Running creatives"},{"title":"Alert Status","desc":"Warning level"}],"frequency":[{"title":"Performance Trend","desc":"Over-time data"},{"title":"Engagement Drop","desc":"Interest loss"},{"title":"Cost Increase","desc":"CPC rising"}],"creative":[{"title":"Frequency Data","desc":"View counts"},{"title":"CTR Decline","desc":"Click drop-off"},{"title":"Audience Overlap","desc":"Saturation"}],"refresh":[{"title":"Refresh Plan","desc":"New creatives"},{"title":"Rotation Rules","desc":"Auto-rotate"},{"title":"Schedule","desc":"Refresh timing"}]},
  tips: [{"title":"Be Detailed","desc":"Provide specific information for accurate Ad Fatigue Detector results."},{"title":"Set Clear Goals","desc":"Define what success looks like for your task."},{"title":"Iterate Results","desc":"Refine your input based on initial output."}],
};
...
export function AdFatigueDetectorPage() {
  const { user } = useAuth();
...
export default AdFatigueDetectorPage;
