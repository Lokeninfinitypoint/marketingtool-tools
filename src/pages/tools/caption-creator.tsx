...
const TOOL_DATA = {
  ...
  badge: 'Social Media',
  badgeColor: '#e53e8c',
  description: 'AI-powered caption creator',
  heroVideo: '/media/videos/Pinterest%20%2811%29.mp4',
  ...
  tabImages: {"overview":["title.png","to-do.png","todolist-page.png"],"create":["toolsbar-modal.png","top-banner.png","top-level-await.png"],"schedule":["trail-bg.png","travel.png","use-guide.png"],"analytics":["user-grid-bg10.png","user-grid-bg11.png","user-grid-bg12.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your caption creator requirements...",
    "required": true
  },
  {
    "name": "platform",
...
export function CaptionCreatorPage() {
  const { user } = useAuth();
...
export default CaptionCreatorPage;
