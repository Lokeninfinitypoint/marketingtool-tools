...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["cat9.png","cb38817443c990755d145826631863ed.png","cf659ade351638581050d6a8fa447c26.png"],"competitors":["change-default-color.png","changelogo.png","channel_darkMode_selected.png"],"trends":["channel_darkMode_unselected.png","channel_lightMode_unselected.png","chat-export-code.png"],"strategy":["chat-gpt.png","chrome.png","contact App.png"]},
  tabDescriptions: {"overview":[{"title":"AI Dashboard","desc":"Agent status"},{"title":"Tasks","desc":"Active tasks"},{"title":"Performance","desc":"AI accuracy"}],"competitors":[{"title":"Configure","desc":"Setup agent"},{"title":"Rules","desc":"Business rules"},{"title":"Training","desc":"Custom data"}],"trends":[{"title":"Run Task","desc":"Execute now"},{"title":"Batch","desc":"Bulk process"},{"title":"Schedule","desc":"Auto-run"}],"strategy":[{"title":"Results","desc":"Output review"},{"title":"Quality","desc":"Score check"},{"title":"History","desc":"Past runs"}]},
...
export function MarketingAiAgentsHubPage() {
  const { user } = useAuth();
...
export default MarketingAiAgentsHubPage;
