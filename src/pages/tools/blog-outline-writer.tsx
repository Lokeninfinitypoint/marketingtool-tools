...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["edge.png","environment-settings.png","error-1.png"],"writing":["error-2.png","essential docs.png","export.png"],"editing":["f-pinia.png","f0e5eb83f003a0d04f55dfd9e5e6e013.png","f0ecf43435c3bd430c0ade1c2073ecf5.png"],"publish":["f10b0d27cc9c8f693b13500975b36576.png","f22c2453e5382e45140785256f212fb4.png","f313e94a3deeda3ca3903219670032f0.png"]},
...
export function BlogOutlineWriterPage() {
  const { user } = useAuth();
...
export default BlogOutlineWriterPage;
