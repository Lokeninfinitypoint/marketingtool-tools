...
const TOOL_DATA = {
  ...
  badge: 'Campaign',
  badgeColor: '#dd6b20',
  description: 'AI-powered campaign optimization engine',
  heroVideo: '/media/videos/Pin%20on%20CRM.mp4',
  ...
  tabImages: {"overview":["nft-img3.png","nft-img4.png","note.png"],"setup":["notes.png","notification-icon.png","objectrecognizer1.png"],"monitor":["openSkyFadeMask_gradientBox.png","partials.png","particle_circle.png"],"optimize":["particle_darkMode_selected.png","particle_darkMode_unselected.png","particle_lightMode_unselected.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your campaign optimization engine requirements...",
    "required": true
  }
];
...
export default CampaignOptimizationEnginePage;
