...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["use-guide.png","user-grid-bg10.png","user-grid-bg11.png"],"transform":["user-grid-bg12.png","user-grid-bg2.png","user-grid-bg5.png"],"style":["user-grid-bg6.png","user-grid-bg7.png","user-grid-bg8.png"],"export":["user-grid-bg9.png","user-grid-img11.png","user-grid-img12.png"]},
...
export function ParagraphExpanderPage() {
  const { user } = useAuth();
...
export default ParagraphExpanderPage;
