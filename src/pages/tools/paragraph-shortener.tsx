...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["10 Quick Wins with Data You Can Tackle Today.jpeg","2 - sine-gasflame.jpeg","20210414041430.jpeg"],"transform":["3 - sine-magenta.jpeg","3D Motion Poster for Business Growth _ Modern Digital Marketing Design.jpeg","4 - sine-green-yellow.jpeg"],"style":["5 - sine-purple-orange-black.jpeg","6 - sine-gray.jpeg","f0654bfb90422af06626aca8e38cc589.webp"],"export":["A Complete Path For The Successful E-Commerce Business.jpeg","AI Content Creation at Its Finest.jpeg","AI Content Writing for Website Optimization.jpeg"]},
...
export function ParagraphShortenerPage() {
  const { user } = useAuth();
...
export default ParagraphShortenerPage;
