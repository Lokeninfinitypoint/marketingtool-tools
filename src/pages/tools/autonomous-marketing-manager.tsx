...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["changelogo.png","channel_darkMode_selected.png","channel_darkMode_unselected.png"],"competitors":["channel_lightMode_unselected.png","chat-export-code.png","chat-gpt.png"],"trends":["chrome.png","contact App.png","contact-page.png"],"strategy":["contact_bg.png","crm-dark-rtl.png","crm-dark.png"]},
...
export function AutonomousMarketingManagerPage() {
  const { user } = useAuth();
...
export default AutonomousMarketingManagerPage;
