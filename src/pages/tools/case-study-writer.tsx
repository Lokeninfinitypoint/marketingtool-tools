...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["user-grid-img6.png","user-grid-img7.png","user-grid-img8.png"],"writing":["user-grid-img9.png","user-list.png","ut-image-01.png"],"editing":["video-img1.png","video-img2.png","video-img3.png"],"publish":["video-img4.png","video-photo-2.png","vk.png"]},
...
export function CaseStudyWriterPage() {
  const { user } = useAuth();
...
export default CaseStudyWriterPage;
