...
const TOOL_DATA = {
  ...
  badgeColor: '#FBBC05',
  description: 'AI-powered audience optimization tool',
  heroVideo: '/media/videos/Digital%20Marketing%20Tips%20for%20Beginners%20Social%20Media%20Growth%20Strateg%20%284%29.mp4',
  ...
  tabImages: {"overview":["bg-trans.png","billboardSample.png","blog-detailes-01.png"],"targeting":["blog-detailes-02.png","bookmark2.png","bookmark3.png"],"performance":["bookmark4.png","brand-logo.png","brave.png"],"optimize":["breadcrumb-bg.png","button-2.png","button.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your audience optimization tool requirements...",
    "required": true
  },
  {
    "name": "keywords",
...
export function AudienceOptimizationToolPage() {
  const { user } = useAuth();
...
export default AudienceOptimizationToolPage;
