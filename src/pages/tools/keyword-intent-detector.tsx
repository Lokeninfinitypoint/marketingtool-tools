...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["ambient_darkMode_unselected.png","ambient_lightMode_selected.png","ambient_lightMode_unselected.png"],"technical":["app-store.png","audit.png","auth-img.png"],"content":["author.png","auto-attach.png","axes.png"],"ranking":["b01cf0dfe0df7e1d04b8d2f3cd8497a6.png","b082a07d646098f66eb1b6d7bf9756b8.png","b0f24fe4687349f7cdbb36bf82b68988.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your keyword intent detector requirements...",
    "required": true
  },
  {
    "name": "url",
...
export function KeywordIntentDetectorPage() {
  const { user } = useAuth();
...
export default KeywordIntentDetectorPage;
