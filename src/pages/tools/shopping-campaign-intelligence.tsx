...
const TOOL_DATA = {
  ...
  badge: 'Campaign',
  badgeColor: '#dd6b20',
  description: 'AI-powered shopping campaign intelligence',
  heroVideo: '/media/videos/new_media_0654.mp4',
  ...
  tabImages: {"overview":["21.png","22.png","2208e851fe2f4c4784be70f9796c31e9.png"],"setup":["222ccbd9c02a04034df53d14603df4b5.png","22a64360567871f37fbb8ad1da4410a8.png","23.png"],"monitor":["2340_1560.png","2340_1560_1.png","23ac0e57976cbcdc4bc96df4329dcc0e.png"],"optimize":["24.png","25.png","2615305a8075efb4e793d83bc9a0eb96.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your shopping campaign intelligence requirements...",
    "required": true
  }
];

export function ShoppingCampaignIntelligencePage() {
  const { user } = useAuth();
...
export default ShoppingCampaignIntelligencePage;
