...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["advanced-tab-bg.png","ae0dca68e671c23400780aeec8a0c5f4.png","af18a87291e3057b5460a0d0106bd654.png"],"writing":["afa1512b105da38bf056de55ddf3d5e0.png","ambient_darkMode_unselected.png","ambient_lightMode_selected.png"],"editing":["ambient_lightMode_unselected.png","app-store.png","audit.png"],"publish":["auth-img.png","author.png","auto-attach.png"]},
...
export function YoutubeDescriptionGeneratorPage() {
  const { user } = useAuth();
