...
const TOOL_DATA = {
  ...
  badge: 'Facebook/Meta',
  badgeColor: '#1877F2',
  description: 'AI-powered meta comment manager',
  heroVideo: '/media/videos/Pinterest%2856%29.mp4',
  ...
  tabImages: {"overview":["img14.png","img15.png","img2.png"],"targeting":["img3.png","img4.png","img5.png"],"creative":["img6.png","img7.png","img8.png"],"optimize":["img9.png","import.png","instrumentation-breakpoints2.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your meta comment manager requirements...",
    "required": true
  },
  {
    "name": "audience",
...
export function MetaCommentManagerPage() {
  const { user } = useAuth();
...
export default MetaCommentManagerPage;
