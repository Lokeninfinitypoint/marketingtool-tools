...
const TOOL_DATA = {
  ...
  badge: 'Campaign',
  badgeColor: '#dd6b20',
  description: 'AI-powered rule based campaign manager',
  heroVideo: '/media/videos/new_media_0640.mp4',
  tabs: [{"id":"overview","name":"Overview","icon":"📊"},{"id":"setup","name":"Setup","icon":"⚙️"},{"id":"monitor","name":"Monitor","icon":"📈"},{"id":"optimize","name":"Optimize","icon":"🚀"}],
  tabImages: {"overview":["138e55c58c358c309e59ba18f6540100.webp","141072e8bb30e668c73c7d35c8b12f18.webp","15da826a1203972392201aa308cb7a26.webp"],"setup":["19cff19e740ee61bd1c34a8c36906aea.webp","1b4973405a768a3bb73135aabf5efd6c.webp","1b857c45034273728acda012e79dcfe8.webp"],"monitor":["1ccfd246bc759a17290b8518fcb1cb9c.webp","2021_Facebook_icon.svg.webp","20331e7f44a1ba700af1c48b8b71863a.webp"],"optimize":["20f464ff5cd5eb8f5482717b264a598c.webp","24545a9c4755d6f4ff66beffd18ebb38.webp","27e3424f9043ad918863987b9d48f569.webp"]},
  tabDescriptions: {"overview":[{"title":"Campaign Status","desc":"Active campaigns"},{"title":"Performance","desc":"Key metrics"},{"title":"Budget Pacing","desc":"Spend tracking"}],"setup":[{"title":"Campaign Builder","desc":"Create campaigns"},{"title":"Audience Config","desc":"Targeting setup"},{"title":"Creative Upload","desc":"Ad assets"}],"monitor":[{"title":"Live Metrics","desc":"Real-time data"},{"title":"Alerts","desc":"Performance alerts"},{"title":"Daily Summary","desc":"Daily report"}],"optimize":[{"title":"Auto Rules","desc":"Optimization rules"},{"title":"Bid Adjust","desc":"Bid management"},{"title":"Scale Plan","desc":"Growth strategy"}]},
  tips: [{"title":"Define Objective","desc":"Specify campaign goal: awareness, traffic, or conversions."},{"title":"Set Budget Range","desc":"Include your budget for realistic recommendations."},{"title":"Name Your Audience","desc":"Describe your ideal customer profile."}],
};
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your rule based campaign manager requirements...",
    "required": true
  }
];

export function RuleBasedCampaignManagerPage() {
  const { user } = useAuth();
...
export default RuleBasedCampaignManagerPage;
