...
const TOOL_DATA = {
  ...
  badge: 'Facebook/Meta',
  badgeColor: '#1877F2',
  description: 'AI-powered meta conversion tracker',
  heroVideo: '/media/videos/Pinterest%286%29.mp4',
  ...
  tabImages: {"overview":["integrations.png","invoice-pattern.png","iphone.png"],"targeting":["iphone_retina4_default_image.png","javascript-structure-1.png","js.png"],"creative":["kanban-1.png","kanban-2.png","kanban-3.png"],"optimize":["kanban-4.png","kanbanBoard.png","landing-page.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your meta conversion tracker requirements...",
    "required": true
  },
  {
    "name": "audience",
...
export function MetaConversionTrackerPage() {
  const { user } = useAuth();
...
export default MetaConversionTrackerPage;
