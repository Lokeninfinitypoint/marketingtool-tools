...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["question.jpg","quote.jpg","responsive.jpg"],"metrics":["robot using mobile phone.jpeg","robot.jpg","seo-bg.jpg"],"insights":["services_bg.jpeg","shopify-ads.jpg","stand 2.jpg"],"export":["stand 3.jpg","stand.jpg","staps_bg.jpeg"]},
  tabDescriptions: {"overview":[{"title":"Report Hub","desc":"All reports"},{"title":"Templates","desc":"Quick start"},{"title":"Recent","desc":"Latest reports"}],"metrics":[{"title":"Build Report","desc":"Custom report"},{"title":"Data Sources","desc":"Connect data"},{"title":"Visualize","desc":"Charts & graphs"}],"insights":[{"title":"Auto-Send","desc":"Email schedule"},{"title":"Frequency","desc":"How often"},{"title":"Recipients","desc":"Who gets it"}],"export":[{"title":"Export","desc":"Download PDF"},{"title":"Share Link","desc":"Online view"},{"title":"Permissions","desc":"Access control"}]},
