...
const TOOL_DATA = {
  ...
  badge: 'Campaign',
  badgeColor: '#dd6b20',
  description: 'AI-powered campaign a/b test manager',
  heroVideo: '/media/videos/LLM-Agenten%20Revolution%C3%A4re%20Planungsmethoden%20enth%C3%BCllt%20%282%29.mp4',
  ...
  tabImages: {"overview":["hero_bg_2.png","horizontal-card-img1.png","horizontal-card-img2.png"],"setup":["horizontal-card-img3.png","horizontal-card-img4.png","icon-256.png"],"monitor":["icon-512.png","icon-shape-five.png","icon_undefined.png"],"optimize":["image-generator1.png","image-generator2.png","image-generator3.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your campaign ab test manager requirements...",
    "required": true
  }
];

export function CampaignAbTestManagerPage() {
  const { user } = useAuth();
...
export default CampaignAbTestManagerPage;
