...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["5b4e4535c8bf4397cd63b73e92c95f13.png","5b64dc58ccbd381a710eb1cfd6f09fcb.png","5ef9171736dffe8838375d0690f2d371.png"],"configure":["637af7b11139f43f3667b1a79d32d498.png","654c8939c0a506b97974184e94d48b66.png","661ca1614536421c475c3a5847afb4f8.png"],"generate":["6712a68ca7c16b2eed0271ca2b008e7d.png","677ba27659c590bd94e196476786d08e.png","6903896ead76d4128d7533079a230f95.png"],"results":["6912d722e0c069ceca6e4c2dd7e9fc89.png","693793c99eacc052bfddd2252c85fb19.png","693f5452a8723177166062ea2f908c70.png"]},
  tabDescriptions: {"overview":[{"title":"Ad Health","desc":"Overall score"},{"title":"Active Ads","desc":"Running count"},{"title":"Key Metrics","desc":"Top numbers"}],"configure":[{"title":"Deep Scan","desc":"Detailed review"},{"title":"Creative Check","desc":"Visual analysis"},{"title":"Copy Review","desc":"Text analysis"}],"generate":[{"title":"Quality Score","desc":"Ad quality"},{"title":"Relevance","desc":"Audience match"},{"title":"Performance","desc":"Results grade"}],"results":[{"title":"Fix List","desc":"Priority actions"},{"title":"Benchmarks","desc":"Compare data"},{"title":"Export","desc":"Download report"}]},
  tips: [{"title":"Be Detailed","desc":"Provide specific information for accurate Advanced Ad Analyzer results."},{"title":"Set Clear Goals","desc":"Define what success looks like for your task."},{"title":"Iterate Results","desc":"Refine your input based on initial output."}],
};
...
export function AdvancedAdAnalyzerPage() {
  const { user } = useAuth();
...
export default AdvancedAdAnalyzerPage;
