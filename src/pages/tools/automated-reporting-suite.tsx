...
// Tool Data
const TOOL_DATA = {
  slug: 'automated-reporting-suite',
  name: 'Automated Reporting Suite',
  badge: 'Analytics',
  badgeColor: '#805ad5',
  description: 'AI-powered automated reporting suite',
  heroVideo: '/media/videos/Digital%20Marketing%20Tips%20for%20Beginners%20Social%20Media%20Growth%20Strateg%20%287%29.mp4',
  ...
  tabImages: {"overview":["carousel-img3.png","carousel-img4.png","cat10.png"],"metrics":["cat11.png","cat12.png","cat6.png"],"insights":["cat7.png","cat8.png","cat9.png"],"export":["cb38817443c990755d145826631863ed.png","cf659ade351638581050d6a8fa447c26.png","change-default-color.png"]},
  tabDescriptions: {"overview":[{"title":"Auto Reports","desc":"Active automations"},{"title":"Delivered","desc":"Sent reports"},{"title":"Queue","desc":"Pending"}],"metrics":[{"title":"Data Sources","desc":"Connect platforms"},{"title":"Templates","desc":"Report layouts"},{"title":"Metrics","desc":"What to track"}],"insights":[{"title":"Frequency","desc":"How often"},{"title":"Recipients","desc":"Who gets it"},{"title":"Format","desc":"PDF/Email/Dashboard"}],"export":[{"title":"Edit Rules","desc":"Modify automations"},{"title":"Pause/Resume","desc":"Control flow"},{"title":"History","desc":"Past reports"}]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your automated reporting suite requirements...",
    "required": true
  }
];

export function AutomatedReportingSuitePage() {
  const { user } = useAuth();
...
export default AutomatedReportingSuitePage;
