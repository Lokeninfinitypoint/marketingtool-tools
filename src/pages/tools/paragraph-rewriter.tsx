...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["video-img3.png","video-img4.png","video-photo-2.png"],"writing":["vk.png","warning.png","wasm-dwarf.png"],"editing":["wave-background.png","web-worker.png","webview2.png"],"publish":["whitenoise_256.png","1 - sine-purple-orange.jpeg","10 Best E-commerce Development Tips for Dubai Businesses.jpeg"]},
...
export function ParagraphRewriterPage() {
  const { user } = useAuth();
