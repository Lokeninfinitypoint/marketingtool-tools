...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["f91f0899e138768563a92cc3fb39a6ef.png","faafb8603d58a0adba3eba1a0c5ce5fb.png","facebook.png"],"competitors":["facebook_share_image.png","faq-img.png","fb6056c5547a8616040df3ce3b2acee5.png"],"trends":["fbde6af1bda85334be9adb27d3a2bc0f.png","fced24483037f82cdd29cfe40a82872e.png","fe21d33bb536ca4e26000a829c9292f4.png"],"strategy":["fe5f8a59dbaae734d6da4096f369ef4a.png","feature-card-image7.png","featured-creator1.png"]},
  tabDescriptions: {"overview":[{"title":"Software Hub","desc":"All platforms"},{"title":"Active Tools","desc":"In use"},{"title":"Spend","desc":"Software costs"}],"competitors":[{"title":"Tool Directory","desc":"Browse tools"},{"title":"Categories","desc":"By function"},{"title":"Reviews","desc":"User ratings"}],"trends":[{"title":"Connected","desc":"Active links"},{"title":"API Keys","desc":"Access setup"},{"title":"Data Flow","desc":"Sync status"}],"strategy":[{"title":"Licenses","desc":"Subscriptions"},{"title":"Usage Stats","desc":"Activity data"},{"title":"Budget","desc":"Cost tracking"}]},
  tips: [{"title":"Be Detailed","desc":"Provide specific information for accurate Marketing Software Hub results."},{"title":"Set Clear Goals","desc":"Define what success looks like for your task."},{"title":"Iterate Results","desc":"Refine your input based on initial output."}],
};
...
export function MarketingSoftwareHubPage() {
  const { user } = useAuth();
...
export default MarketingSoftwareHubPage;
