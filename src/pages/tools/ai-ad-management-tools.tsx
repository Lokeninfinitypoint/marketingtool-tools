...
const TOOL_DATA = {
  ...
  tabs: [{"id":"overview","name":"Overview","icon":"📊"},{"id":"configure","name":"Configure","icon":"⚙️"},{"id":"execute","name":"Execute","icon":"⚡"},{"id":"results","name":"Results","icon":"📋"}],
  tabImages: {"overview":["72707286241826c60239067a2d420b7a.png","73329f2edefb31a41e508107d58db6fb.png","737fc83f4af29d6f3fa841d353287b8b.png"],"configure":["73f3143836ff5ad28fe439bdc3054c04.png","7406eefbb0b001fcf5594f4519a91989.png","7493778d82b2648ef0174d53231e4b3c.png"],"execute":["74b128e3bcebf9ad92449ea21fc5d275.png","74c679b74ddeeac0e3c2d00f2642011b.png","74de9d4ecd7252d128542458bd914e7d.png"],"results":["7748f15c156ec76798896a429f0cf32c.png","779c764ef1c14e11a41ce82608107dbb.png","7a0aeea2918cc669fb00d9fd035d447a.png"]},
  tabDescriptions: {"overview":[{"title":"AI Dashboard","desc":"Agent status"},{"title":"Tasks","desc":"Active tasks"},{"title":"Performance","desc":"AI accuracy"}],"configure":[{"title":"Configure","desc":"Setup agent"},{"title":"Rules","desc":"Business rules"},{"title":"Training","desc":"Custom data"}],"execute":[{"title":"Run Task","desc":"Execute now"},{"title":"Batch","desc":"Bulk process"},{"title":"Schedule","desc":"Auto-run"}],"results":[{"title":"Results","desc":"Output review"},{"title":"Quality","desc":"Score check"},{"title":"History","desc":"Past runs"}]},
  tips: [{"title":"Define the Task","desc":"Be specific about what the AI should accomplish."},{"title":"Set Parameters","desc":"Include constraints, limits, and success criteria."},{"title":"Provide Context","desc":"Share background data for more accurate results."}],
};
...
export function AiAdManagementToolsPage() {
  const { user } = useAuth();
...
export default AiAdManagementToolsPage;
