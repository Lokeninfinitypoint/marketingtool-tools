...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["firebase1.png","firefox.png","flame-chart.png"],"metrics":["folder-structure-1.png","folder-structure-2.png","fonts.png"],"insights":["forgot-pass-img.png","gallery-img1.png","gallery-img10.png"],"export":["gallery-img11.png","gallery-img12.png","gallery-img2.png"]},
  tabDescriptions: {"overview":[{"title":"Safety Score","desc":"Brand health"},{"title":"Active Monitors","desc":"Tracking count"},{"title":"Risk Level","desc":"Current status"}],"metrics":[{"title":"Content Scan","desc":"Ad placement"},{"title":"Keyword Watch","desc":"Term tracking"},{"title":"Platform Check","desc":"Where ads show"}],"insights":[{"title":"Block Lists","desc":"Excluded sites"},{"title":"Allow Lists","desc":"Approved sites"},{"title":"Sensitivity","desc":"Filter level"}],"export":[{"title":"Incident Log","desc":"Past issues"},{"title":"Resolution","desc":"Actions taken"},{"title":"Prevention","desc":"Future guards"}]},
...
export function BrandSafetyMonitorPage() {
  const { user } = useAuth();
...
export default BrandSafetyMonitorPage;
