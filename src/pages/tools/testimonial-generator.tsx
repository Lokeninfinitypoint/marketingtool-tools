...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["6d107688532c8d2425145f5d6cfa065a.png","6e94a9253c9dae2a2bbde3e14a7d55bc.png","6fc8dfddf7fd7255d86361f31adc36c8.png"],"writing":["705fb3d0483c26a5b19a59146723a239.png","709eb1b05980742d06aa4e315bb0270d.png","71602ec35adbd144d552cb32d6f3bf2a.png"],"editing":["71ad4cbbacd0bd20582ec491e4ff1200.png","72481c627abccae437b2b165d30d8c67.png","72707286241826c60239067a2d420b7a.png"],"publish":["73329f2edefb31a41e508107d58db6fb.png","737fc83f4af29d6f3fa841d353287b8b.png","73f3143836ff5ad28fe439bdc3054c04.png"]},
  tabDescriptions: {"overview":[{"title":"Testimonials","desc":"Your reviews"},{"title":"Rating","desc":"Average score"},{"title":"Usage Stats","desc":"Where shown"}],"writing":[{"title":"AI Generate","desc":"Create reviews"},{"title":"Templates","desc":"Review formats"},{"title":"Industries","desc":"Niche style"}],"editing":[{"title":"Collection","desc":"Gather reviews"},{"title":"Approval","desc":"Review & publish"},{"title":"Categories","desc":"Sort by type"}],"publish":[{"title":"Widgets","desc":"Display options"},{"title":"Social Proof","desc":"Trust badges"},{"title":"Placement","desc":"Where to show"}]},
  tips: [{"title":"Be Detailed","desc":"Provide specific information for accurate Testimonial Generator results."},{"title":"Set Clear Goals","desc":"Define what success looks like for your task."},{"title":"Iterate Results","desc":"Refine your input based on initial output."}],
};
...
export function TestimonialGeneratorPage() {
  const { user } = useAuth();
