...
const TOOL_DATA = {
  ...
  badge: 'Budget',
  badgeColor: '#48bb78',
  description: 'AI-powered marketing budget planner',
  heroVideo: '/media/videos/Pinterest%2843%29.mp4',
  ...
  tabImages: {"overview":["d319ca147113424be96be348ced23ba2.png","d327650eb8518cfa4a00b7d35823f324.png","d36fadaf871544a015476718b416eb3d.png"],"allocation":["d4a33ba1000ab14ccc14eb1fb7ffaf46.png","d57fefa16782040d0e89a675e36df06f.png","d5a46f09fe801afa4888c8252a255abf.png"],"forecast":["d72bf484d39cfaf76a050830b7f02662.png","d7e3dfb7fbb679e5b0e98dde03540827.png","d8c503e3ab5b7fb5970734b2d4ed0fad.png"],"optimize":["d9f1c7bf3721c92da9e5b4457ca06689.png","dark-light.png","dashboard.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your marketing budget planner requirements...",
    "required": true
  }
];

export function MarketingBudgetPlannerPage() {
  const { user } = useAuth();
...
export default MarketingBudgetPlannerPage;
