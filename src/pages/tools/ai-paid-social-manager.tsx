...
const TOOL_DATA = {
  ...
  badge: 'Social Media',
  badgeColor: '#e53e8c',
  description: 'AI-powered ai paid social manager',
  heroVideo: '/media/videos/Custom%20ChatGPT%20Chatbots%20for%20Businesses.mp4',
  ...
  tabImages: {"overview":["f4b81fc72b0198b5885125ba78469be5.png","Log_Iso.png","Mountain_Hex.png"],"create":["NoPath.png","OpenGL.png","PageContent.png"],"schedule":["Photoshop LogoSK.png","Placeholder_Inspector.png","Polaroid.Frame.png"],"analytics":["Rectangle381.png","Russe Rocket - Vertical.png","Sci-fi Grid.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your ai paid social manager requirements...",
    "required": true
  },
  {
    "name": "platform",
...
export function AiPaidSocialManagerPage() {
  const { user } = useAuth();
...
export default AiPaidSocialManagerPage;
