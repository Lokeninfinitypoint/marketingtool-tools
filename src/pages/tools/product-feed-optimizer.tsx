...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["detail 2.jpg","detail.jpg","doc for company registration.jpg"],"catalog":["e-commerce web dolution.jpeg","ecommerce-seo.jpg","email-marketing.jpg"],"pricing":["facebook-ads.jpg","faq_bg.jpeg","faq_bg_2.jpeg"],"promote":["features.jpg","footer-2.jpg","footer-3.jpg"]},
...
export function ProductFeedOptimizerPage() {
  const { user } = useAuth();
...
export default ProductFeedOptimizerPage;
