...
const TOOL_DATA = {
  ...
  tabs: [{"id":"overview","name":"Overview","icon":"📊"},{"id":"build","name":"Build","icon":"🏗️"},{"id":"triggers","name":"Triggers","icon":"⚡"},{"id":"logs","name":"Logs","icon":"📋"}],
  tabImages: {"overview":["2648e5d13e5265c8876e8de3026fffa3.png","26bcd8334dacdf81063917e434bae50f.png","297db4529ffd4792b6e27032d6618cab.png"],"build":["2acc810b943449927425101cfc9c9a47.png","2c7c66614c9f13040f87a50cd2c1c44d.png","2ef7ec1624303a90721247b5fdde4429.png"],"triggers":["2fdbac3c62f35c28cb04aa8120b41d18.png","308a0c79016953a161d0f2e20c627f8a.png","30e57079acdf2a4981480fa48edbf841.png"],"logs":["323e8d56af9bc6f95a7dca12f4c1cca4.png","328c87a833feea78aadd11e0b9051c43.png","335c9e535ef4bccb276cb68b21c53e25.png"]},
  tabDescriptions: {"overview":[{"title":"Active Flows","desc":"Running workflows"},{"title":"Success Rate","desc":"Reliability"},{"title":"Run History","desc":"Past runs"}],"build":[{"title":"Flow Builder","desc":"Create workflow"},{"title":"Templates","desc":"Pre-built"},{"title":"Conditions","desc":"If/then logic"}],"triggers":[{"title":"Triggers","desc":"Event-based"},{"title":"Schedule","desc":"Time-based"},{"title":"Webhooks","desc":"API triggers"}],"logs":[{"title":"Run Logs","desc":"Execution detail"},{"title":"Errors","desc":"Failed runs"},{"title":"Speed","desc":"Performance"}]},
  tips: [{"title":"Describe the Process","desc":"Explain the workflow you want to automate."},{"title":"Set Triggers","desc":"Define what events should start the automation."},{"title":"Define Actions","desc":"List what should happen when triggered."}],
};
...
export function SmartSchedulingEnginePage() {
  const { user } = useAuth();
...
export default SmartSchedulingEnginePage;
