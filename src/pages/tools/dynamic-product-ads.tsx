...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["robot.jpg","seo-bg.jpg","services_bg.jpeg"],"catalog":["shopify-ads.jpg","stand 2.jpg","stand 3.jpg"],"pricing":["stand.jpg","staps_bg.jpeg","testimonial_bg.jpeg"],"promote":["testimonial_bg_1.jpeg","thumb.jpg","thumbnail_cmi651dcy0000v874350py1s9_1763608657177_i0kcx7br7u.jpg"]},
...
export function DynamicProductAdsPage() {
  const { user } = useAuth();
...
export default DynamicProductAdsPage;
