...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["ecommerce-dark.png","ecommerce-rtl.png","ecommerce.png"],"metrics":["ed2d3d3c595044213078881f4bd388cf.png","edge.png","environment-settings.png"],"insights":["error-1.png","error-2.png","essential docs.png"],"export":["export.png","f-pinia.png","f0e5eb83f003a0d04f55dfd9e5e6e013.png"]},
  tabDescriptions: {"overview":[{"title":"KPI Dashboard","desc":"Key metrics"},{"title":"Health Score","desc":"Overall status"},{"title":"Trends","desc":"Direction"}],"metrics":[{"title":"Revenue KPIs","desc":"Sales metrics"},{"title":"Marketing KPIs","desc":"Campaign data"},{"title":"Custom KPIs","desc":"Your metrics"}],"insights":[{"title":"Real-Time","desc":"Live tracking"},{"title":"Historical","desc":"Past data"},{"title":"Comparisons","desc":"Period vs period"}],"export":[{"title":"Targets","desc":"Goal setting"},{"title":"Progress","desc":"Achievement %"},{"title":"Forecasts","desc":"Projected reach"}]},
...
export function MarketingKpiDashboardPage() {
  const { user } = useAuth();
...
export default MarketingKpiDashboardPage;
