...
const TOOL_DATA = {
  ...
  badge: 'Facebook/Meta',
  badgeColor: '#1877F2',
  description: 'AI-powered facebook ads orchestrator',
  heroVideo: '/media/videos/Pinterest%20%286%29.mp4',
  ...
  tabImages: {"overview":["65fc12fb316af5e0acb76eee3a69ae67.webp","6697619d302393b530e34c68092085a0.webp","66f50146fd356228826b88c1cc720af9.webp"],"targeting":["671da94427384c7167652c8b5c306c46.webp","6bc6a3f9e0686d70b16b07f4ccf08a53.webp","6cd6e954659fb0bfba14a7a34aed5546.webp"],"creative":["6cd934dd776bea9e102fb652252f6fce.webp","6f7e502ff3be02eecb44866c90a20582.webp","7aade642d5f063896295de1e9ac5ec30.webp"],"optimize":["7bcb24e32ea94fa33a342e990df14702.webp","7df74da6dae74e0f9a748f9d970711ba.webp","804f99157216e02f9244f04311c10482.webp"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your facebook ads orchestrator requirements...",
    "required": true
  },
  {
    "name": "audience",
...
export function FacebookAdsOrchestratorPage() {
  const { user } = useAuth();
...
export default FacebookAdsOrchestratorPage;
