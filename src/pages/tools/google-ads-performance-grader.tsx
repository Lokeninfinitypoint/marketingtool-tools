...
const TOOL_DATA = {
  ...
  badge: 'Grader',
  badgeColor: '#38a169',
  description: 'AI-powered google ads performance grader',
  heroVideo: '/media/videos/Pinterest%2814%29.mp4',
  ...
  tabImages: {"overview":["0f87fda195b8e6fdbf992462e0af6bbb.png","1024.png","11b1bae805f8f3f7d9f40aa96bcb6979.png"],"analysis":["122840bb418ff9b1d7a2f8cc57e92a30.png","1240_1560.png","1250ab3a86b3812873649f9e95126906.png"],"scoring":["13b287083237210d9751816eb1198bf8.png","149b0fa838eb790270e1be35156d3584.png","14bc6080cda3e2af2b0cf7048111d74d.png"],"recommendations":["1551dd64e57589251e90bf5aec029011.png","168672789_NGO Darpan.png","16a92da7a4b26a462bf79876e036e16f.png"]},
  tabDescriptions: {"overview":[{"title":"Health Score","desc":"Google Ads Performance Grader rating"},{"title":"Key Issues","desc":"Critical problems found"},{"title":"Best Practices","desc":"Industry standards"}],"analysis":[{"title":"Deep Scan","desc":"Detailed findings"},{"title":"Trend Data","desc":"Historical changes"},{"title":"Competitor Gap","desc":"How you compare"}],"scoring":[{"title":"Grade Card","desc":"A-F rating breakdown"},{"title":"Priority Fixes","desc":"Most impactful changes"},{"title":"Strengths","desc":"What works well"}],"recommendations":[{"title":"Action Plan","desc":"Step-by-step fixes"},{"title":"Quick Wins","desc":"Easy improvements"},{"title":"Long-term Strategy","desc":"Growth roadmap"}]},
  tips: [{"title":"Provide Full URL","desc":"Include your complete website or account URL for thorough analysis."},{"title":"Compare Competitors","desc":"Add competitor URLs to benchmark your performance."},{"title":"Track Over Time","desc":"Run monthly to track improvement progress."}],
};
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your google ads performance grader requirements...",
    "required": true
  }
];

export function GoogleAdsPerformanceGraderPage() {
  const { user } = useAuth();
...
export default GoogleAdsPerformanceGraderPage;
