...
const TOOL_DATA = {
  ...
  badge: 'Grader',
  badgeColor: '#38a169',
  description: 'AI-powered google analytics grader',
  heroVideo: '/media/videos/Pinterest%2815%29.mp4',
  ...
  tabImages: {"overview":["190224841bfca3a837ce69be7f201d2a.png","1926acdc5ea74814808ed4cf3fb3c60b.png","1bbf66d389f9d7610b9d0c1a3f486f60.png"],"analysis":["1bc743e43e9f038a0a38b2249c2a6c11.png","1c440937d3aea203a4090944d82c9439.png","1dbdd014cf53d8e8bb67eaa67bd34f65.png"],"scoring":["1df01723f3f61fd990d5531a51072f7b.png","202568a90597e8b2b82acba80cf806a8.png","21.png"],"recommendations":["22.png","2208e851fe2f4c4784be70f9796c31e9.png","222ccbd9c02a04034df53d14603df4b5.png"]},
  tabDescriptions: {"overview":[{"title":"Health Score","desc":"Google Analytics Grader rating"},{"title":"Key Issues","desc":"Critical problems found"},{"title":"Best Practices","desc":"Industry standards"}],"analysis":[{"title":"Deep Scan","desc":"Detailed findings"},{"title":"Trend Data","desc":"Historical changes"},{"title":"Competitor Gap","desc":"How you compare"}],"scoring":[{"title":"Grade Card","desc":"A-F rating breakdown"},{"title":"Priority Fixes","desc":"Most impactful changes"},{"title":"Strengths","desc":"What works well"}],"recommendations":[{"title":"Action Plan","desc":"Step-by-step fixes"},{"title":"Quick Wins","desc":"Easy improvements"},{"title":"Long-term Strategy","desc":"Growth roadmap"}]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your google analytics grader requirements...",
    "required": true
  }
];

export function GoogleAnalyticsGraderPage() {
  const { user } = useAuth();
...
export default GoogleAnalyticsGraderPage;
