...
const TOOL_DATA = {
  ...
  badge: 'Facebook/Meta',
  badgeColor: '#1877F2',
  description: 'AI-powered facebook performance dashboard',
  heroVideo: '/media/videos/Pinterest%20%289%29.mp4',
  tabs: [{"id":"overview","name":"Overview","icon":"📊"},{"id":"targeting","name":"Targeting","icon":"🎯"},{"id":"creative","name":"Creative","icon":"🎨"},{"id":"optimize","name":"Optimize","icon":"🚀"}],
  tabImages: {"overview":["af488d3546019c83c4071d1cfc943ebf.webp","b1d46a671b1e36c1ca795e5d791ce861.webp","b20c40d1fdf6227a8867f2d7511a6c6e.webp"],"targeting":["b23f3a3a32c1d38ca03bb72780a118dd.webp","b43157a59245a28f9e7e7cb03a9318f7.webp","b584c1b8002c952956281a0a859da921.webp"],"creative":["b68d37b00aacf3f4b082bb7aefb4ce70.webp","b9b5eb2e4aefb05adcd7b93a2ecbe4fe.webp","b9dfd14635d6eea223af818eb3d37980.webp"],"optimize":["c08543abe08f1f3c3a7d7f44b87b6226.webp","c0a3da181d10e7c54a8ca6b5c86d86c5.webp","c7213d5c6fd75339a1ca9ed1d6786d78.webp"]},
  tabDescriptions: {"overview":[{"title":"Ad Account","desc":"Account overview"},{"title":"Active Ads","desc":"Running campaigns"},{"title":"Reach","desc":"Audience reached"}],"targeting":[{"title":"Custom Audience","desc":"Build audiences"},{"title":"Lookalike","desc":"Similar users"},{"title":"Interest Groups","desc":"Interest targeting"}],"creative":[{"title":"Ad Preview","desc":"Creative preview"},{"title":"Copy Variants","desc":"Text versions"},{"title":"Media Library","desc":"Assets"}],"optimize":[{"title":"Bid Strategy","desc":"Bidding setup"},{"title":"Placement","desc":"Where ads show"},{"title":"Schedule","desc":"Ad timing"}]},
  tips: [{"title":"Connect Ad Account","desc":"Link your Facebook Ad Account for real data."},{"title":"Define Objective","desc":"Choose awareness, engagement, or conversion goal."},{"title":"Set Audience","desc":"Describe your target demographics and interests."}],
};
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your facebook performance dashboard requirements...",
    "required": true
  },
  {
    "name": "audience",
...
export function FacebookPerformanceDashboardPage() {
  const { user } = useAuth();
...
export default FacebookPerformanceDashboardPage;
