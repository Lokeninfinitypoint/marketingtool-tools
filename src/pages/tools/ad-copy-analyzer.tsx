...
const TOOL_DATA = {
  ...
  tabs: [{"id":"overview","name":"Overview","icon":"📊"},{"id":"sentiment","name":"Sentiment","icon":"🧠"},{"id":"scoring","name":"Scoring","icon":"⭐"},{"id":"improve","name":"Improve","icon":"🚀"}],
  tabImages: {"overview":["0718de85344c421f604988e421e608d9.png","077a3149fd779206ad3ef1e14e8faf65.png","08e488cc4e5f340808fa58a0b6227129.png"],"sentiment":["0c34ac3cef8e4faf2bddd7b4d4297036.png","0d25b91a4777b23621a26d5f2dfe5cb1.png","0d5ba2dabad4835552937b83bc74987d.png"],"scoring":["0ecd021753d244d072cd511863fa6292.png","0ef746b3f6bee285632755121f0e8863.png","0f87fda195b8e6fdbf992462e0af6bbb.png"],"improve":["1024.png","11b1bae805f8f3f7d9f40aa96bcb6979.png","122840bb418ff9b1d7a2f8cc57e92a30.png"]},
  tabDescriptions: {"overview":[{"title":"Copy Score","desc":"Overall rating"},{"title":"Key Metrics","desc":"Performance data"},{"title":"Best Practices","desc":"Industry standards"}],"sentiment":[{"title":"Tone Analysis","desc":"Emotional impact"},{"title":"Audience Match","desc":"Targeting fit"},{"title":"Clarity Score","desc":"Message clarity"}],"scoring":[{"title":"Effectiveness","desc":"Conversion potential"},{"title":"Engagement","desc":"Click appeal"},{"title":"Compliance","desc":"Platform rules"}],"improve":[{"title":"Rewrite Tips","desc":"Better versions"},{"title":"A/B Variants","desc":"Test options"},{"title":"Power Words","desc":"High-impact terms"}]},
  tips: [{"title":"Be Detailed","desc":"Provide specific information for accurate Ad Copy Analyzer results."},{"title":"Set Clear Goals","desc":"Define what success looks like for your task."},{"title":"Iterate Results","desc":"Refine your input based on initial output."}],
};
...
export function AdCopyAnalyzerPage() {
  const { user } = useAuth();
...
export default AdCopyAnalyzerPage;
