...
const TOOL_DATA = {
  ...
  badge: 'Social Media',
  badgeColor: '#e53e8c',
  description: 'AI-powered social analytics dashboard',
  heroVideo: '/media/videos/new_media_0656.mp4',
  tabs: [{"id":"overview","name":"Overview","icon":"📊"},{"id":"create","name":"Create","icon":"🎨"},{"id":"schedule","name":"Schedule","icon":"📅"},{"id":"analytics","name":"Analytics","icon":"📈"}],
  tabImages: {"overview":["349bd2c2bb2ababc70cbdb221c75fac2.png","373ccb9a02edeacf9911fc00a04db017.png","39014c094747ec5163eb8eb116eea449.png"],"create":["392b61dafc3ffe7292622a92aabd91de.png","3a7f90c22558c72734e7b199148c5069.png","3a92ded58bb73921734dfd448e8a8399.png"],"schedule":["3b1cd49f9b93d3b663e228a8228ff8c3.png","3dc6dd09fdfd11e99b2cb2dd33034372.png","3df2d668076abbadd1204774b0a7173b.png"],"analytics":["3f991bcf43ae929df34128d8f8fd8f55.png","4274e621fe61e871266ecd0eef3b5b1c.png","4483ca3c63168d0dfed4815fa86686e5.png"]},
  tabDescriptions: {"overview":[{"title":"Content Plan","desc":"Strategy view"},{"title":"Platform Stats","desc":"Engagement data"},{"title":"Trending","desc":"Hot topics"}],"create":[{"title":"Post Creator","desc":"Write content"},{"title":"Visual Design","desc":"Media tools"},{"title":"Hashtag Mix","desc":"Tag strategy"}],"schedule":[{"title":"Calendar","desc":"Schedule view"},{"title":"Best Times","desc":"Optimal posting"},{"title":"Auto Post","desc":"Scheduled publish"}],"analytics":[{"title":"Engagement","desc":"Likes/comments"},{"title":"Growth","desc":"Follower change"},{"title":"Top Content","desc":"Best posts"}]},
  tips: [{"title":"Name Your Platform","desc":"Specify which social platform for optimized output."},{"title":"Describe Your Brand","desc":"Share your brand voice for consistent messaging."},{"title":"Include Context","desc":"Mention the occasion, trend, or campaign theme."}],
};
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your social analytics dashboard requirements...",
    "required": true
  },
  {
    "name": "platform",
...
export function SocialAnalyticsDashboardPage() {
  const { user } = useAuth();
...
export default SocialAnalyticsDashboardPage;
