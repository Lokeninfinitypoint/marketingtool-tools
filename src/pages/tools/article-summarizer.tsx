...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["bd5c45d4f65ec7e6e8a09d7aee2f1f01.png","be2c773c3755f9a2aa276a489849d052.png","be7fd5d29f67d3a18386b11665a58be2.png"],"writing":["bf09d5db9b42d788b87d25bc52241a60.png","bf141fe5dcfcbc2befdd4a12dc4dac56.png","bf61d2295ff9076c4efeff7a037fcecc.png"],"editing":["bf7556bb64ce1ddc1dc2315ebdb6203d.png","bg-pattern.png","bg-shape-five.png"],"publish":["bg-shape-four.png","bg-shape-one.png","bg-shape-tree.png"]},
...
export function ArticleSummarizerPage() {
  const { user } = useAuth();
...
export default ArticleSummarizerPage;
