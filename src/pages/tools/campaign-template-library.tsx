...
const TOOL_DATA = {
  ...
  badge: 'Campaign',
  badgeColor: '#dd6b20',
  description: 'AI-powered campaign template library',
  heroVideo: '/media/videos/Pinterest%20%281%29.mp4',
  ...
  tabImages: {"overview":["sandeep.png","section  8 company.png","services_bg.png"],"setup":["sidebarMenu.png","slider-details.png","slider-main-bg.png"],"monitor":["slider-main-image.png","spatial_darkMode_selected.png","spatial_darkMode_unselected.png"],"optimize":["spatial_lightMode_unselected.png","splashscreen_logo.png","split-2.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your campaign template library requirements...",
    "required": true
  }
];

export function CampaignTemplateLibraryPage() {
  const { user } = useAuth();
...
export default CampaignTemplateLibraryPage;
