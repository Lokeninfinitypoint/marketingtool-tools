...
const TOOL_DATA = {
  ...
  badge: 'Facebook/Meta',
  badgeColor: '#1877F2',
  description: 'AI-powered meta campaign analyzer',
  heroVideo: '/media/videos/Pinterest%2855%29.mp4',
  ...
  tabImages: {"overview":["icon_undefined.png","image-generator1.png","image-generator2.png"],"targeting":["image-generator3.png","image-generator4.png","image-generator5.png"],"creative":["imageclassifier1.png","img.png","img10.png"],"optimize":["img11.png","img12.png","img13.png"]},
  tabDescriptions: {"overview":[{"title":"Campaign Status","desc":"Active campaigns"},{"title":"Performance","desc":"Key metrics"},{"title":"Budget Pacing","desc":"Spend tracking"}],"targeting":[{"title":"Campaign Builder","desc":"Create campaigns"},{"title":"Audience Config","desc":"Targeting setup"},{"title":"Creative Upload","desc":"Ad assets"}],"creative":[{"title":"Live Metrics","desc":"Real-time data"},{"title":"Alerts","desc":"Performance alerts"},{"title":"Daily Summary","desc":"Daily report"}],"optimize":[{"title":"Auto Rules","desc":"Optimization rules"},{"title":"Bid Adjust","desc":"Bid management"},{"title":"Scale Plan","desc":"Growth strategy"}]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your meta campaign analyzer requirements...",
    "required": true
  },
  {
    "name": "audience",
...
export function MetaCampaignAnalyzerPage() {
  const { user } = useAuth();
...
export default MetaCampaignAnalyzerPage;
