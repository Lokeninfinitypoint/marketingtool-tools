...
const TOOL_DATA = {
  ...
  tabs: [{"id":"overview","name":"Overview","icon":"📊"},{"id":"configure","name":"Configure","icon":"⚙️"},{"id":"generate","name":"Generate","icon":"⚡"},{"id":"results","name":"Results","icon":"📋"}],
  tabImages: {"overview":["Data-Driven Online Marketing Strategies for Maximum ROI.jpeg","Design system Photos - Download Free High-Quality Pictures _ Freepik.jpeg","Did You Know- Social Media Activates the Same Pathways as Gambling.jpeg"],"configure":["Digital Marketing and Seo Expertise with Sourcelinebd_.jpeg","Digital Marketing.jpeg","Digitalmehmet's Curated Illumination Magazine - The Digitalmehmet Content Ecosystem.jpeg"],"generate":["Dijital Pazarlama.jpeg","Dust.jpg","E-commerce Seo Expert _ Online Store Optimization_.jpeg"],"results":["Empower Your Business with Professional WordPress Development Services.jpeg","Empower Your Content with AI!.jpeg","Experience The Excitement of Virtual Try-ons!.jpeg"]},
  tabDescriptions: {"overview":[{"title":"Chart Library","desc":"Saved charts"},{"title":"Templates","desc":"Quick start"},{"title":"Popular","desc":"Top formats"}],"configure":[{"title":"Products","desc":"Add items"},{"title":"Features","desc":"Compare points"},{"title":"Scoring","desc":"Rating system"}],"generate":[{"title":"Design","desc":"Visual style"},{"title":"Branding","desc":"Colors & logo"},{"title":"Layout","desc":"Table format"}],"results":[{"title":"Download","desc":"Export chart"},{"title":"Embed Code","desc":"Website use"},{"title":"Share Link","desc":"Send to team"}]},
  tips: [{"title":"Be Detailed","desc":"Provide specific information for accurate Comparison Chart Creator results."},{"title":"Set Clear Goals","desc":"Define what success looks like for your task."},{"title":"Iterate Results","desc":"Refine your input based on initial output."}],
};
...
export function ComparisonChartCreatorPage() {
  const { user } = useAuth();
...
export default ComparisonChartCreatorPage;
