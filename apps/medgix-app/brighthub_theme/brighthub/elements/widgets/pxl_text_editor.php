...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('Case Text Editor', 'brighthub'),
        'icon' => 'eicon-text',
        ...
        'params' => array(
            'sections' => array(
                array(
                    ...
                    'label' => esc_html__('Text Editor', 'brighthub' ),
                    ...
                    'controls' => array(
                        array(
                            ...
                            'default' => esc_html__( 'Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'brighthub' ),
                        ...
                        array(
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .pxl-text-editor .pxl-text-editor__inner' => 'max-width: {{SIZE}}{{UNIT}};',
                            ],
                        ),
                        array(
                            'name' => 'space_botton',
                            'label' => esc_html__('Space Bottom', 'brighthub' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'control_type' => 'responsive',
                            'size_units' => [ 'px', '%' ],
                            'range' => [
                            ...
                            'defaut' => '15',
                            'selectors' => [
                                '{{WRAPPER}} .pxl-text-editor .pxl-text-editor__inner p' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                            ],
                        ),
                        array(
                            'name' => 'flex_grow',
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'image_margin',
                            'label' => esc_html__( 'Image Margin', 'brighthub' ),
                            'type' => \Elementor\Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .pxl-text-editor img' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                        ),
                    ),
                ),
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'gradient_style',
                            'label' => esc_html__('Gradient Style', 'brighthub' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                                'highlight-df' => 'Default',
                                'highlight-gradient' => 'Gradient 1',
                            ],
                            'default' => 'highlight-df',
                        ),
                        array(
                            ...
                            'default' => '',
                            'selectors' => [
                                '{{WRAPPER}} .pxl-text-editor__highlight' => 'color: {{VALUE}};',
                            ],
                        ),
                        array(
                            ...
                            'type' => \Elementor\Group_Control_Typography::get_type(),
                            'control_type' => 'group',
                            'selector' => '{{WRAPPER}} .pxl-text-editor__highlight',
                        ),
                    ),
                ),
