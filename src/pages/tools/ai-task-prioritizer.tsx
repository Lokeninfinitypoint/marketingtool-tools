...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["TBLR_Warnings_unselected.png","Todo.png","Tree_Iso.png"],"configure":["Untitled.png","Water_Hex.png","a03a430660d0dd6b068a56ab2adf1699.png"],"execute":["a04a4a26e9337c87a021322cd68e298f.png","a24a681f107f5f4d3e59140820bc7b75.png","a317a899dbdac91d4b734809d1c3cf99.png"],"results":["a3a4386d29776bc83df810cebb88eec1.png","a73501b5c1ed9df4bafcd5d7b2b7d407.png","aafa2d24ae72d5896966fb33bc3e4caf.png"]},
...
export function AiTaskPrioritizerPage() {
  const { user } = useAuth();
...
export default AiTaskPrioritizerPage;
