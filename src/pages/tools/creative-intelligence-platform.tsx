...
const TOOL_DATA = {
  ...
  heroVideo: '/media/videos/Pinterest%20%2824%29.mp4',
  ...
  tabImages: {"overview":["accordion.jpg","ai-dashboard-bg.jpg","analytics-bg.jpg"],"metrics":["back-image.jpeg","badge.jpg","ball.jpg"],"insights":["banner-1.jpg","banner-4.jpg","blog.jpg"],"export":["brain 2.jpg","brain.jpg","brand-logo.jpg"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your creative intelligence platform requirements...",
    "required": true
  }
];

export function CreativeIntelligencePlatformPage() {
  const { user } = useAuth();
...
export default CreativeIntelligencePlatformPage;
