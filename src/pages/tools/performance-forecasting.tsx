...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["E-commerce Seo Expert _ Online Store Optimization_.jpeg","Empower Your Business with Professional WordPress Development Services.jpeg","Empower Your Content with AI!.jpeg"],"metrics":["Experience The Excitement of Virtual Try-ons!.jpeg","Explore the Future of Social Media with AI.jpeg","f22c2453e5382e45140785256f212fb4.png"],"insights":["f313e94a3deeda3ca3903219670032f0.png","Futuristic Digital Marketing Collaboration.jpg","Google 2026 New Year.jpeg"],"export":["f3a82bce191d066f50fa0ee218d0c315.png","Grow Your Business Online- Full-Service Digital Marketing Strategy.jpeg","f46b815ab94e2d2e9d558d73ac2eea29.png"]},
  tabDescriptions: {"overview":[{"title":"Forecast Hub","desc":"Predictions"},{"title":"Accuracy","desc":"Model score"},{"title":"Confidence","desc":"Reliability"}],"metrics":[{"title":"Revenue Forecast","desc":"Income prediction"},{"title":"Traffic Forecast","desc":"Visit estimates"},{"title":"Conversion Forecast","desc":"Sales outlook"}],"insights":[{"title":"Best Case","desc":"Optimistic view"},{"title":"Base Case","desc":"Expected view"},{"title":"Worst Case","desc":"Conservative view"}],"export":[{"title":"Budget Plan","desc":"Spend forecast"},{"title":"Resource Plan","desc":"Team needs"},{"title":"Timeline","desc":"Key dates"}]},
...
export function PerformanceForecastingPage() {
  const { user } = useAuth();
