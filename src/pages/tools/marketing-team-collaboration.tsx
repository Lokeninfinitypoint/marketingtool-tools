...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["featured-creator2.png","fed2d9cdcb6901ed608b562f5848f58f.png","fff5d2b3a07ff6bd7b0c6d094a912525.png"],"competitors":["file-manager.png","firebase1.png","firefox.png"],"trends":["flame-chart.png","folder-structure-1.png","folder-structure-2.png"],"strategy":["fonts.png","forgot-pass-img.png","gallery-img1.png"]},
  tabDescriptions: {"overview":[{"title":"Team Hub","desc":"Collaboration"},{"title":"Members","desc":"Team roster"},{"title":"Activity","desc":"Recent work"}],"competitors":[{"title":"Projects","desc":"Shared work"},{"title":"Files","desc":"Asset library"},{"title":"Templates","desc":"Shared templates"}],"trends":[{"title":"Task Board","desc":"To-do items"},{"title":"Assignments","desc":"Who does what"},{"title":"Deadlines","desc":"Due dates"}],"strategy":[{"title":"Chat","desc":"Team messaging"},{"title":"Comments","desc":"File feedback"},{"title":"Notifications","desc":"Updates"}]},
  tips: [{"title":"Be Detailed","desc":"Provide specific information for accurate Marketing Team Collaboration results."},{"title":"Set Clear Goals","desc":"Define what success looks like for your task."},{"title":"Iterate Results","desc":"Refine your input based on initial output."}],
};
...
export function MarketingTeamCollaborationPage() {
  const { user } = useAuth();
...
export default MarketingTeamCollaborationPage;
