...
const TOOL_DATA = {
  ...
  badge: 'Analytics',
  badgeColor: '#805ad5',
  description: 'AI-powered performance monitor',
  heroVideo: '/media/videos/We%20harness%20artificial%20intelligence%20to%20analyze%20complex%20data%20predi%20%285%29.mp4',
  ...
  tabImages: {"overview":["Master Your Website- The Ultimate SEO Plugins Management Hub.jpeg","f5d8653cefd222716d03b8b5d173be48.webp","Mastering Digital Marketing_ The Power of Data & Strategy.jpeg"],"metrics":["Meet the AI Agents That Run Your Social Media 24-7.jpeg","Meta Pixel Vs_ GA4_ All You Need to Know.jpeg","Old Ads vs New Meta Ads_ Why Results Matter More Than Reach.jpeg"],"insights":["PPC Ads Agency _ PPC Agency & SEM Marketing Agency.jpeg","PPC portfolio #increase traffic image.jpeg","Personalizing Shopping- AI in Customer Experience.jpeg"],"export":["Pixel-Perfect Web Development + SEO Mastery_ Skyrocket Your Google Ranking in 90 Days or Less!.jpeg","QuickAds utilizes artificial intelligence to streamline ad creation procedures_.jpeg","f6fd00e123ba120bde0748bbe035afc9.png"]},
  tabDescriptions: {"overview":[{"title":"Monitor Hub","desc":"Active tracking"},{"title":"Status","desc":"System health"},{"title":"Quick Stats","desc":"Key numbers"}],"metrics":[{"title":"Real-Time","desc":"Live metrics"},{"title":"Dashboards","desc":"Visual data"},{"title":"Channels","desc":"Per platform"}],"insights":[{"title":"Alert Rules","desc":"Trigger setup"},{"title":"Notifications","desc":"How to alert"},{"title":"Escalation","desc":"Priority levels"}],"export":[{"title":"Performance Log","desc":"Past data"},{"title":"Trends","desc":"Over time"},{"title":"Reports","desc":"Export data"}]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your performance monitor requirements...",
    "required": true
  }
];
