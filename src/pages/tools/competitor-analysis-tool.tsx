...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["Ideogram.jpeg","f55df5fd3f783764d7b6626e2909a206.png","Just for A future tip pt8.jpeg"],"competitors":["JustMyLook Beauty App Launch 3D Animation.jpeg","Langerson araque.jpeg","Making Code Reviews Count.jpeg"],"trends":["f587399cd5c0b89927a719eeb4fa769c.png","Master Your Google Ads_ Become an Expert.jpeg","Master Your Website- The Ultimate SEO Plugins Management Hub.jpeg"],"strategy":["f5d8653cefd222716d03b8b5d173be48.webp","Mastering Digital Marketing_ The Power of Data & Strategy.jpeg","Meet the AI Agents That Run Your Social Media 24-7.jpeg"]},
  tabDescriptions: {"overview":[{"title":"Competitor Hub","desc":"Track rivals"},{"title":"Market Map","desc":"Landscape view"},{"title":"Alerts","desc":"New activity"}],"competitors":[{"title":"Ad Library","desc":"Their ads"},{"title":"Keywords","desc":"Their terms"},{"title":"Social","desc":"Their content"}],"trends":[{"title":"SWOT","desc":"Strength analysis"},{"title":"Gap Analysis","desc":"Opportunities"},{"title":"Trends","desc":"Their direction"}],"strategy":[{"title":"Counter Strategy","desc":"Your response"},{"title":"Differentiation","desc":"Stand out"},{"title":"Priorities","desc":"Focus areas"}]},
...
export function CompetitorAnalysisToolPage() {
  const { user } = useAuth();
...
export default CompetitorAnalysisToolPage;
