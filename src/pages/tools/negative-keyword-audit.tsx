...
const TOOL_DATA = {
  ...
  badge: 'Audit',
  badgeColor: '#38a169',
  description: 'AI-powered negative keyword audit',
  heroVideo: '/media/videos/Social%20Media%20Templates%20%284%29.mp4',
  ...
  tabImages: {"overview":["rtl-dark-mode.png","rtl.png","s4.png"],"analysis":["safari.png","sandeep.png","section  8 company.png"],"scoring":["services_bg.png","sidebarMenu.png","slider-details.png"],"recommendations":["slider-main-bg.png","slider-main-image.png","spatial_darkMode_selected.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your negative keyword audit requirements...",
    "required": true
  }
];

export function NegativeKeywordAuditPage() {
  const { user } = useAuth();
...
export default NegativeKeywordAuditPage;
