...
const TOOL_DATA = {
  ...
  badge: 'Facebook/Meta',
  badgeColor: '#1877F2',
  description: 'AI-powered meta creative studio',
  heroVideo: '/media/videos/Pinterest%287%29.mp4',
  ...
  tabImages: {"overview":["layout-structure-1.png","leafletapi.png","left-sidebar.png"],"targeting":["letter-m.png","lifestyle.png","livingroom_bright.png"],"creative":["livingroom_dim.png","llp vs partnership.png","login-page.png"],"optimize":["logo-setup.png","logo-white.png","main-banner-bg-shape.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your meta creative studio requirements...",
    "required": true
  },
  {
    "name": "audience",
...
export function MetaCreativeStudioPage() {
  const { user } = useAuth();
...
export default MetaCreativeStudioPage;
