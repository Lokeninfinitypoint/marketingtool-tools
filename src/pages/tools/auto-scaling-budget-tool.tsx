...
const TOOL_DATA = {
  ...
  badge: 'Budget',
  badgeColor: '#48bb78',
  description: 'AI-powered auto scaling budget tool',
  heroVideo: '/media/videos/Digital%20Marketing%20Tips%20for%20Beginners%20Social%20Media%20Growth%20Strateg%20%285%29.mp4',
  ...
  tabImages: {"overview":["c08463ba0a73524808021c217934398c.png","c1f09a2543c8f5f9f014ebcce6a4d3be.png","c22e94f45c4672e5a1ba357c8ea803c2.png"],"allocation":["c2fa8b59ccfbcd8fcf504b74af27b110.png","c57e86e292a88a0df26dc13c8a1b4a27.png","c6fb4337abc84072e01123ecc541086b.png"],"forecast":["c736960b0180a4a1199a94796f5e8500.png","c742742c3fcb62d911c572ca2a6f5189.png","ca042d59241cd48ac5fe4d288404df71.png"],"optimize":["ca33bf90c5aa8bcca176cf219e077900.png","ca39d2a61c4631e063c1f53cc6b05ef1.png","calander.png"]},
  tabDescriptions: {"overview":[{"title":"Budget Overview","desc":"Spend summary"},{"title":"Allocation","desc":"Channel split"},{"title":"Pacing","desc":"Daily rate"}],"allocation":[{"title":"Strategy","desc":"Bid approach"},{"title":"Targets","desc":"CPA/ROAS goals"},{"title":"Limits","desc":"Cap settings"}],"forecast":[{"title":"Forecast","desc":"Projected spend"},{"title":"Scenarios","desc":"What-if analysis"},{"title":"Trends","desc":"Historical data"}],"optimize":[{"title":"Savings","desc":"Cut waste"},{"title":"Efficiency","desc":"Cost per result"},{"title":"Scale Plan","desc":"Growth budget"}]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your auto scaling budget tool requirements...",
    "required": true
  }
];

export function AutoScalingBudgetToolPage() {
  const { user } = useAuth();
...
export default AutoScalingBudgetToolPage;
