...
const TOOL_DATA = {
  ...
  badge: 'Audit',
  badgeColor: '#38a169',
  description: 'AI-powered search term audit',
  heroVideo: '/media/videos/new_media_0643.mp4',
  ...
  tabImages: {"overview":["6290d19a135f76f3a83593f1911c27a8.webp","64c4cdb408b74abf8f0a7f95763076ad.webp","6512d63ffc0fd2ab20fbc14327f5eb49.webp"],"analysis":["65de601f00ac0e65deaf43d512a4c525.webp","65fc12fb316af5e0acb76eee3a69ae67.webp","6697619d302393b530e34c68092085a0.webp"],"scoring":["66f50146fd356228826b88c1cc720af9.webp","671da94427384c7167652c8b5c306c46.webp","6bc6a3f9e0686d70b16b07f4ccf08a53.webp"],"recommendations":["6cd6e954659fb0bfba14a7a34aed5546.webp","6cd934dd776bea9e102fb652252f6fce.webp","6f7e502ff3be02eecb44866c90a20582.webp"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your search term audit requirements...",
    "required": true
  }
];

export function SearchTermAuditPage() {
  const { user } = useAuth();
...
export default SearchTermAuditPage;
