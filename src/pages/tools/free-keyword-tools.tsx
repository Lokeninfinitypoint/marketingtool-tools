...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["fbe3ebbc34c5958f22167f60689b8c55.webp","ic_launcher.webp","ic_launcher_foreground.webp"],"technical":["ic_launcher_round.webp","005a225ab33c9f1a8a73d4b3c442f2ae.png","01105d3179e5710817d925e86f3cc698.png"],"content":["013a9a763684472490af6bc7aabfbfa8.png","014af3803f7fe988bc4661386f1e80f7.png","01b569fd1095ed0daf4f923864e685bc.png"],"ranking":["027fc88df11eecda52c049fe445b632c.png","0282fe00d374d04aa480de2d9a670e2b.png","02_Tools.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your free keyword tools requirements...",
    "required": true
  },
  {
    "name": "url",
...
export function FreeKeywordToolsPage() {
  const { user } = useAuth();
...
export default FreeKeywordToolsPage;
