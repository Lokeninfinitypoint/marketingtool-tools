...
const TOOL_DATA = {
  ...
  tabs: [{"id":"overview","name":"Overview","icon":"📊"},{"id":"emotions","name":"Emotions","icon":"🎭"},{"id":"tone","name":"Tone","icon":"🎙️"},{"id":"optimize","name":"Optimize","icon":"💡"}],
  tabImages: {"overview":["1240_1560.png","1250ab3a86b3812873649f9e95126906.png","13b287083237210d9751816eb1198bf8.png"],"emotions":["149b0fa838eb790270e1be35156d3584.png","14bc6080cda3e2af2b0cf7048111d74d.png","1551dd64e57589251e90bf5aec029011.png"],"tone":["168672789_NGO Darpan.png","16a92da7a4b26a462bf79876e036e16f.png","190224841bfca3a837ce69be7f201d2a.png"],"optimize":["1926acdc5ea74814808ed4cf3fb3c60b.png","1bbf66d389f9d7610b9d0c1a3f486f60.png","1bc743e43e9f038a0a38b2249c2a6c11.png"]},
  tabDescriptions: {"overview":[{"title":"Sentiment Score","desc":"Emotional tone"},{"title":"Mood Map","desc":"Feeling breakdown"},{"title":"Audience Impact","desc":"Reader response"}],"emotions":[{"title":"Positive Signals","desc":"Uplifting words"},{"title":"Negative Flags","desc":"Risk words"},{"title":"Neutral Balance","desc":"Factual tone"}],"tone":[{"title":"Emotion Grade","desc":"A-F rating"},{"title":"Trust Score","desc":"Credibility check"},{"title":"Urgency Level","desc":"Action pressure"}],"optimize":[{"title":"Tone Shifts","desc":"Better emotions"},{"title":"Word Swaps","desc":"Improve sentiment"},{"title":"Brand Alignment","desc":"Voice match"}]},
  tips: [{"title":"Be Detailed","desc":"Provide specific information for accurate Ad Copy Sentiment Analyzer results."},{"title":"Set Clear Goals","desc":"Define what success looks like for your task."},{"title":"Iterate Results","desc":"Refine your input based on initial output."}],
};
...
export function AdCopySentimentAnalyzerPage() {
  const { user } = useAuth();
...
export default AdCopySentimentAnalyzerPage;
