...
const TOOL_DATA = {
  ...
  badge: 'Instagram',
  badgeColor: '#E4405F',
  description: 'AI-powered instagram content scheduler',
  heroVideo: '/media/videos/Pinterest%2820%29.mp4',
  ...
  tabImages: {"overview":["547f28896fb1a2f30aa77925e664e441.png","55411036857f11774ce24483d4e45c2d.png","555994644_pvt ltd company.png"],"targeting":["5590f347fd864703b3413c0458a7e477.png","55ae9d91011f194762b652dd3a06f05b.png","55b9f4803fc65aef6c621a43c5da05f3.png"],"creative":["562a226345b2c4762840ba4ecd9a91cd.png","565d280f5ba73152f1d8e88bd00b1e41.png","57a1581037cb539b8609df2e95fe2928.png"],"optimize":["57ba9fbad69e0ac8af1b814de12e372d.png","589a97fc8440211a5969d5404370b8c2.png","58a1927cbd42b79353f66a3451ef31d6.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your instagram content scheduler requirements...",
    "required": true
  },
  {
    "name": "audience",
...
export function InstagramContentSchedulerPage() {
  const { user } = useAuth();
...
export default InstagramContentSchedulerPage;
