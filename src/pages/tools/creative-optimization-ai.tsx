...
const TOOL_DATA = {
  ...
  badge: 'Creative',
  badgeColor: '#9f7aea',
  description: 'AI-powered creative optimization ai',
  heroVideo: '/media/videos/Pinterest%20%2825%29.mp4',
  ...
  tabImages: {"overview":["button-2.jpg","button.jpg","callto-action.jpg"],"create":["calltobg.jpg","change-default-color.jpg","change-email-setting.jpg"],"library":["chat-bot-bg.jpg","clients.jpg","company profile presentation.jpg"],"optimize":["contact_bg.jpeg","contact_bg_2.jpeg","countbg.jpg"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your creative optimization ai requirements...",
    "required": true
  }
];

export function CreativeOptimizationAiPage() {
  const { user } = useAuth();
...
export default CreativeOptimizationAiPage;
