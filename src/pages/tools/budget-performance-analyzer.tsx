...
const TOOL_DATA = {
  ...
  badge: 'Budget',
  badgeColor: '#48bb78',
  description: 'AI-powered budget performance analyzer',
  heroVideo: '/media/videos/LLM-Agenten%20Revolution%C3%A4re%20Planungsmethoden%20enth%C3%BCllt%20%281%29.mp4',
  ...
  tabImages: {"overview":["group3474.png","group9060.png","group9102.png"],"allocation":["group93352.png","grunt.png","header-4096x2304.png"],"forecast":["header-dashboard.png","header-default.png","header-with-topbar.png"],"optimize":["header.png","headerMenu.png","headphone.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your budget performance analyzer requirements...",
    "required": true
  }
];

export function BudgetPerformanceAnalyzerPage() {
  const { user } = useAuth();
...
export default BudgetPerformanceAnalyzerPage;
