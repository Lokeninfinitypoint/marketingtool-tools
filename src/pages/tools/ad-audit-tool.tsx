...
const TOOL_DATA = {
  ...
  badge: 'Audit',
  badgeColor: '#38a169',
  description: 'AI-powered ad audit tool',
  heroVideo: '/media/videos/AI%20Shortcut%2030KMonth%20Passive%20System%20-%20AI%20Shortcut%2030KMonth%20Passi%20%281%29.mp4',
  tabs: [{"id":"overview","name":"Overview","icon":"📊"},{"id":"performance","name":"Performance","icon":"⚡"},{"id":"budget","name":"Budget","icon":"💰"},{"id":"recommendations","name":"Fixes","icon":"🔧"}],
  tabImages: {"overview":["03_AIChat.png","03_ToolResult.png","03b06697daf2f6ac9641f178050018c1.png"],"performance":["0462d6a689202be7955ff5f99bdab462.png","04_AIChat.png","04_History.png"],"budget":["053c5068b3122138005547f79bcf6e57.png","05_MemeGenerator.png","05_Profile.png"],"recommendations":["06_MemeGen.png","06_Profile.png","0714f92dea58ee1adbcb4348b64d94c0.png"]},
  tabDescriptions: {"overview":[{"title":"Account Health","desc":"Overall score"},{"title":"Key Findings","desc":"Top issues found"},{"title":"Coverage","desc":"Areas analyzed"}],"performance":[{"title":"Issue Details","desc":"Problem breakdown"},{"title":"Severity Level","desc":"Impact assessment"},{"title":"Root Cause","desc":"Why it happens"}],"budget":[{"title":"Score Card","desc":"Performance rating"},{"title":"Benchmarks","desc":"Industry comparison"},{"title":"Trends","desc":"Over-time changes"}],"recommendations":[{"title":"Fix Guide","desc":"How to resolve"},{"title":"Priority Order","desc":"What to fix first"},{"title":"Estimated Impact","desc":"Expected improvement"}]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your ad audit tool requirements...",
    "required": true
  }
];

export function AdAuditToolPage() {
  const { user } = useAuth();
...
export default AdAuditToolPage;
