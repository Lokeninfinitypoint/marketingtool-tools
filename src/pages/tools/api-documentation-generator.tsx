...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["acf714cdf28af3d58645b1915cd13e79.png","ad0236f053402c69a0e56a25878e85d6.png","adaptive-icon.png"],"writing":["admin-dashboard.png","advanced-tab-bg.png","ae0dca68e671c23400780aeec8a0c5f4.png"],"editing":["af18a87291e3057b5460a0d0106bd654.png","afa1512b105da38bf056de55ddf3d5e0.png","ambient_darkMode_unselected.png"],"publish":["ambient_lightMode_selected.png","ambient_lightMode_unselected.png","app-store.png"]},
...
export function ApiDocumentationGeneratorPage() {
  const { user } = useAuth();
...
export default ApiDocumentationGeneratorPage;
