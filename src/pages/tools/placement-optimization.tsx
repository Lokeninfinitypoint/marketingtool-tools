...
const TOOL_DATA = {
  ...
  badgeColor: '#FBBC05',
  description: 'AI-powered placement optimization',
  heroVideo: '/media/videos/We%20harness%20artificial%20intelligence%20to%20analyze%20complex%20data%20predi%20%289%29.mp4',
  tabs: [{"id":"overview","name":"Overview","icon":"📊"},{"id":"targeting","name":"Targeting","icon":"🎯"},{"id":"performance","name":"Performance","icon":"📈"},{"id":"optimize","name":"Optimize","icon":"🔧"}],
  tabImages: {"overview":["WhatsApp Image 2026-01-22 at 18.22.00.jpeg","WhatsApp Image 2026-01-22 at 18.22.07.jpeg","WhatsApp Image 2026-01-22 at 18.22.12.jpeg"],"targeting":["WhatsApp Image 2026-01-22 at 18.22.19.jpeg","WhatsApp Image 2026-01-22 at 18.22.25.jpeg","WhatsApp Image 2026-01-22 at 18.22.31.jpeg"],"performance":["WhatsApp Image 2026-01-22 at 18.22.55.jpeg","WhatsApp Image 2026-01-24 at 16.45.31.jpeg","WhatsApp Image 2026-01-24 at 17.34.13.jpeg"],"optimize":["WhatsApp Image 2026-01-24 at 18.48.50.jpeg","WhatsApp Image 2026-01-25 at 08.02.57.jpeg","WhatsApp Image 2026-01-25 at 08.02.58.jpeg"]},
  tabDescriptions: {"overview":[{"title":"Overview","desc":"Current setup"},{"title":"Reach","desc":"Audience size"},{"title":"Coverage","desc":"Market share"}],"targeting":[{"title":"Segment Build","desc":"Create targets"},{"title":"Exclusions","desc":"Block list"},{"title":"Overlap","desc":"Audience overlap"}],"performance":[{"title":"By Segment","desc":"Performance split"},{"title":"Top Targets","desc":"Best segments"},{"title":"CPA","desc":"Cost analysis"}],"optimize":[{"title":"Auto-Adjust","desc":"AI optimize"},{"title":"Bid Mods","desc":"Adjustments"},{"title":"Expand","desc":"New audiences"}]},
  tips: [{"title":"Share Current Data","desc":"Include recent performance metrics."},{"title":"Set Target CPA","desc":"Define your cost-per-acquisition goal."},{"title":"Name Your Market","desc":"Specify geographic and demographic targets."}],
};
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your placement optimization requirements...",
    "required": true
  },
  {
    "name": "keywords",
...
export function PlacementOptimizationPage() {
  const { user } = useAuth();
...
export default PlacementOptimizationPage;
