...
const TOOL_DATA = {
  ...
  badge: 'Creative',
  badgeColor: '#9f7aea',
  description: 'AI-powered creative refresh agent',
  heroVideo: '/media/videos/Pinterest%20%2827%29.mp4',
  ...
  tabImages: {"overview":["ecommerce-seo.jpg","email-marketing.jpg","facebook-ads.jpg"],"create":["faq_bg.jpeg","faq_bg_2.jpeg","features.jpg"],"library":["footer-2.jpg","footer-3.jpg","footer.jpg"],"optimize":["footer_bg.jpeg","ftp-01.jpg","ftp-02.jpg"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your creative refresh agent requirements...",
    "required": true
  }
];

export function CreativeRefreshAgentPage() {
  const { user } = useAuth();
...
export default CreativeRefreshAgentPage;
