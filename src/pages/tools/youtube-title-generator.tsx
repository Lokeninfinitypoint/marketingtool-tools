...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["axes.png","b01cf0dfe0df7e1d04b8d2f3cd8497a6.png","b082a07d646098f66eb1b6d7bf9756b8.png"],"writing":["b0f24fe4687349f7cdbb36bf82b68988.png","b1eac7b54f9bb7d6e314cb346c032ff1.png","b36e6f8e9ab7c2e39894a67bb47f8160.png"],"editing":["b40fc5f8185cbbd4538377d6db8866ab.png","b43dadb01425cb103fbc6e91cb3d75c8.png","b48e0c135a452a232e7f2b0b4abd8c52.png"],"publish":["b500e87353f4dcafd70fbc1c57fdb7f3.png","b642e33b320f93ecb38a90d1d23ee315.png","b6936c850da742995343267ecdecb9c3.png"]},
  tabDescriptions: {"overview":[{"title":"Channel Stats","desc":"Overview"},{"title":"Video Ideas","desc":"Content topics"},{"title":"SEO Score","desc":"Search ranking"}],"writing":[{"title":"Title Writer","desc":"Click-worthy titles"},{"title":"Description","desc":"SEO optimized"},{"title":"Tags","desc":"Discovery tags"}],"editing":[{"title":"Thumbnail","desc":"Click rate"},{"title":"End Screen","desc":"Retention"},{"title":"Cards","desc":"Engagement"}],"publish":[{"title":"Views","desc":"Watch metrics"},{"title":"Retention","desc":"Watch time"},{"title":"Subscribers","desc":"Growth"}]},
  tips: [{"title":"Describe Video Content","desc":"Summarize what the video covers for relevant titles."},{"title":"Include Keywords","desc":"Add search terms viewers would use to find your video."},{"title":"State Your Channel Niche","desc":"Mention your channel topic for consistent branding."}],
};
...
export function YoutubeTitleGeneratorPage() {
  const { user } = useAuth();
