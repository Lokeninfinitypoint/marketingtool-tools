...
const TOOL_DATA = {
  ...
  badge: 'Instagram',
  badgeColor: '#E4405F',
  description: 'AI-powered instagram story ads manager',
  heroVideo: '/media/videos/Pinterest%2828%29.mp4',
  ...
  tabImages: {"overview":["98a7edb8d1a24bcbf443560f34e78bc8.png","98c5ae0c858eb88d62beb52e4e601080.png","99d26377b7bb3bcd65110d493b7050cf.png"],"targeting":["9b9909b0ddc0cdda15f19a5b9fb7a0f1.png","9c77d84390fd1695a4dc6671f5739d4e.png","9d41c24424c7e255c388e23dfbd2be61.png"],"creative":["9e15ec1a717eb440e11c3b9efd20a44a.png","9f09ad0d46dd1436746a0a1e1ded33f8.png","App-Icon-1024x1024@1x.png"],"optimize":["AreaLookUpTable.png","Asteroid.png","B 08.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your instagram story ads manager requirements...",
    "required": true
  },
  {
    "name": "audience",
...
export function InstagramStoryAdsManagerPage() {
  const { user } = useAuth();
...
export default InstagramStoryAdsManagerPage;
