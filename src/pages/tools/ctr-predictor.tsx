...
const TOOL_DATA = {
  ...
  badgeColor: '#FBBC05',
  description: 'AI-powered ctr predictor',
  heroVideo: '/media/videos/Pinterest%20%283%29.mp4',
  ...
  tabImages: {"overview":["history-hero.jpg","html-structure-1.jpg","html.jpg"],"analysis":["img-1.jpg","img-10.jpg","img-11.jpg"],"optimize":["img-2.jpg","img-3.jpg","img-4.jpg"],"report":["img-5.jpg","img-6.jpg","img-8.jpg"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your ctr predictor requirements...",
    "required": true
  },
  {
    "name": "keywords",
...
export function CtrPredictorPage() {
  const { user } = useAuth();
...
export default CtrPredictorPage;
