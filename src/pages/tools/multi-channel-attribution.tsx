...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["particle_circle.png","particle_darkMode_selected.png","particle_darkMode_unselected.png"],"analysis":["particle_lightMode_unselected.png","pattern.png","photo-8.png"],"optimize":["photo-9.png","pointLight_darkMode_selected.png","pointLight_darkMode_unselected.png"],"report":["pointLight_lightMode_selected.png","portfolio-1-1.png","portfolio-1-2.png"]},
...
export function MultiChannelAttributionPage() {
  const { user } = useAuth();
...
export default MultiChannelAttributionPage;
