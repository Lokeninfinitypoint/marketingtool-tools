...
const TOOL_DATA = {
  ...
  badge: 'Audit',
  badgeColor: '#38a169',
  description: 'AI-powered campaign audit tool',
  heroVideo: '/media/videos/LLM-Agenten%20Revolution%C3%A4re%20Planungsmethoden%20enth%C3%BCllt%20%283%29.mp4',
  ...
  tabImages: {"overview":["image-generator4.png","image-generator5.png","imageclassifier1.png"],"analysis":["img.png","img10.png","img11.png"],"scoring":["img12.png","img13.png","img14.png"],"recommendations":["img15.png","img2.png","img3.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your campaign audit tool requirements...",
    "required": true
  }
];

export function CampaignAuditToolPage() {
  const { user } = useAuth();
...
export default CampaignAuditToolPage;
