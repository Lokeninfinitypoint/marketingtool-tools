...
const TOOL_DATA = {
  ...
  badge: 'Audit',
  badgeColor: '#38a169',
  description: 'AI-powered ad group audit',
  heroVideo: '/media/videos/Ai%20Business%20Video%20%283%29.mp4',
  ...
  tabImages: {"overview":["23ac0e57976cbcdc4bc96df4329dcc0e.png","24.png","25.png"],"analysis":["2615305a8075efb4e793d83bc9a0eb96.png","2648e5d13e5265c8876e8de3026fffa3.png","26bcd8334dacdf81063917e434bae50f.png"],"scoring":["297db4529ffd4792b6e27032d6618cab.png","2acc810b943449927425101cfc9c9a47.png","2c7c66614c9f13040f87a50cd2c1c44d.png"],"recommendations":["2ef7ec1624303a90721247b5fdde4429.png","2fdbac3c62f35c28cb04aa8120b41d18.png","308a0c79016953a161d0f2e20c627f8a.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your ad group audit requirements...",
    "required": true
  }
];

export function AdGroupAuditPage() {
  const { user } = useAuth();
...
export default AdGroupAuditPage;
