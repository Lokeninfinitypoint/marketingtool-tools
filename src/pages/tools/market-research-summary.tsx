...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["card-overlay-img2.png","card-overlay-img3.png","carousel-img1.png"],"competitors":["carousel-img2.png","carousel-img3.png","carousel-img4.png"],"trends":["cat10.png","cat11.png","cat12.png"],"strategy":["cat6.png","cat7.png","cat8.png"]},
  tabDescriptions: {"overview":[{"title":"Market Overview","desc":"Industry data"},{"title":"Key Players","desc":"Competitors"},{"title":"Market Size","desc":"Revenue data"}],"competitors":[{"title":"Data Sources","desc":"Research inputs"},{"title":"Survey Results","desc":"User feedback"},{"title":"Trend Analysis","desc":"Market shifts"}],"trends":[{"title":"SWOT Analysis","desc":"Strengths/Weaknesses"},{"title":"Opportunity Map","desc":"Growth areas"},{"title":"Risk Assessment","desc":"Threats"}],"strategy":[{"title":"Executive Summary","desc":"Key findings"},{"title":"Recommendations","desc":"Action plan"},{"title":"Export","desc":"Download report"}]},
  tips: [{"title":"Be Detailed","desc":"Provide specific information for accurate Market Research Summary results."},{"title":"Set Clear Goals","desc":"Define what success looks like for your task."},{"title":"Iterate Results","desc":"Refine your input based on initial output."}],
};
...
export function MarketResearchSummaryPage() {
  const { user } = useAuth();
...
export default MarketResearchSummaryPage;
