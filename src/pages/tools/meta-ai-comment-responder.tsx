...
const TOOL_DATA = {
  ...
  badge: 'Facebook/Meta',
  badgeColor: '#1877F2',
  description: 'AI-powered meta ai comment responder',
  heroVideo: '/media/videos/Pinterest%2851%29.mp4',
  ...
  tabImages: {"overview":["gallery-img10.png","gallery-img11.png","gallery-img12.png"],"targeting":["gallery-img2.png","gallery-img3.png","gallery-img4.png"],"creative":["gallery-img5.png","gallery-img6.png","gallery-img7.png"],"optimize":["gallery-img8.png","gallery-img9.png","gallery.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your meta ai comment responder requirements...",
    "required": true
  },
  {
    "name": "audience",
...
export function MetaAiCommentResponderPage() {
  const { user } = useAuth();
...
export default MetaAiCommentResponderPage;
