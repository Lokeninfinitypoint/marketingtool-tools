...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["30e57079acdf2a4981480fa48edbf841.png","323e8d56af9bc6f95a7dca12f4c1cca4.png","328c87a833feea78aadd11e0b9051c43.png"],"metrics":["335c9e535ef4bccb276cb68b21c53e25.png","349bd2c2bb2ababc70cbdb221c75fac2.png","373ccb9a02edeacf9911fc00a04db017.png"],"insights":["39014c094747ec5163eb8eb116eea449.png","392b61dafc3ffe7292622a92aabd91de.png","3a7f90c22558c72734e7b199148c5069.png"],"export":["3a92ded58bb73921734dfd448e8a8399.png","3b1cd49f9b93d3b663e228a8228ff8c3.png","3dc6dd09fdfd11e99b2cb2dd33034372.png"]},
  tabDescriptions: {"overview":[{"title":"Intel Dashboard","desc":"Market overview"},{"title":"Ad Spend","desc":"Budget tracking"},{"title":"Market Share","desc":"Position data"}],"metrics":[{"title":"Competitor Ads","desc":"Their creatives"},{"title":"Strategy Map","desc":"Their approach"},{"title":"Gap Analysis","desc":"Opportunities"}],"insights":[{"title":"Market Trends","desc":"Industry shifts"},{"title":"Platform Updates","desc":"New features"},{"title":"Seasonal Data","desc":"Timing patterns"}],"export":[{"title":"Action Items","desc":"What to do"},{"title":"Alerts Setup","desc":"Auto-monitor"},{"title":"Reports","desc":"Export findings"}]},
  tips: [{"title":"Be Detailed","desc":"Provide specific information for accurate Ad Intelligence Software results."},{"title":"Set Clear Goals","desc":"Define what success looks like for your task."},{"title":"Iterate Results","desc":"Refine your input based on initial output."}],
};
...
export function AdIntelligenceSoftwarePage() {
  const { user } = useAuth();
...
export default AdIntelligenceSoftwarePage;
