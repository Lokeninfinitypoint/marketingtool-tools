...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["thumbnail_cmhngoquj0000v83kef120ig2_1762439340373_gkoactmwpj9.png","thumbnail_cmhniyboy0002v8rvph8hiy8x_1762443931257_ekamwgsiacq.png","thumbnail_cmhpk5tm00000v8mjhovo12co_1762852746763_zad4sdg99os.png"],"configure":["thumbnail_cmij8qfjm0000x42sroofa61l_1764391315157_eig6r0t37mo.png","title.png","to-do.png"],"generate":["todolist-page.png","toolsbar-modal.png","top-banner.png"],"results":["top-level-await.png","trail-bg.png","travel.png"]},
  tabDescriptions: {"overview":[{"title":"Suite Overview","desc":"All tools"},{"title":"Active Tasks","desc":"Running jobs"},{"title":"Performance","desc":"Improvement data"}],"configure":[{"title":"Tool Library","desc":"Available tools"},{"title":"Integrations","desc":"Connected apps"},{"title":"Setup","desc":"Configuration"}],"generate":[{"title":"Automation","desc":"Auto-optimize"},{"title":"Scheduling","desc":"Task timing"},{"title":"Priorities","desc":"What to fix"}],"results":[{"title":"Improvements","desc":"Before/after"},{"title":"ROI Impact","desc":"Cost savings"},{"title":"Reports","desc":"Download data"}]},
  tips: [{"title":"Be Detailed","desc":"Provide specific information for accurate Optimization Software Suite results."},{"title":"Set Clear Goals","desc":"Define what success looks like for your task."},{"title":"Iterate Results","desc":"Refine your input based on initial output."}],
};
...
export function OptimizationSoftwareSuitePage() {
  const { user } = useAuth();
...
export default OptimizationSoftwareSuitePage;
