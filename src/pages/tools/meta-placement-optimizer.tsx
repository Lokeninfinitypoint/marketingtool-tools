...
const TOOL_DATA = {
  ...
  badge: 'Facebook/Meta',
  badgeColor: '#1877F2',
  description: 'AI-powered meta placement optimizer',
  heroVideo: '/media/videos/Pinterest.mp4',
  ...
  tabImages: {"overview":["news10.png","news11.png","news12.png"],"targeting":["news13.png","news14.png","news2.png"],"creative":["news3.png","news5.png","news6.png"],"optimize":["news7.png","news8.png","news9.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your meta placement optimizer requirements...",
    "required": true
  },
  {
    "name": "audience",
...
export function MetaPlacementOptimizerPage() {
  const { user } = useAuth();
...
export default MetaPlacementOptimizerPage;
