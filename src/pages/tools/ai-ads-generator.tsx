...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["7b3f067099089085d6dd615eb9638097.png","7c0a7019741c8b7ffca2c7ea21a4e95f.png","7cabe0cc2335eba9eebea7cc47bb754a.png"],"writing":["7d2fd5deab9fa2da7f475e864a8ab0ce.png","7e34a08ec6f2d54c3da70cbd74449d4f.png","80a5a2879e1602292245b770a358f72f.png"],"editing":["8194b6296b740b982101d994e4e4346c.png","824f0150588eb95752ba4b34601aa644.png","82e4c589a62849eea3fe49865c585ff7.png"],"publish":["85b1a9f187b415432dcfc44ec3150d07.png","8839330665927f64ebac47c0a8a18f16.png","884090d7be4d64d40edba36203a97356.png"]},
  tabDescriptions: {"overview":[{"title":"AI Dashboard","desc":"Agent status"},{"title":"Tasks","desc":"Active tasks"},{"title":"Performance","desc":"AI accuracy"}],"writing":[{"title":"Configure","desc":"Setup agent"},{"title":"Rules","desc":"Business rules"},{"title":"Training","desc":"Custom data"}],"editing":[{"title":"Run Task","desc":"Execute now"},{"title":"Batch","desc":"Bulk process"},{"title":"Schedule","desc":"Auto-run"}],"publish":[{"title":"Results","desc":"Output review"},{"title":"Quality","desc":"Score check"},{"title":"History","desc":"Past runs"}]},
...
export function AiAdsGeneratorPage() {
  const { user } = useAuth();
...
export default AiAdsGeneratorPage;
