...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["4c9e29dbf6d601083b8e515623e13faf.png","4d35648697c8c465cc0208bd38981b69.png","4ee673b9365dc8939108fd2fa6e41103.png"],"configure":["4f505d349e0506d2bbc49ca0376cd6f2.png","50dc6e085d4119c841578610408235a3.png","51adfa69ca7f294f9afed92aa4c9c1ac.png"],"generate":["53444b1e5dc93bf1632d434641625f2d.png","53c4248fc9f25fe6275f4900f756b3a7.png","547f28896fb1a2f30aa77925e664e441.png"],"results":["55411036857f11774ce24483d4e45c2d.png","555994644_pvt ltd company.png","5590f347fd864703b3413c0458a7e477.png"]},
  tabDescriptions: {"overview":[{"title":"Launch Pad","desc":"Campaign ready"},{"title":"Platforms","desc":"Ad channels"},{"title":"Budget","desc":"Spend plan"}],"configure":[{"title":"Campaign Type","desc":"Choose format"},{"title":"Audience","desc":"Target setup"},{"title":"Creative","desc":"Ad assets"}],"generate":[{"title":"Ad Preview","desc":"How it looks"},{"title":"Platform Check","desc":"Policy review"},{"title":"Cost Estimate","desc":"Projected spend"}],"results":[{"title":"Go Live","desc":"Launch now"},{"title":"Schedule","desc":"Timed launch"},{"title":"Checklist","desc":"Final review"}]},
  tips: [{"title":"Be Detailed","desc":"Provide specific information for accurate Ads Launcher results."},{"title":"Set Clear Goals","desc":"Define what success looks like for your task."},{"title":"Iterate Results","desc":"Refine your input based on initial output."}],
};
...
export default AdsLauncherPage;
