...
const TOOL_DATA = {
  ...
  badge: 'Campaign',
  badgeColor: '#dd6b20',
  description: 'AI-powered campaign scaling assistant',
  heroVideo: '/media/videos/Pin%20on%20Social.mp4',
  ...
  tabImages: {"overview":["portfolio-4.png","preview.png","pricing-bg-two.png"],"setup":["projects.png","release-note.png","returnvalue.png"],"monitor":["right-sidebar.png","routs.png","rtl-dark-mode.png"],"optimize":["rtl.png","s4.png","safari.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your campaign scaling assistant requirements...",
    "required": true
  }
];

export function CampaignScalingAssistantPage() {
  const { user } = useAuth();
...
export default CampaignScalingAssistantPage;
