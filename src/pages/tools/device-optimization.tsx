...
const TOOL_DATA = {
  ...
  badgeColor: '#FBBC05',
  description: 'AI-powered device optimization',
  heroVideo: '/media/videos/Pinterest%20%2832%29.mp4',
  ...
  tabImages: {"overview":["news4.jpg","page_header_1.jpeg","post-details-1.jpeg"],"targeting":["preview.jpg","pricing-hero.jpg","profile-bg.jpg"],"performance":["progressbar.jpg","project_details_img.jpeg","question.jpg"],"optimize":["quote.jpg","responsive.jpg","robot using mobile phone.jpeg"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your device optimization requirements...",
    "required": true
  },
  {
    "name": "keywords",
...
export function DeviceOptimizationPage() {
  const { user } = useAuth();
...
export default DeviceOptimizationPage;
