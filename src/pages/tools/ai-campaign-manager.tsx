...
const TOOL_DATA = {
  ...
  badge: 'Campaign',
  badgeColor: '#dd6b20',
  description: 'AI-powered ai campaign manager',
  heroVideo: '/media/videos/Choose%20Digital%20Marketing%20as%20Your%20Career..mp4',
  ...
  tabImages: {"overview":["8ea7bc268d871e354c35a90ab65f4f11.png","8ed7f735045ffa7174280db69af8e70b.png","919843430_1.png"],"setup":["94db93a11e9c6655a58f5d365b3433ac.png","961b5ea0e4e20be9ee389f8abc4e9c52.png","96206b3de1fa5a79e50e89c1e0aa1034.png"],"monitor":["976105545a311b0106e33fe8f2350de3.png","98697ec9a4349dc1c16ff0e6f379df0b.png","98a7edb8d1a24bcbf443560f34e78bc8.png"],"optimize":["98c5ae0c858eb88d62beb52e4e601080.png","99d26377b7bb3bcd65110d493b7050cf.png","9b9909b0ddc0cdda15f19a5b9fb7a0f1.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your ai campaign manager requirements...",
    "required": true
  }
];

export function AiCampaignManagerPage() {
  const { user } = useAuth();
...
export default AiCampaignManagerPage;
