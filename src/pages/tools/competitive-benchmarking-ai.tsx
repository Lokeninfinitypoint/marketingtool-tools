...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["Explore the Future of Social Media with AI.jpeg","f22c2453e5382e45140785256f212fb4.png","f313e94a3deeda3ca3903219670032f0.png"],"competitors":["Futuristic Digital Marketing Collaboration.jpg","Google 2026 New Year.jpeg","f3a82bce191d066f50fa0ee218d0c315.png"],"trends":["Grow Your Business Online- Full-Service Digital Marketing Strategy.jpeg","f46b815ab94e2d2e9d558d73ac2eea29.png","Hire Affordable Sugar Land SEO Company, Local Business SEO Sugar Land.jpeg"],"strategy":["How Enterprises Use Automated Performance Testing to Prevent Scalability Failures.jpeg","How to Run Facebook Ads the Smart Way Without Wasting Your Budget.jpg","How to make AI agents cheaper, faster and more accurate.jpeg"]},
  tabDescriptions: {"overview":[{"title":"Benchmark Hub","desc":"Market position"},{"title":"Score","desc":"Your ranking"},{"title":"Competitors","desc":"Who to track"}],"competitors":[{"title":"Ad Spend","desc":"Budget compare"},{"title":"Creative","desc":"Content quality"},{"title":"Reach","desc":"Audience size"}],"trends":[{"title":"Side-by-Side","desc":"Direct compare"},{"title":"Strengths","desc":"Where you win"},{"title":"Gaps","desc":"Where to improve"}],"strategy":[{"title":"Action Plan","desc":"Next steps"},{"title":"Opportunities","desc":"Market gaps"},{"title":"Threats","desc":"Watch out"}]},
...
export function CompetitiveBenchmarkingAiPage() {
  const { user } = useAuth();
...
export default CompetitiveBenchmarkingAiPage;
