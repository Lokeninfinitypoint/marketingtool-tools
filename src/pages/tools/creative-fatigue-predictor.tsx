...
const TOOL_DATA = {
  ...
  badge: 'Creative',
  badgeColor: '#9f7aea',
  description: 'AI-powered creative fatigue predictor',
  heroVideo: '/media/videos/Pinterest%20%2823%29.mp4',
  tabs: [{"id":"overview","name":"Overview","icon":"📊"},{"id":"create","name":"Create","icon":"🎨"},{"id":"library","name":"Library","icon":"📂"},{"id":"optimize","name":"Optimize","icon":"✨"}],
  tabImages: {"overview":["WhatsApp Image 2026-01-31 at 22.31.17.jpeg","WhatsApp Image 2026-01-31 at 22.31.18.jpeg","WhatsApp Image 2026-01-31 at 22.31.19.jpeg"],"create":["WhatsApp Image 2026-01-31 at 22.31.20.jpeg","WhatsApp Image 2026-01-31 at 22.31.21.jpeg","_.jpeg"],"library":["_Mastering Digital Marketing_ Strategies for Success in a Connected World_.jpeg","ab1.jpg","about_hero.jpg"],"optimize":["aboutt.jpeg","abstract-images.jpg","accelerometer-front.jpg"]},
  tabDescriptions: {"overview":[{"title":"Creative Brief","desc":"Design setup"},{"title":"Brand Kit","desc":"Brand assets"},{"title":"Templates","desc":"Starting points"}],"create":[{"title":"AI Generate","desc":"Auto-create"},{"title":"Multi-size","desc":"Format options"},{"title":"Style Match","desc":"Brand style"}],"library":[{"title":"Asset Library","desc":"Saved designs"},{"title":"Versions","desc":"Edit history"},{"title":"Team Share","desc":"Collaborate"}],"optimize":[{"title":"Performance","desc":"Creative data"},{"title":"A/B Results","desc":"Test winners"},{"title":"Refresh Alert","desc":"When to change"}]},
  tips: [{"title":"Describe Your Vision","desc":"Be specific about the visual style you want."},{"title":"Mention Platform","desc":"Specify where the creative will be used for proper sizing."},{"title":"Brand Guidelines","desc":"Include colors, fonts, and style preferences."}],
};
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your creative fatigue predictor requirements...",
    "required": true
  }
];

export function CreativeFatiguePredictorPage() {
  const { user } = useAuth();
...
export default CreativeFatiguePredictorPage;
