...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('Case Team Carousel', 'brighthub'),
                        ...
                        array(
                            ...
                            'options' => [
                                '1' => [
                                    ...
                                    'image' => get_template_directory_uri() . '/elements/assets/img/pxl_team_carousel/layout-1.jpg'
                                ],
                                '2' => [
                                    'label' => esc_html__('Layout 2', 'brighthub' ),
                                    'image' => get_template_directory_uri() . '/elements/assets/img/pxl_team_carousel/layout-2.webp'
                                ],
                            ],
                        ),
                    ),
