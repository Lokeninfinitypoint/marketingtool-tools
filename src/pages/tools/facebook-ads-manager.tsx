...
const TOOL_DATA = {
  ...
  badge: 'Facebook/Meta',
  badgeColor: '#1877F2',
  description: 'AI-powered facebook ads manager',
  heroVideo: '/media/videos/Pinterest%20%285%29.mp4',
  ...
  tabImages: {"overview":["5236daa629552a1372a5a6211c491515.webp","55d94db75083b7052f1d6df531ea9b78.webp","57701f669a39dc95b02179d0424a2471.webp"],"targeting":["5cd532d667d2f59bf5888bc40f8352ae.webp","5d4b6bd33669e38efea3bb59083d54f4.webp","5dd9aa171308990a182c48383b892d12.webp"],"creative":["5fa810f224a150c3dab4a28eb99c79c0.webp","60302eb8c4e33ec21d91bd08fa36d0db.webp","6290d19a135f76f3a83593f1911c27a8.webp"],"optimize":["64c4cdb408b74abf8f0a7f95763076ad.webp","6512d63ffc0fd2ab20fbc14327f5eb49.webp","65de601f00ac0e65deaf43d512a4c525.webp"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your facebook ads manager requirements...",
    "required": true
  },
  {
    "name": "audience",
...
export function FacebookAdsManagerPage() {
  const { user } = useAuth();
...
export default FacebookAdsManagerPage;
