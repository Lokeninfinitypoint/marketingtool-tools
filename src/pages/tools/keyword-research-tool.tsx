...
const TOOL_DATA = {
  ...
  tabs: [{"id":"overview","name":"Overview","icon":"📊"},{"id":"technical","name":"Technical","icon":"⚙️"},{"id":"content","name":"Content","icon":"📝"},{"id":"ranking","name":"Rankings","icon":"📈"}],
  tabImages: {"overview":["b1eac7b54f9bb7d6e314cb346c032ff1.png","b36e6f8e9ab7c2e39894a67bb47f8160.png","b40fc5f8185cbbd4538377d6db8866ab.png"],"technical":["b43dadb01425cb103fbc6e91cb3d75c8.png","b48e0c135a452a232e7f2b0b4abd8c52.png","b500e87353f4dcafd70fbc1c57fdb7f3.png"],"content":["b642e33b320f93ecb38a90d1d23ee315.png","b6936c850da742995343267ecdecb9c3.png","b80be05da77faf80016911a1d84b531b.png"],"ranking":["b82c730b5a7110ac716177b749b04305.png","b88a2b47821c8b47507781b773e5c6d3.png","badge.png"]},
  tabDescriptions: {"overview":[{"title":"SEO Score","desc":"Site health"},{"title":"Rankings","desc":"Keyword positions"},{"title":"Visibility","desc":"Search presence"}],"technical":[{"title":"Technical SEO","desc":"Site structure"},{"title":"Speed Score","desc":"Load time"},{"title":"Mobile Ready","desc":"Mobile check"}],"content":[{"title":"Content Quality","desc":"Writing score"},{"title":"Keyword Usage","desc":"Optimization"},{"title":"Readability","desc":"User friendly"}],"ranking":[{"title":"SERP Preview","desc":"Search display"},{"title":"Rank Tracking","desc":"Position changes"},{"title":"Opportunities","desc":"Growth areas"}]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your keyword research tool requirements...",
    "required": true
  },
  {
    "name": "url",
...
export function KeywordResearchToolPage() {
  const { user } = useAuth();
...
export default KeywordResearchToolPage;
