...
const TOOL_DATA = {
  ...
  badge: 'Campaign',
  badgeColor: '#dd6b20',
  description: 'AI-powered campaign health monitor',
  heroVideo: '/media/videos/Pin%20on%20CRM%20%281%29.mp4',
  ...
  tabImages: {"overview":["news14.png","news2.png","news3.png"],"setup":["news5.png","news6.png","news7.png"],"monitor":["news8.png","news9.png","nf-card-img.png"],"optimize":["nft-gradient-bg.png","nft-img1.png","nft-img2.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your campaign health monitor requirements...",
    "required": true
  }
];

export function CampaignHealthMonitorPage() {
  const { user } = useAuth();
...
export default CampaignHealthMonitorPage;
