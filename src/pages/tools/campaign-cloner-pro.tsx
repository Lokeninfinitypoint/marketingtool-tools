...
const TOOL_DATA = {
  ...
  badge: 'Campaign',
  badgeColor: '#dd6b20',
  description: 'AI-powered campaign cloner pro',
  heroVideo: '/media/videos/LLM-Agenten%20Revolution%C3%A4re%20Planungsmethoden%20enth%C3%BCllt.mp4',
  ...
  tabImages: {"overview":["lifestyle.png","livingroom_bright.png","livingroom_dim.png"],"setup":["llp vs partnership.png","login-page.png","logo-setup.png"],"monitor":["logo-white.png","main-banner-bg-shape.png","main-banner-bg.png"],"optimize":["maintenance-shape.png","marketingtool-feature-graphic.png","missingMaterialImage.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your campaign cloner pro requirements...",
    "required": true
  }
];

export function CampaignClonerProPage() {
  const { user } = useAuth();
...
export default CampaignClonerProPage;
