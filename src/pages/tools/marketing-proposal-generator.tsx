...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["f0ecf43435c3bd430c0ade1c2073ecf5.png","f10b0d27cc9c8f693b13500975b36576.png","f22c2453e5382e45140785256f212fb4.png"],"writing":["f313e94a3deeda3ca3903219670032f0.png","f3a82bce191d066f50fa0ee218d0c315.png","f46b815ab94e2d2e9d558d73ac2eea29.png"],"editing":["f4b81fc72b0198b5885125ba78469be5.png","f55df5fd3f783764d7b6626e2909a206.png","f587399cd5c0b89927a719eeb4fa769c.png"],"publish":["f6fd00e123ba120bde0748bbe035afc9.png","f774e48ec9b3aa21c3877f9a2dc31ff7.png","f84eb12e10324dd70d8cb3ddfbd2938d.png"]},
  tabDescriptions: {"overview":[{"title":"Proposals","desc":"Your drafts"},{"title":"Templates","desc":"Starting points"},{"title":"Win Rate","desc":"Success stats"}],"writing":[{"title":"AI Writer","desc":"Generate proposal"},{"title":"Scope","desc":"Service details"},{"title":"Pricing","desc":"Cost breakdown"}],"editing":[{"title":"Branding","desc":"Your look"},{"title":"Sections","desc":"Content blocks"},{"title":"Case Studies","desc":"Past work"}],"publish":[{"title":"Export PDF","desc":"Download file"},{"title":"Send Link","desc":"Share online"},{"title":"Track","desc":"View analytics"}]},
  tips: [{"title":"Be Detailed","desc":"Provide specific information for accurate Marketing Proposal Generator results."},{"title":"Set Clear Goals","desc":"Define what success looks like for your task."},{"title":"Iterate Results","desc":"Refine your input based on initial output."}],
};
...
export function MarketingProposalGeneratorPage() {
  const { user } = useAuth();
...
export default MarketingProposalGeneratorPage;
