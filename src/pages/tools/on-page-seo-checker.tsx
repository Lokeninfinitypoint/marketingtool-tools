...
const TOOL_DATA = {
  ...
  badge: 'Audit',
  badgeColor: '#38a169',
  description: 'AI-powered on page seo checker',
  heroVideo: '/media/videos/Social%20Media%20Templates.mp4',
  ...
  tabImages: {"overview":["spatial_darkMode_unselected.png","spatial_lightMode_unselected.png","splashscreen_logo.png"],"analysis":["split-2.png","split-bg-shape.png","sport.png"],"scoring":["stylegude.png","tabs-image1.png","tabs-image2.png"],"recommendations":["terms-condition.png","texture.png","thumb.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your on page seo checker requirements...",
    "required": true
  }
];

export function OnPageSeoCheckerPage() {
  const { user } = useAuth();
