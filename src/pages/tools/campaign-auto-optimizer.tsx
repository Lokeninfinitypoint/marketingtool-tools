...
const TOOL_DATA = {
  ...
  badge: 'Campaign',
  badgeColor: '#dd6b20',
  description: 'AI-powered campaign auto optimizer',
  heroVideo: '/media/videos/LLM-Agenten%20Revolution%C3%A4re%20Planungsmethoden%20enth%C3%BCllt%20%284%29.mp4',
  ...
  tabImages: {"overview":["img4.png","img5.png","img6.png"],"setup":["img7.png","img8.png","img9.png"],"monitor":["import.png","instrumentation-breakpoints2.png","integrations.png"],"optimize":["invoice-pattern.png","iphone.png","iphone_retina4_default_image.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your campaign auto optimizer requirements...",
    "required": true
  }
];

export function CampaignAutoOptimizerPage() {
  const { user } = useAuth();
...
export default CampaignAutoOptimizerPage;
