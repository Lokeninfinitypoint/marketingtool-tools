...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["3D Motion Poster for Business Growth _ Modern Digital Marketing Design.jpeg","4 - sine-green-yellow.jpeg","5 - sine-purple-orange-black.jpeg"],"writing":["6 - sine-gray.jpeg","f0654bfb90422af06626aca8e38cc589.webp","A Complete Path For The Successful E-Commerce Business.jpeg"],"editing":["AI Content Creation at Its Finest.jpeg","AI Content Writing for Website Optimization.jpeg","f0e5eb83f003a0d04f55dfd9e5e6e013.png"],"publish":["AI robot working on laptop.jpeg","f0ecf43435c3bd430c0ade1c2073ecf5.png","AI-Powered Case Analysis for Legal Professionals.jpeg"]},
  tabDescriptions: {"overview":[{"title":"Input Code","desc":"Paste source"},{"title":"Language","desc":"Programming lang"},{"title":"Format","desc":"Output style"}],"writing":[{"title":"Generate","desc":"AI create"},{"title":"Templates","desc":"Doc templates"},{"title":"Batch","desc":"Multiple files"}],"editing":[{"title":"Preview","desc":"Review output"},{"title":"Edit","desc":"Manual adjust"},{"title":"Validate","desc":"Accuracy check"}],"publish":[{"title":"Export","desc":"Download"},{"title":"Integrate","desc":"CI/CD hook"},{"title":"History","desc":"Past generations"}]},
  tips: [{"title":"Paste Your Code","desc":"Include the actual code for accurate documentation."},{"title":"Specify Language","desc":"Name the programming language used."},{"title":"Define Audience","desc":"Is this for developers, users, or both?"}],
};
...
export function CodeCommentsGeneratorPage() {
  const { user } = useAuth();
...
export default CodeCommentsGeneratorPage;
