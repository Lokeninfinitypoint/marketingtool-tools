...
const TOOL_DATA = {
  ...
  badge: 'Facebook/Meta',
  badgeColor: '#1877F2',
  description: 'AI-powered real time meta optimizer',
  heroVideo: '/media/videos/new_media_0635.mp4',
  ...
  tabImages: {"overview":["motherboard 2.jpg","motherboard.jpg","news2.jpg"],"targeting":["news3.jpg","news4.jpg","page_header_1.jpeg"],"creative":["post-details-1.jpeg","preview.jpg","pricing-hero.jpg"],"optimize":["profile-bg.jpg","progressbar.jpg","project_details_img.jpeg"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your real time meta optimizer requirements...",
    "required": true
  },
  {
    "name": "audience",
...
export function RealTimeMetaOptimizerPage() {
  const { user } = useAuth();
...
export default RealTimeMetaOptimizerPage;
