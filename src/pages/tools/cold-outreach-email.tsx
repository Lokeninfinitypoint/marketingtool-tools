...
const TOOL_DATA = {
  ...
  tabs: [{"id":"overview","name":"Overview","icon":"📊"},{"id":"compose","name":"Compose","icon":"✍️"},{"id":"personalize","name":"Personalize","icon":"👤"},{"id":"sequence","name":"Sequence","icon":"📨"}],
  tabImages: {"overview":["AI-Powered Innovation for Growth.jpeg","AI.jpeg","Agentic AI- Building Autonomous Systems from Scratch.jpeg"],"compose":["Best Data Analytics Solutions Providers for Smarter Decisions.jpeg","Best Website Analysis Tools for Digital Marketers.jpeg","BlackTexture.jpg"],"personalize":["Boost Your Website with GEO, AEO & AI SEO Optimization.jpeg","f10b0d27cc9c8f693b13500975b36576.png","Campaign Performance Insights in New Google Ads Reports.jpeg"],"sequence":["Campaign Performance Metrics Analysis in Ads.jpeg","Conversion rate optimization.jpeg","Cover image-image.jpg"]},
  tabDescriptions: {"overview":[{"title":"Email Score","desc":"Quality rating"},{"title":"Subject Line","desc":"Open rate driver"},{"title":"Preview Text","desc":"First impression"}],"compose":[{"title":"Body Writer","desc":"Email content"},{"title":"CTA Design","desc":"Action button"},{"title":"Signature","desc":"Professional close"}],"personalize":[{"title":"Personalize","desc":"Dynamic fields"},{"title":"Segments","desc":"Audience groups"},{"title":"A/B Test","desc":"Version testing"}],"sequence":[{"title":"Send Schedule","desc":"Best times"},{"title":"Follow-up","desc":"Auto sequence"},{"title":"Analytics","desc":"Open/click data"}]},
  tips: [{"title":"Know Your Recipient","desc":"Describe who you are writing to for personalization."},{"title":"State Your Goal","desc":"Define the email purpose: sell, inform, or follow up."},{"title":"Keep It Short","desc":"Best emails are 50-125 words for optimal engagement."}],
};
...
export function ColdOutreachEmailPage() {
  const { user } = useAuth();
...
export default ColdOutreachEmailPage;
