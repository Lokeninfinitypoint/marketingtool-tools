...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["contact-page.png","contact_bg.png","crm-dark-rtl.png"],"competitors":["crm-dark.png","crm-hover-sidebar.png","crm-rtl.png"],"trends":["crm.png","crypto-wallet-dashboard.png","css-structure-1.png"],"strategy":["d0d121f0e1571d0cf9c3c016a97bbb5a.png","d221397e7bdbd8d6abedd616bdaa1afd.png","d2c180b6d64db3fdf163750d49c19340.png"]},
  tabDescriptions: {"overview":[{"title":"Asset Library","desc":"All files"},{"title":"Recent","desc":"Latest uploads"},{"title":"Storage","desc":"Space used"}],"competitors":[{"title":"Images","desc":"Photo assets"},{"title":"Videos","desc":"Video files"},{"title":"Documents","desc":"Text files"}],"trends":[{"title":"Folders","desc":"Categories"},{"title":"Tags","desc":"Label system"},{"title":"Metadata","desc":"File details"}],"strategy":[{"title":"Team Access","desc":"Permissions"},{"title":"Download","desc":"Export files"},{"title":"Embed","desc":"Use in ads"}]},
  tips: [{"title":"Be Detailed","desc":"Provide specific information for accurate Marketing Asset Library results."},{"title":"Set Clear Goals","desc":"Define what success looks like for your task."},{"title":"Iterate Results","desc":"Refine your input based on initial output."}],
};
...
export function MarketingAssetLibraryPage() {
  const { user } = useAuth();
...
export default MarketingAssetLibraryPage;
