...
const TOOL_DATA = {
  ...
  badge: 'Facebook/Meta',
  badgeColor: '#1877F2',
  description: 'AI-powered meta budget optimizer',
  heroVideo: '/media/videos/Pinterest%2854%29.mp4',
  ...
  tabImages: {"overview":["header-with-topbar.png","header.png","headerMenu.png"],"targeting":["headphone.png","hero_bg_2.png","horizontal-card-img1.png"],"creative":["horizontal-card-img2.png","horizontal-card-img3.png","horizontal-card-img4.png"],"optimize":["icon-256.png","icon-512.png","icon-shape-five.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your meta budget optimizer requirements...",
    "required": true
  },
  {
    "name": "audience",
...
export function MetaBudgetOptimizerPage() {
  const { user } = useAuth();
...
export default MetaBudgetOptimizerPage;
