...
const TOOL_DATA = {
  ...
  tabs: [{"id":"overview","name":"Overview","icon":"📊"},{"id":"colors","name":"Colors & Type","icon":"🎨"},{"id":"assets","name":"Assets","icon":"📁"},{"id":"export","name":"Export","icon":"📤"}],
  tabImages: {"overview":["AI Products & UX Design ✨.jpeg","gallery-img3.png","gallery-img4.png"],"colors":["gallery-img5.png","gallery-img6.png","gallery-img7.png"],"assets":["gallery-img8.png","gallery-img9.png","gallery.png"],"export":["gallery2.png","gallery3.png","gallery4.png"]},
  tabDescriptions: {"overview":[{"title":"Brand Brief","desc":"Define identity"},{"title":"Audience","desc":"Target profiles"},{"title":"Competitors","desc":"Market analysis"}],"colors":[{"title":"Color Palette","desc":"Brand colors"},{"title":"Typography","desc":"Font system"},{"title":"Logo Mark","desc":"Visual identity"}],"assets":[{"title":"Templates","desc":"Design assets"},{"title":"Guidelines","desc":"Brand rules"},{"title":"Mockups","desc":"Preview assets"}],"export":[{"title":"Brand Kit","desc":"Download pack"},{"title":"Style Guide","desc":"PDF export"},{"title":"Share","desc":"Team access"}]},
  tips: [{"title":"Start with Values","desc":"Define your brand's core values and mission first."},{"title":"Know Your Audience","desc":"Describe your ideal customer for targeted branding."},{"title":"Be Consistent","desc":"Use the generated style guide across all channels."}],
};
...
export function BrandIdentityBuilderPage() {
  const { user } = useAuth();
...
export default BrandIdentityBuilderPage;
