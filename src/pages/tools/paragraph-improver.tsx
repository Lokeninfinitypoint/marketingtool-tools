...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["user-grid-img14.png","user-grid-img2.png","user-grid-img4.png"],"transform":["user-grid-img5.png","user-grid-img6.png","user-grid-img7.png"],"style":["user-grid-img8.png","user-grid-img9.png","user-list.png"],"export":["ut-image-01.png","video-img1.png","video-img2.png"]},
...
export function ParagraphImproverPage() {
  const { user } = useAuth();
...
export default ParagraphImproverPage;
