...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["f774e48ec9b3aa21c3877f9a2dc31ff7.png","Revolutionizing Legal Practices with AI- An Overview.jpeg","SEO Agency.jpeg"],"writing":["SEO Course in Kolkata - SEO Training Course in Kolkata.jpeg","Smart Home Future.jpeg","Smart Strategies for Online Success.jpeg"],"editing":["Social Media Templates.jpeg","Social Media.jpeg","Sparky AI- Your Partner in Network Marketing Growth.jpeg"],"publish":["f84eb12e10324dd70d8cb3ddfbd2938d.png","The Future of Homework_ AI Evaluation.jpeg","These AI SEO Tools Are Outsmarting Old SEO Tricks.jpeg"]},
...
export function PinterestAdGeneratorPage() {
  const { user } = useAuth();
...
export default PinterestAdGeneratorPage;
