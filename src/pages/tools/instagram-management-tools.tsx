...
const TOOL_DATA = {
  ...
  badge: 'Instagram',
  badgeColor: '#E4405F',
  description: 'AI-powered instagram management tools',
  heroVideo: '/media/videos/Pinterest%2824%29.mp4',
  ...
  tabImages: {"overview":["709eb1b05980742d06aa4e315bb0270d.png","71602ec35adbd144d552cb32d6f3bf2a.png","71ad4cbbacd0bd20582ec491e4ff1200.png"],"targeting":["72481c627abccae437b2b165d30d8c67.png","72707286241826c60239067a2d420b7a.png","73329f2edefb31a41e508107d58db6fb.png"],"creative":["737fc83f4af29d6f3fa841d353287b8b.png","73f3143836ff5ad28fe439bdc3054c04.png","7406eefbb0b001fcf5594f4519a91989.png"],"optimize":["7493778d82b2648ef0174d53231e4b3c.png","74b128e3bcebf9ad92449ea21fc5d275.png","74c679b74ddeeac0e3c2d00f2642011b.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your instagram management tools requirements...",
    "required": true
  },
  {
    "name": "audience",
...
export function InstagramManagementToolsPage() {
  const { user } = useAuth();
...
export default InstagramManagementToolsPage;
