...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["04_AIChat.png","04_History.png","053c5068b3122138005547f79bcf6e57.png"],"technical":["05_MemeGenerator.png","05_Profile.png","06_MemeGen.png"],"content":["06_Profile.png","0714f92dea58ee1adbcb4348b64d94c0.png","0718de85344c421f604988e421e608d9.png"],"ranking":["077a3149fd779206ad3ef1e14e8faf65.png","08e488cc4e5f340808fa58a0b6227129.png","0c34ac3cef8e4faf2bddd7b4d4297036.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your serp analyzer requirements...",
    "required": true
  },
  {
    "name": "url",
...
export function SerpAnalyzerPage() {
  const { user } = useAuth();
...
export default SerpAnalyzerPage;
