...
const TOOL_DATA = {
  ...
  badge: 'Audit',
  badgeColor: '#38a169',
  description: 'AI-powered placement audit',
  heroVideo: '/media/videos/We%20harness%20artificial%20intelligence%20to%20analyze%20complex%20data%20predi%20%288%29.mp4',
  tabs: [{"id":"overview","name":"Overview","icon":"📊"},{"id":"analysis","name":"Analysis","icon":"🔍"},{"id":"scoring","name":"Scoring","icon":"⭐"},{"id":"recommendations","name":"Fixes","icon":"🔧"}],
  tabImages: {"overview":["f91f0899e138768563a92cc3fb39a6ef.png","Tier-1 Software Engineer - Aitrich Academy.jpg","Truth bomb TIME!.jpeg"],"analysis":["UDHOY AADHAR INFITY TEG.1.jpg","Unleash Your Inner Author with Sudowrite AI!.jpeg","Upcoming Enhancements for GA4 Analytics 360 Properties.jpeg"],"scoring":["Using AI for Data Analysis.jpeg","What Are The Pros Of Outsourcing Mobile App Development Company-.jpeg","WhatsApp Image 2026-01-20 at 08.15.18.jpeg"],"recommendations":["WhatsApp Image 2026-01-21 at 10.58.21.jpeg","WhatsApp Image 2026-01-22 at 13.08.35.jpeg","WhatsApp Image 2026-01-22 at 18.21.46.jpeg"]},
  tabDescriptions: {"overview":[{"title":"Account Health","desc":"Overall score"},{"title":"Key Findings","desc":"Top issues found"},{"title":"Coverage","desc":"Areas analyzed"}],"analysis":[{"title":"Issue Details","desc":"Problem breakdown"},{"title":"Severity Level","desc":"Impact assessment"},{"title":"Root Cause","desc":"Why it happens"}],"scoring":[{"title":"Score Card","desc":"Performance rating"},{"title":"Benchmarks","desc":"Industry comparison"},{"title":"Trends","desc":"Over-time changes"}],"recommendations":[{"title":"Fix Guide","desc":"How to resolve"},{"title":"Priority Order","desc":"What to fix first"},{"title":"Estimated Impact","desc":"Expected improvement"}]},
  tips: [{"title":"Export Account Data","desc":"Provide recent account data for accurate analysis."},{"title":"Set Goals First","desc":"Define KPIs so the audit measures what matters."},{"title":"Regular Audits","desc":"Run quarterly to catch issues early."}],
};
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your placement audit requirements...",
    "required": true
  }
];

export function PlacementAuditPage() {
  const { user } = useAuth();
...
export default PlacementAuditPage;
