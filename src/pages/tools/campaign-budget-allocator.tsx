...
const TOOL_DATA = {
  ...
  badge: 'Campaign',
  badgeColor: '#dd6b20',
  description: 'AI-powered campaign budget allocator',
  heroVideo: '/media/videos/LLM-Agenten%20Revolution%C3%A4re%20Planungsmethoden%20enth%C3%BCllt%20%285%29.mp4',
  ...
  tabImages: {"overview":["javascript-structure-1.png","js.png","kanban-1.png"],"setup":["kanban-2.png","kanban-3.png","kanban-4.png"],"monitor":["kanbanBoard.png","landing-page.png","layout-structure-1.png"],"optimize":["leafletapi.png","left-sidebar.png","letter-m.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your campaign budget allocator requirements...",
    "required": true
  }
];

export function CampaignBudgetAllocatorPage() {
  const { user } = useAuth();
...
export default CampaignBudgetAllocatorPage;
