...
const TOOL_DATA = {
  ...
  badge: 'Audit',
  badgeColor: '#38a169',
  description: 'AI-powered quality score checker',
  heroVideo: '/media/videos/new_media_0634.mp4',
  ...
  tabImages: {"overview":["img5.jpg","img6.jpg","instagram.jpg"],"analysis":["javascript-structure-1.jpg","lamp.jpg","laptop-with-chart-and-glowing-distant-coworking-re-2026-01-11-08-42-31-utc.jpg"],"scoring":["learn-debugging-basics.jpg","learn-native-debugging.jpg","learn-react-native-devtools.jpg"],"recommendations":["magnifier.jpg","meta-content.jpg","monitor.jpg"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your quality score checker requirements...",
    "required": true
  }
];

export function QualityScoreCheckerPage() {
  const { user } = useAuth();
...
export default QualityScoreCheckerPage;
