...
const TOOL_DATA = {
  ...
  badge: 'Audit',
  badgeColor: '#38a169',
  description: 'AI-powered landing page audit',
  heroVideo: '/media/videos/Pinterest%2836%29.mp4',
  ...
  tabImages: {"overview":["banner-dark.png","basic.png","bbe67d5628bdf6330b88ba20cc2603cc.png"],"analysis":["bcf41aa95f125066cb78fcc7a43381cd.png","bd5c45d4f65ec7e6e8a09d7aee2f1f01.png","be2c773c3755f9a2aa276a489849d052.png"],"scoring":["be7fd5d29f67d3a18386b11665a58be2.png","bf09d5db9b42d788b87d25bc52241a60.png","bf141fe5dcfcbc2befdd4a12dc4dac56.png"],"recommendations":["bf61d2295ff9076c4efeff7a037fcecc.png","bf7556bb64ce1ddc1dc2315ebdb6203d.png","bg-pattern.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your landing page audit requirements...",
    "required": true
  }
];

export function LandingPageAuditPage() {
  const { user } = useAuth();
...
export default LandingPageAuditPage;
