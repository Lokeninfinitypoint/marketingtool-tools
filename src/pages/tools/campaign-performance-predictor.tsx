...
const TOOL_DATA = {
  ...
  badge: 'Campaign',
  badgeColor: '#dd6b20',
  description: 'AI-powered campaign performance predictor',
  heroVideo: '/media/videos/Pin%20on%20Social%20%281%29.mp4',
  ...
  tabImages: {"overview":["pattern.png","photo-8.png","photo-9.png"],"setup":["pointLight_darkMode_selected.png","pointLight_darkMode_unselected.png","pointLight_lightMode_selected.png"],"monitor":["portfolio-1-1.png","portfolio-1-2.png","portfolio-1-3.png"],"optimize":["portfolio-1.png","portfolio-2.png","portfolio-3.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your campaign performance predictor requirements...",
    "required": true
  }
];

export function CampaignPerformancePredictorPage() {
  const { user } = useAuth();
...
export default CampaignPerformancePredictorPage;
