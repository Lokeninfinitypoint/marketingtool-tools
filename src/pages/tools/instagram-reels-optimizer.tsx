...
const TOOL_DATA = {
  ...
  badge: 'Instagram',
  badgeColor: '#E4405F',
  description: 'AI-powered instagram reels optimizer',
  heroVideo: '/media/videos/Pinterest%2826%29.mp4',
  ...
  tabImages: {"overview":["82e4c589a62849eea3fe49865c585ff7.png","85b1a9f187b415432dcfc44ec3150d07.png","8839330665927f64ebac47c0a8a18f16.png"],"targeting":["884090d7be4d64d40edba36203a97356.png","885e1ec67f2f95075f12b29f39581380.png","88ce7b128d282f0ae9b07e2cef24954a.png"],"creative":["88e5bdd28893371102f4e81babc2ffd7.png","88f1310ae528c76b009f8a2d512616fb.png","8980b76598b69ec55178be3b5793ee0e.png"],"optimize":["89b1593c93bbf106e71c3741ea1ad3ca.png","8b1cc32f221c5c1e717042323ef0ff9a.png","8b89b26aa42314a627ae5a9977140296.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your instagram reels optimizer requirements...",
    "required": true
  },
  {
    "name": "audience",
...
export function InstagramReelsOptimizerPage() {
  const { user } = useAuth();
...
export default InstagramReelsOptimizerPage;
