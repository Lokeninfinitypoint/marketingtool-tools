...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["Sign_Iso.png","Spaceship.png","SplashScreenLegacy.png"],"metrics":["Stump_Iso.png","Success.png","TBLR_Check_selected.png"],"insights":["TBLR_Check_unselected.png","TBLR_Control_selected.png","TBLR_Control_unselected.png"],"export":["TBLR_Magnifier_selected.png","TBLR_Magnifier_unselected.png","TBLR_Warnings_selected.png"]},
  tabDescriptions: {"overview":[{"title":"AI Dashboard","desc":"Agent status"},{"title":"Tasks","desc":"Active tasks"},{"title":"Performance","desc":"AI accuracy"}],"metrics":[{"title":"Configure","desc":"Setup agent"},{"title":"Rules","desc":"Business rules"},{"title":"Training","desc":"Custom data"}],"insights":[{"title":"Run Task","desc":"Execute now"},{"title":"Batch","desc":"Bulk process"},{"title":"Schedule","desc":"Auto-run"}],"export":[{"title":"Results","desc":"Output review"},{"title":"Quality","desc":"Score check"},{"title":"History","desc":"Past runs"}]},
...
export function AiPerformanceMarketerPage() {
  const { user } = useAuth();
...
export default AiPerformanceMarketerPage;
