...
const TOOL_DATA = {
  ...
  tabs: [{"id":"overview","name":"Overview","icon":"📊"},{"id":"catalog","name":"Catalog","icon":"🛒"},{"id":"pricing","name":"Pricing","icon":"💲"},{"id":"promote","name":"Promote","icon":"📣"}],
  tabImages: {"overview":["7aade642d5f063896295de1e9ac5ec30.webp","7bcb24e32ea94fa33a342e990df14702.webp","7df74da6dae74e0f9a748f9d970711ba.webp"],"catalog":["804f99157216e02f9244f04311c10482.webp","8550c6d198f91df2a534d5a02135d27f.webp","85591200949e116ee44bebadd9aef634.webp"],"pricing":["86374d13fa1ed69e726b258381a4c80f.webp","864c97d40cde8977961981418fda8e29.webp","8b06c5588b54fa3b486d969c5d7ba53a.webp"],"promote":["8bf5b101a29db0252d3a512bb39b9ee0.webp","8f8effb82469f94244a5728fcbc6dccf.webp","8ff16e0adc386534ff54eb2a5e7f423a.webp"]},
  tabDescriptions: {"overview":[{"title":"Store Stats","desc":"Sales overview"},{"title":"Products","desc":"Active items"},{"title":"Revenue","desc":"Sales data"}],"catalog":[{"title":"Product Feed","desc":"Catalog sync"},{"title":"Categories","desc":"Organization"},{"title":"Inventory","desc":"Stock levels"}],"pricing":[{"title":"Price Check","desc":"Competitor pricing"},{"title":"Discounts","desc":"Sale setup"},{"title":"Margins","desc":"Profit tracking"}],"promote":[{"title":"Ad Creator","desc":"Product ads"},{"title":"Cross-sell","desc":"Upsell offers"},{"title":"Retarget","desc":"Cart recovery"}]},
  tips: [{"title":"Name Your Products","desc":"List the products or categories to focus on."},{"title":"Set Revenue Goals","desc":"Include sales targets for strategy alignment."},{"title":"Describe Your Store","desc":"Share your niche and customer type."}],
};
...
export function SeasonalEcommercePlannerPage() {
  const { user } = useAuth();
...
export default SeasonalEcommercePlannerPage;
