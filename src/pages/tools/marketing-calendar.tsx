...
const TOOL_DATA = {
  ...
  badge: 'Social Media',
  badgeColor: '#e53e8c',
  description: 'AI-powered marketing calendar',
  heroVideo: '/media/videos/Pinterest%2844%29.mp4',
  ...
  tabImages: {"overview":["db3a5475704287bfb8e2fc9d06b918d7.png","dc996bdec61c6ae5079546c030cba081.png","dcfa1ff216de6ad0b54a74b642f96a68.png"],"competitors":["demo.png","design.png","device-iPhone14Pro.8b4e207e.png"],"trends":["device-iPhone14Pro_dark.6179e616.png","device-tv.afb3e674.png","device-tv_dark.3d102412.png"],"strategy":["device-watchSeries8-45.6b7e9754.png","device-watchSeries8-45_dark.97273065.png","digital-wallet-button.png"]},
  tabDescriptions: {"overview":[{"title":"Content Plan","desc":"Strategy view"},{"title":"Platform Stats","desc":"Engagement data"},{"title":"Trending","desc":"Hot topics"}],"competitors":[{"title":"Post Creator","desc":"Write content"},{"title":"Visual Design","desc":"Media tools"},{"title":"Hashtag Mix","desc":"Tag strategy"}],"trends":[{"title":"Calendar","desc":"Schedule view"},{"title":"Best Times","desc":"Optimal posting"},{"title":"Auto Post","desc":"Scheduled publish"}],"strategy":[{"title":"Engagement","desc":"Likes/comments"},{"title":"Growth","desc":"Follower change"},{"title":"Top Content","desc":"Best posts"}]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your marketing calendar requirements...",
    "required": true
  },
  {
    "name": "platform",
