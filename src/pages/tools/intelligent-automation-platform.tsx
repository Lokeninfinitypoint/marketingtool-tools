...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["BigTexturedWindow.png","Blog.png","BoundingBoxLabelFont.png"],"build":["Chart.png","Chart1.png","ColorMap.png"],"triggers":["DELETE THIS!!.png","Desert_Hex.png","Envato Logo.png"],"logs":["Error.png","Farm_Hex.png","Footer.png"]},
  tabDescriptions: {"overview":[{"title":"AI Dashboard","desc":"Agent status"},{"title":"Tasks","desc":"Active tasks"},{"title":"Performance","desc":"AI accuracy"}],"build":[{"title":"Configure","desc":"Setup agent"},{"title":"Rules","desc":"Business rules"},{"title":"Training","desc":"Custom data"}],"triggers":[{"title":"Run Task","desc":"Execute now"},{"title":"Batch","desc":"Bulk process"},{"title":"Schedule","desc":"Auto-run"}],"logs":[{"title":"Results","desc":"Output review"},{"title":"Quality","desc":"Score check"},{"title":"History","desc":"Past runs"}]},
...
export function IntelligentAutomationPlatformPage() {
  const { user } = useAuth();
...
export default IntelligentAutomationPlatformPage;
