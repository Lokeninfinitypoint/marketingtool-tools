...
const TOOL_DATA = {
  ...
  badge: 'Campaign',
  badgeColor: '#dd6b20',
  description: 'AI-powered campaign tools suite',
  heroVideo: '/media/videos/Pinterest%20%2810%29.mp4',
  ...
  tabImages: {"overview":["split-bg-shape.png","sport.png","stylegude.png"],"setup":["tabs-image1.png","tabs-image2.png","terms-condition.png"],"monitor":["texture.png","thumb.png","thumbnail_cmhngoquj0000v83kef120ig2_1762439340373_gkoactmwpj9.png"],"optimize":["thumbnail_cmhniyboy0002v8rvph8hiy8x_1762443931257_ekamwgsiacq.png","thumbnail_cmhpk5tm00000v8mjhovo12co_1762852746763_zad4sdg99os.png","thumbnail_cmij8qfjm0000x42sroofa61l_1764391315157_eig6r0t37mo.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your campaign tools suite requirements...",
    "required": true
  }
];

export function CampaignToolsSuitePage() {
  const { user } = useAuth();
...
export default CampaignToolsSuitePage;
