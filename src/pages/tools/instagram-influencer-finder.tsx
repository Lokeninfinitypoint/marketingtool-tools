...
const TOOL_DATA = {
  ...
  badge: 'Instagram',
  badgeColor: '#E4405F',
  description: 'AI-powered instagram influencer finder',
  heroVideo: '/media/videos/Pinterest%2822%29.mp4',
  ...
  tabImages: {"overview":["6903896ead76d4128d7533079a230f95.png","6912d722e0c069ceca6e4c2dd7e9fc89.png","693793c99eacc052bfddd2252c85fb19.png"],"targeting":["693f5452a8723177166062ea2f908c70.png","699538e1072edabd56b3d503c7d484cb.png","69e0cabc6abf41944e42d7f7ac26c1ba.png"],"creative":["6afff8727d01c94db3b9a7209bb2f0ad.png","6c45133afbd06206756e1dac2c9c4ba1.png","6d107688532c8d2425145f5d6cfa065a.png"],"optimize":["6e94a9253c9dae2a2bbde3e14a7d55bc.png","6fc8dfddf7fd7255d86361f31adc36c8.png","705fb3d0483c26a5b19a59146723a239.png"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your instagram influencer finder requirements...",
    "required": true
  },
  {
    "name": "audience",
...
export function InstagramInfluencerFinderPage() {
  const { user } = useAuth();
...
export default InstagramInfluencerFinderPage;
