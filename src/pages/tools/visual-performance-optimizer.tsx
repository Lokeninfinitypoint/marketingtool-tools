...
const TOOL_DATA = {
  ...
  badge: 'Creative',
  badgeColor: '#9f7aea',
  description: 'AI-powered visual performance optimizer',
  heroVideo: '/media/videos/new_media_0665.mp4',
  ...
  tabImages: {"overview":["961b5ea0e4e20be9ee389f8abc4e9c52.png","96206b3de1fa5a79e50e89c1e0aa1034.png","976105545a311b0106e33fe8f2350de3.png"],"metrics":["98697ec9a4349dc1c16ff0e6f379df0b.png","98a7edb8d1a24bcbf443560f34e78bc8.png","98c5ae0c858eb88d62beb52e4e601080.png"],"insights":["99d26377b7bb3bcd65110d493b7050cf.png","9b9909b0ddc0cdda15f19a5b9fb7a0f1.png","9c77d84390fd1695a4dc6671f5739d4e.png"],"export":["9d41c24424c7e255c388e23dfbd2be61.png","9e15ec1a717eb440e11c3b9efd20a44a.png","9f09ad0d46dd1436746a0a1e1ded33f8.png"]},
  tabDescriptions: {"overview":[{"title":"Creative Brief","desc":"Design setup"},{"title":"Brand Kit","desc":"Brand assets"},{"title":"Templates","desc":"Starting points"}],"metrics":[{"title":"AI Generate","desc":"Auto-create"},{"title":"Multi-size","desc":"Format options"},{"title":"Style Match","desc":"Brand style"}],"insights":[{"title":"Asset Library","desc":"Saved designs"},{"title":"Versions","desc":"Edit history"},{"title":"Team Share","desc":"Collaborate"}],"export":[{"title":"Performance","desc":"Creative data"},{"title":"A/B Results","desc":"Test winners"},{"title":"Refresh Alert","desc":"When to change"}]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your visual performance optimizer requirements...",
    "required": true
  }
];

export function VisualPerformanceOptimizerPage() {
  const { user } = useAuth();
...
export default VisualPerformanceOptimizerPage;
