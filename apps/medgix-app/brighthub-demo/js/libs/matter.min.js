  ...
  return (function (e) {
          ...
          (n.colorToNumber = function (e) {
            ...
            (n.topologicalSort = function (e) {
              var t = [],
                o = [],
                i = [];
              for (var r in e) o[r] || i[r] || n._topologicalSort(r, o, i, e, t);
              return t;
            }),
    ...
    function (e, t) {
      ...
      (e.exports = n),
        ...
        (n.rotateAbout = function (e, t, n, o) {
          ...
          return (o.y = n.y + ((e.x - n.x) * r + (e.y - n.y) * i)), (o.x = a), o;
        }),
    ...
    function (e, t, n) {
      ...
      (o.create = function (e, t) {
        ...
        (o.centre = function (e) {
          for (var t, n, r, a = o.area(e, !0), s = { x: 0, y: 0 }, l = 0; l < e.length; l++)
            (r = (l + 1) % e.length),
              (t = i.cross(e[l], e[r])),
        ...
        (o.contains = function (e, t) {
          for (var n, o = t.x, i = t.y, r = e.length, a = e[r - 1], s = 0; s < r; s++) {
            if (((n = e[s]), (o - a.x) * (n.y - a.y) + (i - a.y) * (a.x - n.x) > 0)) return !1;
            a = n;
          }
          return !0;
        }),
        (o.scale = function (e, t, n, r) {
          ...
          for (var l = 0; l < e.length; l++)
            (a = e[l]), (s = i.sub(a, r)), (e[l].x = r.x + s.x * t), (e[l].y = r.y + s.y * n);
          return e;
        }),
      ...
      !(function () {
        ...
        (o.set = function (e, t, n) {
          ...
          (o.setAngle = function (e, t, n) {
            var o = t - e.angle;
            n
              ? ((e.anglePrev = e.angle), (e.angularVelocity = o), (e.angularSpeed = Math.abs(o)))
              : (e.anglePrev += o);
            for (var a = 0; a < e.parts.length; a++) {
              var s = e.parts[a];
              (s.angle += o),
          ...
          (o.rotate = function (e, t, n, i) {
            if (n) {
              var r = Math.cos(t),
                ...
                s = e.position.x - n.x,
                l = e.position.y - n.y;
              o.setPosition(e, { x: n.x + (s * r - l * a), y: n.y + (s * a + l * r) }, i),
          ...
          (o.scale = function (e, t, n, r) {
            ...
            e.parts.length > 1 &&
              ((e.area = a), e.isStatic || (o.setMass(e, e.density * a), o.setInertia(e, s))),
          ...
          (o.applyForce = function (e, t, n) {
            var o = t.x - e.position.x,
              i = t.y - e.position.y;
            (e.force.x += n.x), (e.force.y += n.y), (e.torque += o * n.y - i * n.x);
          }),
    ...
    function (e, t, n) {
      ...
      (o.create = function (e) {
        ...
        (o.removeComposite = function (e, t, n) {
          ...
          if (n)
            for (s = 0; s < e.composites.length; s++) o.removeComposite(e.composites[s], t, !0);
          return e;
        }),
        ...
        (o.removeBody = function (e, t, n) {
          ...
          if ((-1 !== i && (o.removeBodyAt(e, i), (t.sleepCounter = 0)), n))
            for (var a = 0; a < e.composites.length; a++) o.removeBody(e.composites[a], t, !0);
          return e;
        }),
        ...
        (o.rebase = function (e) {
          for (
            var t = o.allBodies(e).concat(o.allConstraints(e)).concat(o.allComposites(e)), n = 0;
            n < t.length;
            n++
          )
            t[n].id = r.nextId();
        ...
        (o.rotate = function (e, t, n, i) {
          for (
            var r = Math.cos(t), a = Math.sin(t), l = i ? o.allBodies(e) : e.bodies, c = 0;
            c < l.length;
            c++
          ) {
            var u = l[c],
        ...
        (o.scale = function (e, t, n, i, r) {
          for (var a = r ? o.allBodies(e) : e.bodies, l = 0; l < a.length; l++) {
            var c = a[l],
              u = c.position.x - i.x,
              d = c.position.y - i.y;
            s.setPosition(c, { x: i.x + u * t, y: i.y + d * n }), s.scale(c, t, n);
          }
          return e;
        }),
        (o.bounds = function (e) {
            ...
            if (0 === l.force.x && 0 === l.force.y) {
              ...
              (l.motion = o._minBias * p + (1 - o._minBias) * f),
                l.sleepThreshold > 0 && l.motion < r
                  ? ((l.sleepCounter += 1), l.sleepCounter >= l.sleepThreshold / n && o.set(l, !0))
    ...
    function (e, t, n) {
      ...
      (i = []),
        ...
        (o.collides = function (e, t, n) {
          if ((o._overlapAxes(r, e.vertices, t.vertices, e.axes), r.overlap <= 0)) return null;
          if ((o._overlapAxes(a, t.vertices, e.vertices, t.axes), a.overlap <= 0)) return null;
          var i,
            c,
          ...
          var d = i.normal,
            ...
            g = y.x,
            x = y.y;
          g * (t.position.x - e.position.x) + x * (t.position.y - e.position.y) >= 0 &&
            ((g = -g), (x = -x)),
            (d.x = g),
            (d.y = x),
            (p.x = -x),
        ...
        (o._overlapAxes = function (e, t, n, o) {
          ...
          for (l = 0; l < y; l++) {
            ...
            if ((i = (r = P - A) < (a = B - w) ? r : a) < g && ((g = i), (x = l), i <= 0)) break;
          }
        ...
        (o._findSupports = function (e, t, n, o) {
          var r,
            ...
            y = p * (u - m.x) + f * (d - m.y);
          for (s = 1; s < c; s += 1)
            (a = p * (u - (m = l[s]).x) + f * (d - m.y)) < y && ((y = a), (v = m));
          return (
      ...
      (o.create = function (e, t) {
        ...
        (o.update = function (e, t, n) {
          ...
          (e.isActive = !0),
            ...
            (e.frictionStatic =
              a.frictionStatic > s.frictionStatic ? a.frictionStatic : s.frictionStatic),
          ...
          var l = o[0],
            ...
            u = o[1],
            d = r[1];
          (d.vertex !== l && c.vertex !== u) || ((r[1] = c), (r[0] = c = d), (d = r[1])),
            (c.vertex = l),
            (d.vertex = u);
        }),
        ...
        (o.solve = function (e, t) {
          ...
          if (n || i) {
            n && !n.isStatic && (r.rotate(a, n.angle - e.angleA, a), (e.angleA = n.angle)),
              i && !i.isStatic && (r.rotate(s, i.angle - e.angleB, s), (e.angleB = i.angle));
            var l = a,
              c = s;
            if ((n && (l = r.add(n.position, a)), i && (c = r.add(i.position, s)), l && c)) {
              var u = r.sub(l, c),
                d = r.magnitude(u);
              ...
              var p,
                ...
                w = S + ((n ? n.inverseInertia : 0) + (i ? i.inverseInertia : 0));
              if (h > 0) {
                var A = r.create();
                (v = r.div(u, d)),
                  (y = r.sub(
              ...
              n &&
                ...
                (n.position.y -= b.y * f),
                h > 0 &&
                  ((n.positionPrev.x -= h * v.x * m * f), (n.positionPrev.y -= h * v.y * m * f)),
                (p =
                  (r.cross(a, b) / w) *
                  o._torqueDampen *
                  n.inverseInertia *
                ...
                i &&
                  ...
                  (i.position.y += b.y * f),
                  h > 0 &&
                    ((i.positionPrev.x += h * v.x * m * f), (i.positionPrev.y += h * v.y * m * f)),
                  (p =
                    (r.cross(s, b) / w) *
                    o._torqueDampen *
                    i.inverseInertia *
    ...
    function (e, t, n) {
      ...
      (o.rectangle = function (e, t, n, o, s) {
        ...
        (o.trapezoid = function (e, t, n, o, s, l) {
          (l = l || {}), s >= 1 && r.warn("Bodies.trapezoid: slope parameter must be < 1.");
          var c,
            u = n * (s *= 0.5),
            d = u + (1 - 2 * s) * n,
            p = d + u;
          c =
            s < 0.5
              ? "L 0 0 L " + u + " " + -o + " L " + d + " " + -o + " L " + p + " 0"
              : "L 0 0 L " + d + " " + -o + " L " + p + " 0";
          var f = { label: "Trapezoid Body", position: { x: e, y: t }, vertices: i.fromPath(c) };
          if (l.chamfer) {
            var v = l.chamfer;
        ...
        (o.circle = function (e, t, n, i, a) {
          ...
          return l % 2 == 1 && (l += 1), o.polygon(e, t, l, n, r.extend({}, s, i));
        }),
        (o.polygon = function (e, t, n, s, l) {
          ...
          var y = { label: "Polygon Body", position: { x: e, y: t }, vertices: i.fromPath(u) };
          if (l.chamfer) {
            var g = l.chamfer;
          ...
          for (
            ...
            if (
              ...
              for (x = 0; x < B.length; x++) {
                ...
                (d > 0 && i.area(M) < d) || m.push({ position: i.centre(M), vertices: M });
              }
            }
              ...
              if (
                ...
                if (h && 1 === S) (M = c(p, b, i)) && (u[d++] = M);
                  ...
                  for (var w = S > 1 ? 1 : 0, A = x > 1 ? 1 : 0; A < x; A++)
                    for (var P = p.parts[A], B = ((f = P.bounds), w); B < S; B++) {
                      var M,
                        _ = b.parts[B],
                        C = _.bounds;
                      f.min.x > C.max.x ||
    ...
    function (e, t, n) {
      ...
      (o._registry = {}),
        (o.register = function (e) {
          if (
            (o.isPlugin(e) ||
              i.warn("Plugin.register:", o.toString(e), "does not implement all required fields."),
            ...
            n > r
              ...
              : n < r
              ? i.warn("Plugin.register:", o.toString(t), "can not be downgraded to", o.toString(e))
              : e !== t &&
                i.warn(
                  "Plugin.register:",
                  o.toString(e),
        ...
        (o.use = function (e, t) {
          if (((e.uses = (e.uses || []).concat(t || [])), 0 !== e.uses.length)) {
            for (
              var n = o.dependencies(e), r = i.topologicalSort(n), a = [], s = 0;
              s < r.length;
              s += 1
            )
              if (r[s] !== e.name) {
      ...
      (o._deltaMax = 1e3 / 60),
        ...
        (o.update = function (e, t) {
          ...
          for (r.postSolvePosition(h), u.preSolveAll(h), n = 0; n < e.constraintIterations; n++)
            u.solveAll(b, t);
          for (u.postSolveAll(h), r.preSolveVelocity(m.list), n = 0; n < e.velocityIterations; n++)
    ...
    function (e, t, n) {
      ...
      (o._restingThresh = 2),
        ...
        (o.postSolvePosition = function (e) {
          for (
            var t = o._positionWarming, n = e.length, r = i.translate, s = a.update, l = 0;
            l < n;
            l++
          ) {
            var c = e[l],
              ...
              for (n = 0; n < a; n++) {
                ...
                if (0 !== v || 0 !== m) {
                  ...
                  l.isStatic ||
                    ...
                    (l.anglePrev +=
                      l.inverseInertia * ((f.x - l.position.x) * g - (f.y - l.position.y) * y))),
                    c.isStatic ||
                      c.isSleeping ||
                      ((c.positionPrev.x -= y * c.inverseMass),
                      (c.positionPrev.y -= g * c.inverseMass),
                      (c.anglePrev -=
                        c.inverseInertia * ((f.x - c.position.x) * g - (f.y - c.position.y) * y)));
                }
              }
            }
          }
          ...
          for (a = 0; a < v; a++) {
            ...
            if (m.isActive && !m.isSensor) {
              ...
              for (s = 0; s < M; s++) {
                ...
                W < -z || W > z
                  ? ((i = W > 0 ? W : -W),
                    (n = m.friction * (W > 0 ? 1 : -1) * c) < -i ? (n = -i) : n > i && (n = i))
                  : ((n = W), (i = f));
                var X = L * b - F * h,
                  Q = O * b - H * h,
        ...
        (o.update = function (e, t, n) {
          ...
          for (f = 0, p = d.length, a = 0; a < p; a++)
            (r = d[a]).timeUpdated >= n
              ? (d[f++] = r)
              : (c(r, !1, n),
                r.collision.bodyA.sleepCounter > 0 && r.collision.bodyB.sleepCounter > 0
                  ? (d[f++] = r)
                  : ((m[h++] = r), delete u[r.id]));
    ...
    function (e, t, n) {
      ...
      (o.stack = function (e, t, n, o, r, a, l) {
        for (var c, u = i.create({ label: "Stack" }), d = e, p = t, f = 0, v = 0; v < o; v++) {
        ...
        (o.mesh = function (e, t, n, o, s) {
          ...
          for (l = 0; l < n; l++) {
            for (c = 1; c < t; c++)
              (u = f[c - 1 + l * t]),
                (d = f[c + l * t]),
                i.addConstraint(e, r.create(a.extend({ bodyA: u, bodyB: d }, s)));
            if (l > 0)
              for (c = 0; c < t; c++)
                (u = f[c + (l - 1) * t]),
                  (d = f[c + l * t]),
                  ...
                  o &&
                    c > 0 &&
                    ((p = f[c - 1 + (l - 1) * t]),
                    i.addConstraint(e, r.create(a.extend({ bodyA: p, bodyB: d }, s)))),
                  o &&
                    c < t - 1 &&
                    ((p = f[c + 1 + (l - 1) * t]),
                    i.addConstraint(e, r.create(a.extend({ bodyA: p, bodyB: d }, s))));
        ...
        (o.newtonsCradle = function (e, t, n, o, a) {
          for (var s = i.create({ label: "Newtons Cradle" }), c = 0; c < n; c++) {
            var u = l.circle(e + c * (1.9 * o), t + a, o, {
              ...
              d = r.create({ pointA: { x: e + c * (1.9 * o), y: t }, bodyB: u });
      ...
      (o.create = function (e) {
                ...
                for (a = m.startCol; a <= m.endCol; a++)
                  for (s = m.startRow; s <= m.endRow; s++) {
                    ...
                    !y && g && g && l && o._bucketRemoveBody(e, l, f),
                      (f.region === v || (y && !g) || i) &&
                        (l || (l = o._createBucket(d, c)), o._bucketAddBody(e, l, f));
                  }
                (f.region = v), (p = !0);
              }
            }
        ...
        (o._createActivePairsList = function (e) {
          var t,
            ...
            a = i.length,
            s = [];
          for (n = 0; n < a; n++) (t = o[i[n]])[2] > 0 ? s.push(t) : delete o[i[n]];
          return s;
        });
    },
    function (e, t, n) {
    ...
    function (e, t, n) {
      ...
      (o.collides = function (e, t) {
        for (
          var n = [], o = t.length, i = e.bounds, s = r.collides, l = a.overlaps, c = 0;
          c < o;
          c++
        ) {
          var u = t[c],
      ...
      !(function () {
        ...
        "undefined" != typeof window &&
          ...
          (o.lookAt = function (e, t, n, o) {
            (o = void 0 === o || o), (t = r.isArray(t) ? t : [t]), (n = n || { x: 0, y: 0 });
            for (
              var i = { min: { x: 1 / 0, y: 1 / 0 }, max: { x: -1 / 0, y: -1 / 0 } }, a = 0;
              a < t.length;
              a += 1
            ) {
              var s = t[a],
          ...
          (o.world = function (e, t) {
            ...
            !y.wireframes || (d.enableSleeping && y.showSleeping)
              ? o.bodies(e, S, v)
              : (y.showConvexHulls && o.bodyConvexHulls(e, S, v), o.bodyWireframes(e, S, v)),
          ...
          (o.stats = function (e, t, n) {
            for (
              var o = e.engine, i = o.world, r = a.allBodies(i), s = 0, l = 0, c = 0;
              c < r.length;
              c += 1
            )
              s += r[c].parts.length;
          ...
          (o.status = function (e, t, n, o, i, a, s, l, c) {
            ...
            for (var u = 0; u < o; u += 1)
              e.lineTo(t + u, n + 7 - (u < a ? i * r.clamp(0.4 * c(u), -2, 2) : 0));
            e.stroke(),
            ...
            for (var n = t, o = 0; o < e.length; o++) {
              ...
              if (i.render.visible && i.pointA && i.pointB) {
                var a,
                  ...
                  l = i.bodyA,
                  u = i.bodyB;
                if (((a = l ? c.add(l.position, i.pointA) : i.pointA), "pin" === i.render.type))
                  ...
                  if ((i = o.parts[a]).render.visible) {
                    if (
                      (l.showSleeping && o.isSleeping
                        ...
                        : 1 !== i.render.opacity && (s.globalAlpha = i.render.opacity),
                      ...
                      if (i.circleRadius)
                        ...
                        s.lineTo(i.vertices[0].x, i.vertices[0].y), s.closePath();
                      }
                      l.wireframes
                        ? ((s.lineWidth = 1),
            ...
            for (l.beginPath(), r = 0; r < t.length; r++)
              if ((o = t[r]).render.visible)
                for (s = o.parts.length > 1 ? 1 : 0; s < o.parts.length; s++) {
                  for (
                    i = o.parts[s], l.moveTo(i.vertices[0].x, i.vertices[0].y), a = 1;
                    a < i.vertices.length;
                    a++
                  )
          ...
          (o.bodyConvexHulls = function (e, t, n) {
            ...
            for (a.beginPath(), i = 0; i < t.length; i++)
              if ((o = t[i]).render.visible && 1 !== o.parts.length) {
                for (a.moveTo(o.vertices[0].x, o.vertices[0].y), r = 1; r < o.vertices.length; r++)
          ...
          (o.bodyPositions = function (e, t, n) {
            ...
            for (
              ...
              (o = t[r]).render.visible &&
                (s.arc(o.positionPrev.x, o.positionPrev.y, 2, 0, 2 * Math.PI, !1), s.closePath());
          ...
          (o.collisions = function (e, t, n) {
            ...
            for (
              ...
              if ((o = t[r]).isActive && ((i = o.collision), o.contactCount > 0)) {
        ...
        (o._maxFrameDelta = 1e3 / 15),
          ...
          (o.run = function (e, t) {
            return (
              ...
              (function n(i) {
                (e.frameRequestId = o._onNextFrame(e, n)), i && e.enabled && o.tick(e, t, i);
              })(),
              e
            );
          }),
          (o.tick = function (t, n, s) {
            var l = a.now(),
              ...
              d = s - t.timeLastTick;
            if (
              ((!d || !t.timeLastTick || d > Math.max(o._maxFrameDelta, t.maxFrameTime)) &&
            ...
            (n.timing.lastUpdatesPerFrame = u),
              ...
              t.frameDeltaHistory.length >= 100 &&
                (t.lastUpdatesDeferred && Math.round(t.frameDelta / c) > v
                  ? a.warnOnce("Matter.Runner: runner reached runner.maxUpdates, see docs.")
                  : t.lastUpdatesDeferred &&
                    a.warnOnce("Matter.Runner: runner reached runner.maxFrameTime, see docs."),
                void 0 !== t.isFixed &&
                  a.warnOnce("Matter.Runner: runner.isFixed is now redundant, see docs."),
                (t.deltaMin || t.deltaMax) &&
                  a.warnOnce(
                    "Matter.Runner: runner.deltaMin and runner.deltaMax were removed, see docs."
                  ),
                0 !== t.fps &&
                  a.warnOnce("Matter.Runner: runner.fps was replaced by runner.delta, see docs."));
          }),
          (o.stop = function (e) {
    ...
    function (e, t, n) {
      ...
      (o.pathToVertices = function (e, t) {
        ...
        (o._svgPathToAbsolute = function (e) {
          for (
            var t, n, o, i, r, a, s = e.pathSegList, l = 0, c = 0, u = s.numberOfItems, d = 0;
            d < u;
            ++d
          ) {
            var p = s.getItem(d),
