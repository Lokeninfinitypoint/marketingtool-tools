...
const TOOL_DATA = {
  ...
  badge: 'Social Media',
  badgeColor: '#e53e8c',
  description: 'AI-powered post scheduler',
  heroVideo: '/media/videos/Your%20Social%20Media%20Can%20Run%20Itself%20And%20So%20Can%20Your%20Customer%20Calls.mp4',
  ...
  tabImages: {"overview":["about_hero.jpg","aboutt.jpeg","abstract-images.jpg"],"create":["accelerometer-front.jpg","accordion.jpg","ai-dashboard-bg.jpg"],"schedule":["analytics-bg.jpg","back-image.jpeg","badge.jpg"],"analytics":["ball.jpg","banner-1.jpg","banner-4.jpg"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your post scheduler requirements...",
    "required": true
  },
  {
    "name": "platform",
