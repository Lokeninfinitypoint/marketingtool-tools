...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["654c8939c0a506b97974184e94d48b66.png","661ca1614536421c475c3a5847afb4f8.png","6712a68ca7c16b2eed0271ca2b008e7d.png"],"writing":["677ba27659c590bd94e196476786d08e.png","6903896ead76d4128d7533079a230f95.png","6912d722e0c069ceca6e4c2dd7e9fc89.png"],"editing":["693793c99eacc052bfddd2252c85fb19.png","693f5452a8723177166062ea2f908c70.png","699538e1072edabd56b3d503c7d484cb.png"],"publish":["69e0cabc6abf41944e42d7f7ac26c1ba.png","6afff8727d01c94db3b9a7209bb2f0ad.png","6c45133afbd06206756e1dac2c9c4ba1.png"]},
  tabDescriptions: {"overview":[{"title":"Content Brief","desc":"Topic setup"},{"title":"Structure","desc":"Outline builder"},{"title":"Target Audience","desc":"Reader profile"}],"writing":[{"title":"AI Draft","desc":"Auto-write"},{"title":"Tone Control","desc":"Voice style"},{"title":"Length","desc":"Word count"}],"editing":[{"title":"Grammar","desc":"Error check"},{"title":"Readability","desc":"Clarity score"},{"title":"Originality","desc":"Plagiarism check"}],"publish":[{"title":"SEO Check","desc":"Search optimize"},{"title":"Export","desc":"Download file"},{"title":"Publish","desc":"Go live"}]},
  tips: [{"title":"Define Your Topic","desc":"Be specific about the subject for focused content."},{"title":"Set Target Length","desc":"Specify word count for appropriate depth."},{"title":"Know Your Reader","desc":"Describe your audience for the right tone and level."}],
};
...
export function TechnicalExplanationWriterPage() {
  const { user } = useAuth();
...
export default TechnicalExplanationWriterPage;
