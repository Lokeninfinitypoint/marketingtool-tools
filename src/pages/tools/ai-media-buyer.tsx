...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["Chart1.png","ColorMap.png","DELETE THIS!!.png"],"configure":["Desert_Hex.png","Envato Logo.png","Error.png"],"execute":["Farm_Hex.png","Footer.png","Forest_Hex.png"],"results":["GlobalColor.png","Grass_Iso_Left.png","Grassland_Hex.png"]},
...
export function AiMediaBuyerPage() {
  const { user } = useAuth();
