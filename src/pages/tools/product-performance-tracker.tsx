...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["google-analytics.jpg","google-content.jpg","google-seo.jpg"],"metrics":["guy 2.jpg","guy 3.jpg","guy.jpg"],"insights":["head.jpg","header-center-navigation.jpg","header-default.jpg"],"export":["header-transperent.jpg","header-with-topbar.jpg","hero_area_bg1.jpg"]},
  tabDescriptions: {"overview":[{"title":"Store Stats","desc":"Sales overview"},{"title":"Products","desc":"Active items"},{"title":"Revenue","desc":"Sales data"}],"metrics":[{"title":"Product Feed","desc":"Catalog sync"},{"title":"Categories","desc":"Organization"},{"title":"Inventory","desc":"Stock levels"}],"insights":[{"title":"Price Check","desc":"Competitor pricing"},{"title":"Discounts","desc":"Sale setup"},{"title":"Margins","desc":"Profit tracking"}],"export":[{"title":"Ad Creator","desc":"Product ads"},{"title":"Cross-sell","desc":"Upsell offers"},{"title":"Retarget","desc":"Cart recovery"}]},
...
export function ProductPerformanceTrackerPage() {
  const { user } = useAuth();
...
export default ProductPerformanceTrackerPage;
