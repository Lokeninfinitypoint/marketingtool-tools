...
const TOOL_DATA = {
  ...
  tabImages: {"overview":["warning.png","wasm-dwarf.png","wave-background.png"],"metrics":["web-worker.png","webview2.png","whitenoise_256.png"],"insights":["1 - sine-purple-orange.jpeg","10 Best E-commerce Development Tips for Dubai Businesses.jpeg","10 Quick Wins with Data You Can Tackle Today.jpeg"],"export":["2 - sine-gasflame.jpeg","20210414041430.jpeg","3 - sine-magenta.jpeg"]},
  tabDescriptions: {"overview":[{"title":"Client Portal","desc":"All clients"},{"title":"Active Reports","desc":"Live dashboards"},{"title":"Scheduled","desc":"Auto-reports"}],"metrics":[{"title":"Build Report","desc":"Custom layout"},{"title":"White Label","desc":"Your branding"},{"title":"Templates","desc":"Quick start"}],"insights":[{"title":"Client List","desc":"Manage clients"},{"title":"Permissions","desc":"Access control"},{"title":"Branding","desc":"Per-client look"}],"export":[{"title":"Auto-Send","desc":"Email schedule"},{"title":"Triggers","desc":"Event-based"},{"title":"Archive","desc":"Past reports"}]},
...
export function ClientReportingPortalPage() {
  const { user } = useAuth();
...
export default ClientReportingPortalPage;
