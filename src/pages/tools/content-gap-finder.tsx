...
const TOOL_DATA = {
  ...
  tabs: [{"id":"overview","name":"Overview","icon":"📊"},{"id":"writing","name":"Writing","icon":"✍️"},{"id":"editing","name":"Editing","icon":"📝"},{"id":"publish","name":"Publish","icon":"🚀"}],
  tabImages: {"overview":["Meta Pixel Vs_ GA4_ All You Need to Know.jpeg","Old Ads vs New Meta Ads_ Why Results Matter More Than Reach.jpeg","PPC Ads Agency _ PPC Agency & SEM Marketing Agency.jpeg"],"writing":["PPC portfolio #increase traffic image.jpeg","Personalizing Shopping- AI in Customer Experience.jpeg","Pixel-Perfect Web Development + SEO Mastery_ Skyrocket Your Google Ranking in 90 Days or Less!.jpeg"],"editing":["QuickAds utilizes artificial intelligence to streamline ad creation procedures_.jpeg","f6fd00e123ba120bde0748bbe035afc9.png","f774e48ec9b3aa21c3877f9a2dc31ff7.png"],"publish":["Revolutionizing Legal Practices with AI- An Overview.jpeg","SEO Agency.jpeg","SEO Course in Kolkata - SEO Training Course in Kolkata.jpeg"]},
  tabDescriptions: {"overview":[{"title":"SEO Score","desc":"Site health"},{"title":"Rankings","desc":"Keyword positions"},{"title":"Visibility","desc":"Search presence"}],"writing":[{"title":"Technical SEO","desc":"Site structure"},{"title":"Speed Score","desc":"Load time"},{"title":"Mobile Ready","desc":"Mobile check"}],"editing":[{"title":"Content Quality","desc":"Writing score"},{"title":"Keyword Usage","desc":"Optimization"},{"title":"Readability","desc":"User friendly"}],"publish":[{"title":"SERP Preview","desc":"Search display"},{"title":"Rank Tracking","desc":"Position changes"},{"title":"Opportunities","desc":"Growth areas"}]},
  tips: [{"title":"Include Target URL","desc":"Provide the page URL for specific analysis."},{"title":"Add Keywords","desc":"List your primary and secondary target keywords."},{"title":"Mention Competitors","desc":"Name competitors for comparison insights."}],
};
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your content gap finder requirements...",
    "required": true
  },
  {
    "name": "url",
  ...
  },
  {
    ...
    "type": "text",
    "placeholder": "Main keyword, secondary keywords...",
    "required": false
  }
];

export function ContentGapFinderPage() {
  const { user } = useAuth();
...
export default ContentGapFinderPage;
