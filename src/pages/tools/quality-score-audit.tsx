...
const TOOL_DATA = {
  ...
  badge: 'Audit',
  badgeColor: '#38a169',
  description: 'AI-powered quality score audit',
  heroVideo: '/media/videos/new_media_0633.mp4',
  ...
  tabImages: {"overview":["img-4.jpg","img-5.jpg","img-6.jpg"],"analysis":["img-8.jpg","img-9.jpg","img-news-3.jpg"],"scoring":["img-news-4.jpg","img.jpg","img1.jpg"],"recommendations":["img2.jpg","img3.jpg","img4.jpg"]},
...
const FORM_FIELDS = [
  {
    ...
    "type": "textarea",
    "placeholder": "Describe your quality score audit requirements...",
    "required": true
  }
];

export function QualityScoreAuditPage() {
  const { user } = useAuth();
...
export default QualityScoreAuditPage;
